...
export const CARA_ARTIFACT_TYPE_LABELS: Record<CaraArtifactType, string> = {
...
export type CaraArtifactStatus =
  | "draft"
  | "in_review"
  | "changes_requested"
  | "approved"
...
export const CARA_STATUS_LABELS: Record<CaraArtifactStatus, string> = {
  draft: "Draft",
  in_review: "In Review",
...
export const CARA_SOURCE_TYPE_LABELS: Record<CaraSourceType, string> = {
  daily_log: "Daily Log",
...
export const CARA_FRAMEWORK_LABELS: Record<CaraFramework, string> = {
...
export const CARA_TONE_LABELS: Record<CaraTone, string> = {
...
export const CARA_CREATIVE_MODE_LABELS: Record<CaraCreativeMode, string> = {
...
export type CaraEvidenceLevel = "high" | "medium" | "low" | "unverified" | "contradicted" | "missing";

export const CARA_EVIDENCE_LEVEL_LABELS: Record<CaraEvidenceLevel, string> = {
...
export const CARA_GAP_TYPE_LABELS: Record<CaraGapType, string> = {
...
export interface CaraStructuredSection {
  id: string;
  title: string;
  content: string;
  evidence_notes?: string;
  confidence?: CaraEvidenceLevel;
  requires_human_review?: boolean;
  is_ai_generated: boolean;
}

export interface CaraStructuredContent {
  sections: CaraStructuredSection[];
  known_evidence: string;
  analysis: string;
  professional_hypothesis: string;
  suggested_actions: string[];
  human_review_required: string[];
  framework_used: CaraFramework;
  ...
  confidence_overall: CaraEvidenceLevel;
...
export interface CaraArtifact {
  id: string;
  artifact_type: CaraArtifactType;
  title: string;
  status: CaraArtifactStatus;
  ...
  structured_content: CaraStructuredContent | null;
...
export interface CaraArtifactVersion {
  id: string;
  artifact_id: string;
  version_number: number;
  title: string;
...
export interface CaraArtifactReview {
  id: string;
  artifact_id: string;
  reviewer_id: string;
...
export interface CaraArtifactAction {
  id: string;
  artifact_id: string;
  task_id: string | null;
  action_title: string;
...
export interface CaraQualityCheck {
  id: string;
  artifact_id: string;
...
export interface CaraStudioAuditLog {
  id: string;
  home_id: string;
  actor_id: string;
  action_type: CaraAuditAction;
...
export type CaraSafeguardingPatternType =
  | "repeat_missing"
  | "repeat_restraint"
  | "escalating_severity"
  | "night_time_cluster"
...
export type CaraPatternSeverity = "low" | "medium" | "high" | "critical";

export interface CaraSafeguardingEvidenceRef {
  source_table: string;
  source_id: string;
  date: string;
  excerpt: string;
...
export interface CaraSafeguardingPattern {
  id: string;
  home_id: string;
  child_id: string | null;
  pattern_type: CaraSafeguardingPatternType;
  title: string;
  description: string;
  severity: CaraPatternSeverity;
  window_start: string;
  window_end: string;
  evidence_refs: CaraSafeguardingEvidenceRef[];
...
export interface CaraEarlyWarning {
  id: string;
  home_id: string;
  child_id: string | null;
  source_pattern_id: string | null;
  warning_type: CaraSafeguardingPatternType;
  title: string;
  rationale: string;
  severity: CaraPatternSeverity;
  recommended_action: string;
...
export type CaraCareGraphNodeType =
  | "child"
  | "incident"
  | "missing_episode"
  | "restraint"
...
export type CaraCareGraphEdgeType =
  | "involves"
  | "caused_by"
  | "escalated_from"
  | "mitigates"
...
export interface CaraCareGraphNode {
  id: string;
  home_id: string;
  child_id: string | null;
...
export interface CaraCareGraphEdge {
  id: string;
  home_id: string;
  from_node_id: string;
  to_node_id: string;
...
export interface CaraCareGraphSnapshot {
  home_id: string;
  child_id: string | null;
  generated_at: string;
  nodes: CaraCareGraphNode[];
...
export type CaraFormulationFactorType =
  | "predisposing"
  | "precipitating"
  | "perpetuating"
  | "protective";

export interface CaraFormulationFactor {
  factor_type: CaraFormulationFactorType;
  label: string;
  detail: string;
  evidence_refs: CaraSafeguardingEvidenceRef[];
...
export type CaraFormulationStatus =
  | "ai_draft"
  | "in_review"
  | "approved"
  | "superseded"
...
export interface CaraFormulation {
  id: string;
  home_id: string;
  child_id: string;
  title: string;
  narrative: string;
  factors: CaraFormulationFactor[];
  hypotheses: string[];
  recommended_focus: string[];
  source_pattern_ids: string[];
  source_warning_ids: string[];
  source_risk_ids: string[];
  status: CaraFormulationStatus;
  is_ai_draft: boolean;
  generated_at: string;
  approved_by: string | null;
  approved_at: string | null;
...
export type CaraDecisionPriority = "p1" | "p2" | "p3" | "p4";
export type CaraDecisionStatus =
  | "ai_draft"
  | "accepted"
  | "modified"
  | "deferred"
...
export type CaraDecisionAction =
...
export interface CaraDecisionRecommendation {
  id: string;
  home_id: string;
  child_id: string | null;
  ...
  source_pattern_ids: string[];
  source_warning_ids: string[];
  action: CaraDecisionAction;
  title: string;
  rationale: string;
  expected_impact: string;
  priority: CaraDecisionPriority;
  confidence: number;
  status: CaraDecisionStatus;
  is_ai_draft: boolean;
  generated_at: string;
...
export interface CaraDecisionSupportSnapshot {
  home_id: string;
  child_id: string | null;
  generated_at: string;
  formulations: CaraFormulation[];
  recommendations: CaraDecisionRecommendation[];
  summary: {
    formulations: number;
...
export const CARA_REG45_THEME_LABELS: Record<CaraReg45Theme, string> = {
...
export type CaraReg45EvidenceSentiment = "concern" | "positive" | "neutral";

export type CaraReg45EvidenceStatus =
  | "ai_draft"
  | "accepted"
  | "deferred"
  | "rejected"
...
export interface CaraReg45EvidenceItem {
  id: string;
  home_id: string;
  child_id: string | null;
  ...
  period_start: string;
  period_end: string;
  status: CaraReg45EvidenceStatus;
  is_ai_draft: boolean;
  generated_at: string;
  decided_by: string | null;
  decided_at: string | null;
...
export interface CaraReg45Snapshot {
  home_id: string;
  period_start: string;
  period_end: string;
  generated_at: string;
  themes: Record<CaraReg45Theme, CaraReg45EvidenceItem[]>;
  summary: {
    total: number;
    ai_draft: number;
    accepted: number;
    ...
    by_theme: Record<CaraReg45Theme, number>;
    concerns: number;
    positives: number;
  };
}
...
export type CaraAnnexASectionKey =
  | "section_1"
  | "section_2"
  | "section_3"
  | "section_4"
...
export const CARA_ANNEX_A_SECTIONS: { key: CaraAnnexASectionKey; label: string; weight: number }[] = [
...
export type CaraAnnexAReadiness = "green" | "amber" | "red";

export interface CaraAnnexASectionReading {
  key: CaraAnnexASectionKey;
  label: string;
  weight: number;
  record_count: number;
  gap_count: number;
  stale_count: number;
  readiness: CaraAnnexAReadiness;
  issues: string[];
  notes: string;
}

export type CaraAnnexASnapshotStatus = "draft" | "locked";

export interface CaraAnnexASnapshot {
  id: string;
  home_id: string;
  period_start: string;
  period_end: string;
...
export type CaraReg45ReportStatus = "draft" | "in_review" | "approved" | "locked";

export interface CaraReg45ReportSection {
  theme: CaraReg45Theme;
  label: string;
  narrative: string;
...
export interface CaraReg45Report {
  id: string;
  home_id: string;
  period_start: string;
  period_end: string;
  status: CaraReg45ReportStatus;
  generated_at: string;
  generated_by: string;
  title: string;
  executive_summary: string;
  sections: CaraReg45ReportSection[];
  evidence_item_ids: string[];
...
export type CaraSuggestedRecordStatus =
  | "pending"
  | "committed"
  | "rejected"
  | "superseded";

export const CARA_SUGGESTED_RECORD_LABELS: Record<CaraSuggestedRecordType, string> = {
...
export interface CaraSuggestedSourceRef {
  type: string;
  id: string;
  label: string;
}

export interface CaraSuggestedRecord {
  id: string;
  home_id: string;
  child_id: string | null;
...
export interface CaraCommittedRecord {
  id: string;
...
export interface CaraReg40Triage {
  id: string;
  home_id: string;
  child_id: string | null;
...
export type CaraIndicatorStatus = "green" | "amber" | "red";

export interface CaraHomeDynamicsIndicator {
  key: string;
  label: string;
  value: number | string;
  status: CaraIndicatorStatus;
  detail: string;
}

export interface CaraHomeDynamicsSnapshot {
  id: string;
  home_id: string;
  ...
  overall_status: CaraIndicatorStatus;
...
export interface CaraGenerationRequest {
  artifact_type: CaraArtifactType;
  title: string;
  child_id: string | null;
  home_id: string;
...
export interface CaraGenerationResult {
  artifact: CaraArtifact;
  sources_used: CaraSource[];
  gaps_detected: CaraGap[];
  model_used: string;
  is_stub: boolean;
}
...
export interface CaraArtifactListResponse {
  data: CaraArtifact[];
  meta: {
    total: number;
    draft: number;
...
export interface CaraSourceListResponse {
  data: CaraSource[];
  meta: { total: number };
}

export interface CaraGapListResponse {
  data: CaraGap[];
  meta: {
    total: number;
    critical: number;
...
// Pages under /cara-studio use the older naming convention.
// These aliases keep them compiling without touching every import.

/** @deprecated Use CaraArtifactType */
export type CaraStudioArtifactType = CaraArtifactType;
/** @deprecated Use CaraFramework */
export type CaraStudioFramework = CaraFramework;
/** @deprecated Use CaraTone */
export type CaraStudioTone = CaraTone;
/** @deprecated Use CaraArtifact */
export type CaraStudioArtifact = CaraArtifact;
/** @deprecated Use CaraQualityCheck */
export type CaraStudioQualityCheck = CaraQualityCheck;
/** @deprecated Use CaraGap */
...
/** @deprecated Use CARA_STATUS_LABELS */
export const STATUS_LABELS = CARA_STATUS_LABELS;
/** @deprecated Use CARA_FRAMEWORK_LABELS */
export const FRAMEWORK_LABELS = CARA_FRAMEWORK_LABELS;
/** @deprecated Use CARA_TONE_LABELS */
export const TONE_LABELS = CARA_TONE_LABELS;
/** @deprecated Use CARA_SOURCE_TYPE_LABELS */
export const SOURCE_TYPE_LABELS = CARA_SOURCE_TYPE_LABELS;

/** @deprecated Derive from Object.keys(CARA_ARTIFACT_TYPE_LABELS) */
export const CARA_STUDIO_ARTIFACT_TYPES = Object.keys(
  CARA_ARTIFACT_TYPE_LABELS,
) as CaraArtifactType[];
/** @deprecated Derive from Object.keys(CARA_FRAMEWORK_LABELS) */
export const CARA_STUDIO_FRAMEWORKS = Object.keys(
  CARA_FRAMEWORK_LABELS,
) as CaraFramework[];
/** @deprecated Derive from Object.keys(CARA_TONE_LABELS) */
export const CARA_STUDIO_TONES = Object.keys(
  CARA_TONE_LABELS,
) as CaraTone[];
/** @deprecated Derive from Object.keys(CARA_SOURCE_TYPE_LABELS) */
