...
export interface AriaEvidenceLink {
  id: string;
  agent_run_id: string;
  source_table: string;
...
export type AriaEvidenceLinkInsert = Omit<AriaEvidenceLink, "id" | "created_at">;

// ── aria_drafts ─────────────────────────────────────────────────────────────

export interface AriaDraft {
  id: string;
  organisation_id: string;
  home_id: string;
  agent_run_id: string;
...
export type AriaDraftInsert = Omit<AriaDraft, "id" | "created_at" | "updated_at">;
...
export interface AriaGovernanceSettings {
  id: string;
  organisation_id: string;
  home_id: string | null;
...
export type AriaGovernanceSettingsInsert = Omit<AriaGovernanceSettings, "id" | "created_at" | "updated_at">;

// ── aria_prompt_templates ───────────────────────────────────────────────────

export interface AriaPromptTemplate {
  id: string;
  organisation_id: string;
  home_id: string | null;
  template_key: string;
...
export type AriaPromptTemplateInsert = Omit<AriaPromptTemplate, "id" | "created_at" | "updated_at">;
...
export interface AriaAuditEvent {
  id: string;
  organisation_id: string;
  home_id: string;
  event_type: string;
...
export type AriaAuditEventInsert = Omit<AriaAuditEvent, "id" | "created_at">;
