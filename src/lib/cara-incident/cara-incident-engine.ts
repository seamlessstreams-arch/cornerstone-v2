...
} from "@/lib/cara/contextual-safeguarding";
import { NRM_GUIDANCE_BLOCK, NRM_WORDING, assessNRMIndicators } from "@/lib/cara/nrm-modern-slavery";
import { safetyPlanComponentPrompts, safetyTypologyPrompts } from "@/lib/cara/safety-planning";
...
export interface CaraRecordingReview {
  id: string;
  home_id: string;
  child_id: string;
  user_id: string;
...
export const CARA_INCIDENT_SYSTEM_PROMPT = `You are Cara, the AI practice assistant inside Cara OS, supporting residential childcare staff with therapeutic, restorative, trauma-informed, safeguarding-aware and professionally written recording.
