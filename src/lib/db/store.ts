...
// ── Substance misuse screenings (seed) ────────────────────────────────────────
// Mixed: Alex medium-risk (CCE-linked) with active harm-reduction; Jordan no
// identified risk; Casey awareness-only (alcohol + prescribed-medication safety).
store.substanceScreenings = [
  {
    id: "subs_alex_1",
    child_id: "yp_alex",
    screening_date: "2026-05-21",
    conducted_by: "staff_edward",
    screening_tool: "crafft" as const,
    risk_level: "medium_risk" as const,
    substances_identified: ["Cannabis (occasional, social/peer context)"],
    context_of_use: "Use linked to periods of county-lines exploitation and association with older peers; reports using to 'manage stress' and to fit in when away from placement. Reduced markedly since last missing episode.",
    peer_influences: "Strong influence from older individuals connected to criminal exploitation; some pressure to use and to carry. Actively working with key worker to disengage from these contacts.",
    family_history: "Limited reliable family history available. No disclosed parental substance dependence; maternal contact supportive of harm-reduction approach.",
    education_provided: [
      "1:1 harm-reduction session on cannabis and impact on developing brain",
      "Information on links between substance use and exploitation/debt bondage",
      "Safer-use and 'staying safe when away from placement' planning",
    ],
    harm_reduction_approach: [
      "Non-judgemental key-worker check-ins twice weekly",
      "Agreed 'safe to talk' plan if offered substances while away",
      "Trusted-adult contact card and return-from-missing debrief focus on triggers",
    ],
    professional_support_in_place: [
      "CAMHS practitioner (emotional regulation and trauma)",
      "Allocated social worker (CIN/CP oversight)",
      "Local young people's substance-misuse service (open referral)",
      "Child exploitation / missing coordinator",
    ],
    child_insight: "Alex recognises that cannabis use increases when he feels unsafe or pressured, and can name how it has been used by others to create obligation. He understands the link between use and the exploitation he has experienced.",
    child_motivation: "Wants to cut down and 'not owe anyone'; motivated to stay in education and rebuild trust with his social worker. Engages willingly with harm-reduction sessions.",
    warning_signs_to_watch: [
      "Unexplained money, new phones or trainers",
      "Increased missing-from-home episodes",
      "Withdrawal from key worker or sudden secrecy about contacts",
      "Return presenting under the influence",
    ],
    review_schedule: "Fortnightly key-worker review; multi-agency review every 6 weeks",
    escalation_criteria: [
      "Any return from missing showing significant intoxication",
      "Disclosure of new debt or threats",
      "Escalation in frequency or move to higher-risk substances",
    ],
    next_screening_date: "2026-06-18",
    confidentiality_framing: "Discussed limits of confidentiality at outset; Alex aware that information indicating risk of harm or exploitation will be shared with his social worker and safeguarding leads, and consented to CAMHS sharing.",
  ...
  },
  {
    ...
    conducted_by: "staff_anna",
    screening_tool: "conversation_based" as const,
    risk_level: "no_identified_risk" as const,
    substances_identified: [],
    context_of_use: "No substance use identified. Routine preventative screen completed as part of admission health and wellbeing review.",
    peer_influences: "Settled peer group within placement and at school; no indication of pressure to use substances at this time.",
    family_history: "No disclosed family history of substance dependence on the information currently available.",
    education_provided: [
      "Age-appropriate conversation about alcohol, vaping and drugs",
      "Information on staying safe online and offline from peer pressure",
    ],
    harm_reduction_approach: [
      "Open-door approach: key worker available to talk without judgement",
    ],
    professional_support_in_place: [
      "Allocated social worker (oversight)",
    ],
    child_insight: "Jordan was able to talk openly and understood the purpose of the conversation. Says he 'isn't interested' in substances and would tell staff if offered anything.",
    child_motivation: "Keen to focus on football and school; positive about keeping healthy.",
    warning_signs_to_watch: [
      "Change in peer group or new unknown contacts",
      "Unexplained items or money",
      "Withdrawal or marked change in mood or sleep",
    ],
    review_schedule: "Routine review at next placement planning meeting; informal key-worker check-ins ongoing",
    escalation_criteria: [
      "Any disclosure or observation of substance use",
      "Emergence of risky peer associations",
    ],
    next_screening_date: "2026-11-12",
    confidentiality_framing: "Explained that this was a normal wellbeing conversation and that anything raising a safety concern would be shared with his social worker; Jordan was comfortable with this.",
    shared_with_social_worker: true,
  ...
  },
  {
    id: "subs_casey_1",
    child_id: "yp_casey",
    screening_date: "2026-05-28",
    conducted_by: "staff_chervelle",
    screening_tool: "internal_brief_screen" as const,
    risk_level: "awareness_only" as const,
    substances_identified: [],
    context_of_use: "No illicit substance use identified. Some curiosity about alcohol in social contexts; brief alcohol-awareness work completed. Prescribed Melatonin and Fluoxetine taken as directed under medication support.",
    peer_influences: "Older peer group outside placement occasionally drinks; Casey reports declining and feeling confident to do so. No pressure currently of concern.",
    family_history: "No reliable disclosure of family substance dependence on current information.",
    education_provided: [
      "Alcohol-awareness 1:1 (units, effects, and interaction with prescribed medication)",
      "Discussion of why mixing alcohol with Fluoxetine and Melatonin is unsafe",
      "Assertiveness and 'how to say no' in social settings",
    ],
    harm_reduction_approach: [
      "Agreed plan to contact staff if in a situation where alcohol is offered",
      "Medication kept and administered with staff support to ensure safe use",
    ],
    professional_support_in_place: [
      "CAMHS (low-mood and sleep, prescribing oversight)",
      "Allocated social worker (oversight)",
    ],
    child_insight: "Casey understands how alcohol could interact with her prescribed medication and can explain why she avoids it. Reflective and able to identify situations she finds tricky.",
    child_motivation: "Motivated to manage her mood and sleep well; values staff support and wants to keep making progress.",
    warning_signs_to_watch: [
      "Returning home smelling of alcohol or appearing intoxicated",
      "Skipped or hoarded medication",
      "Dip in mood or increased social withdrawal",
    ],
    review_schedule: "Reviewed at monthly key-worker and CAMHS check-ins",
    escalation_criteria: [
      "Any use of alcohol alongside prescribed medication",
      "Signs of medication misuse or non-compliance",
      "Disclosure of illicit substance use",
    ],
    next_screening_date: "2026-08-28",
    confidentiality_framing: "Discussed that the conversation was supportive and confidential within the team, but that anything affecting her safety or medication would be shared with CAMHS and her social worker; Casey agreed.",
    shared_with_social_worker: true,
    shared_with_camhs: true,
    child_authored: false,
...
// ── Trauma / therapy session logs (seed) ──────────────────────────────────────
// A session series over ~8 weeks. Mixed: Alex (3, incl. one non-attendance +
// escalation flags, improving arc); Jordan (2, strong); Casey (2, one harder).
store.traumaTherapyLogs = [
  {
    id: "ttl_alex_1",
    child_id: "yp_alex",
    session_date: daysFromNow(-52),
    modality: "ddp" as const,
    therapist_name: "Dr Rebecca Hartley",
    therapist_service: "CAMHS Trauma Team",
    session_format: "one_to_one" as const,
    session_length_minutes: 60,
    attended: true,
    general_theme_broad: "Building safety and trust within the therapeutic relationship; early exploration of past experiences at a pace led by Alex.",
    child_presentation: "building_trust" as const,
    pre_session_mood_rating: 4,
    post_session_mood_rating: 5,
    regulation_strategies_used_after: ["Grounding breathing", "Quiet time in bedroom with music"],
    between_session_support: "Key worker check-ins offered each evening; sensory box made available.",
    escalation_flags: [],
    child_voice_shared: "Said the sessions feel 'a bit awkward but okay' and that he likes that no one pushes him to talk.",
    staff_observation: "Alex was guarded on arrival but settled across the hour. Asked one question about what happens to the notes, which the therapist answered openly.",
    next_session: daysFromNow(-38),
  ...
  },
  {
    ...
    session_length_minutes: 60,
    attended: false,
    reason_if_missed: "Alex declined to attend on the day, reporting low mood and disrupted sleep the night before. Non-attendance communicated to CAMHS and rebooked.",
    general_theme_broad: "Session not held — continuation of trust-building work deferred.",
    child_presentation: "withdrawn" as const,
    pre_session_mood_rating: 3,
    post_session_mood_rating: 3,
    regulation_strategies_used_after: ["Stayed in room", "1:1 walk with key worker later that afternoon"],
    between_session_support: "Key worker spent additional time with Alex; sleep difficulties logged and GP review considered.",
    escalation_flags: ["Session non-attendance", "Reported sleep disruption and low mood"],
    child_voice_shared: "Told staff he 'just couldn't face it today' and wanted to be left alone for a while.",
    staff_observation: "Alex remained in his room for much of the morning. Engaged warmly on a later walk, which suggests the reluctance was situational rather than a wider disengagement.",
    next_session: daysFromNow(-24),
    recorded_by: "staff_edward",
  ...
  },
  {
    id: "ttl_alex_3",
    child_id: "yp_alex",
    session_date: daysFromNow(-24),
    modality: "ddp" as const,
    therapist_name: "Dr Rebecca Hartley",
    therapist_service: "CAMHS Trauma Team",
    session_format: "one_to_one" as const,
    session_length_minutes: 55,
    attended: true,
    general_theme_broad: "Re-engagement after the missed session; naming and noticing feelings, with attention to recent sleep and mood.",
    child_presentation: "engaged" as const,
    pre_session_mood_rating: 5,
    post_session_mood_rating: 7,
    regulation_strategies_used_after: ["Grounding breathing", "Listened to music", "Talked it through with key worker"],
    between_session_support: "Agreed a simple wind-down routine before bed; key worker to support consistency.",
    escalation_flags: [],
    child_voice_shared: "Said he was glad he came back and that 'it was easier than last time'.",
    staff_observation: "Noticeably more open than previous sessions. Made eye contact and initiated conversation about school, which is new.",
    next_session: daysFromNow(-10),
    recorded_by: "staff_edward",
  ...
  },
  {
    ...
    modality: "person_centred" as const,
    therapist_name: "Maria Osei",
    therapist_service: "Therapeutic Support Service",
    session_format: "one_to_one" as const,
    session_length_minutes: 50,
    attended: true,
    general_theme_broad: "Settling into the home; identifying feelings and early emotional-regulation skills using simple, age-appropriate tools.",
    child_presentation: "engaged" as const,
    pre_session_mood_rating: 6,
    post_session_mood_rating: 8,
    regulation_strategies_used_after: ["Feelings chart", "Counting to ten before responding"],
    between_session_support: "Key worker reinforcing the feelings chart during daily routines.",
    escalation_flags: [],
    child_voice_shared: "Said he likes Maria and found the worksheet 'fun'.",
    staff_observation: "Jordan was chatty and cooperative throughout. Settling into the home well and clearly comfortable with the therapist.",
    next_session: daysFromNow(-9),
    recorded_by: "staff_anna",
  ...
  },
  {
    ...
    session_length_minutes: 50,
    attended: true,
    general_theme_broad: "Practising emotional-regulation strategies; recognising early warning signs of frustration and what helps.",
    child_presentation: "engaged" as const,
    pre_session_mood_rating: 7,
    post_session_mood_rating: 8,
    regulation_strategies_used_after: ["Counting to ten before responding", "Asking for space when needed"],
    between_session_support: "Staff prompting Jordan to use his agreed strategies when he becomes frustrated.",
    escalation_flags: [],
    child_voice_shared: "Said he had used his 'count to ten' once during the week and it 'kind of worked'.",
    staff_observation: "Good attendance and consistent engagement. Jordan is beginning to generalise strategies outside of sessions, which staff have observed at home.",
    next_session: daysFromNow(12),
    recorded_by: "staff_anna",
  ...
  },
  {
    id: "ttl_casey_1",
    child_id: "yp_casey",
    session_date: daysFromNow(-45),
    modality: "cbt_general" as const,
    therapist_name: "Dr Sunil Pereira",
    therapist_service: "CAMHS",
    session_format: "one_to_one" as const,
    session_length_minutes: 60,
    attended: true,
    general_theme_broad: "Assessment and formulation around low mood and disrupted sleep; psychoeducation on the link between sleep, activity and mood.",
    child_presentation: "mixed" as const,
    pre_session_mood_rating: 4,
    post_session_mood_rating: 5,
    regulation_strategies_used_after: ["Sleep diary", "Reduced screen time before bed"],
    between_session_support: "Staff supporting a consistent bedtime routine and completing the sleep diary with Casey.",
    escalation_flags: [],
    child_voice_shared: "Said she 'doesn't sleep much' and feels 'flat most days', but was willing to try the sleep diary.",
    staff_observation: "Casey attended on time and participated, though her affect was low. Engaged more readily once the conversation moved to practical sleep strategies.",
    next_session: daysFromNow(-31),
  ...
  },
  {
    ...
    session_length_minutes: 60,
    attended: true,
    general_theme_broad: "Reviewing the sleep diary and low mood; behavioural-activation ideas to gently increase daytime activity.",
    child_presentation: "withdrawn" as const,
    pre_session_mood_rating: 3,
    post_session_mood_rating: 4,
    regulation_strategies_used_after: ["Short daily walk", "Continued sleep diary"],
    between_session_support: "Key worker to encourage one small planned activity each day and check in on mood.",
    escalation_flags: [],
    child_voice_shared: "Said it had been 'a harder week' and that getting up in the mornings felt difficult.",
    staff_observation: "A harder session — Casey was quieter and more withdrawn than last time, reflecting a tougher week. She stayed for the full hour and completed the diary, which is a positive sign of commitment.",
    next_session: daysFromNow(-3),
    recorded_by: "staff_chervelle",
    created_at: daysFromNow(-31),
  },
];

// ── Multi-disciplinary formulations (seed) ────────────────────────────────────
// Mixed: Alex comprehensive trauma-informed (v2, 4 agencies, future review);
// Jordan lighter v1 (2 participants); Casey integrated v2 (review imminent).
store.multiDisciplinaryFormulations = [
  {
    id: "mdf_alex_1",
    child_id: "yp_alex",
    version: 2,
    formulation_date: daysFromNow(-21),
    model_used: "trauma_informed" as const,
    participants_attended: [
      "staff_edward (Key Worker)",
      "CAMHS Clinical Psychologist",
      "Allocated Social Worker (Local Authority)",
      "Police — Child Exploitation Team (CET)",
    ],
    presenting_difficulties: [
      "Episodes of self-harm (superficial cutting), increasing in frequency over the last term",
      "Repeated unauthorised absences associated with suspected child criminal exploitation",
      "Hypervigilance and difficulty trusting adults, consistent with developmental trauma",
    ],
    predisposing: [
      "Early-childhood neglect and multiple placement moves prior to admission",
      "Disrupted primary attachment; limited experience of consistent, attuned caregiving",
    ],
    precipitating: [
      "Contact from a known older peer linked to a county-lines network",
      "Anniversary of removal from birth family coinciding with rise in self-harm",
    ],
    perpetuating: [
      "Exploiters reinforcing a sense of belonging and financial reward",
      "Shame and secrecy around self-harm limiting help-seeking",
    ],
    protective: [
      "Strong, consistent relationship with key worker staff_edward",
      "Engagement with weekly CAMHS sessions",
      "Stable education placement with named pastoral lead",
    ],
    key_hypotheses: [
      "Self-harm functions as affect-regulation in the absence of trusted co-regulation; trauma-informed relational repair is the primary lever",
      "Exploitation risk is sustained by unmet attachment needs that the network appears to meet — safety planning must offer genuine belonging within the home",
    ],
    agreed_interventions: [
      "Twice-weekly CAMHS trauma-focused sessions, reviewed at 6 weeks",
      "Contextual safeguarding plan co-owned with the Police CET, with mapped associates and return-home interview protocol",
      "Key-worker-led daily check-in and agreed self-harm safety plan (urge-surfing, replacement strategies)",
    ],
    risk_factors: [
      "Active child criminal exploitation by an identified network",
      "Self-harm with escalating frequency",
      "Going missing from placement",
    ],
    child_contribution:
      "Alex contributed via a one-page profile and a key-worker session: identifies football and music as things that help him feel calm, says he 'doesn't want to be a grass' but agreed return-home interviews can happen with staff_edward present.",
    next_review_date: daysFromNow(21),
    internal_lead: "staff_edward",
    shareable_summary:
      "Trauma-informed formulation for a 16-year-old (S20) with developmental trauma, self-harm and child criminal exploitation risk. Multi-agency interventions in place (CAMHS, contextual safeguarding with Police CET, key-worker safety planning). Review due in three weeks.",
    confidential_notes:
      "Network associate details and intelligence shared by Police CET held on the contextual safeguarding map; not for inclusion in shareable summary.",
    created_at: daysFromNow(-21),
  },
  {
    id: "mdf_jordan_1",
    child_id: "yp_jordan",
    version: 1,
    formulation_date: daysFromNow(-40),
    model_used: "attachment_based" as const,
    participants_attended: [
      "staff_anna (Key Worker)",
      "Allocated Social Worker (Local Authority)",
    ],
    presenting_difficulties: [
      "Difficulty settling at bedtime and seeking frequent reassurance",
      "Short-lived emotional outbursts when routines change unexpectedly",
    ],
    predisposing: [
      "Several short-term placements before arriving at the home",
    ],
    precipitating: [
      "Recent transition into the home and a new school",
    ],
    perpetuating: [],
    protective: [
      "Warm, developing relationship with key worker staff_anna",
      "Predictable daily routine and consistent staff team",
      "Enjoys football and looking after the home's garden",
    ],
    key_hypotheses: [
      "Bedtime difficulties reflect attachment-related anxiety during a period of transition; consistency and predictable nurture should support settling",
    ],
    agreed_interventions: [
      "Consistent wind-down routine led by the on-shift key-worker figure",
      "Daily 'special time' with staff_anna to build felt security",
    ],
    risk_factors: [
      "Emotional dysregulation during unplanned change",
    ],
    child_contribution:
      "Jordan said he sleeps better when the landing light is left on and likes a story or a chat before bed; chose the wording 'I just want to feel settled' for his plan.",
    next_review_date: daysFromNow(50),
    internal_lead: "staff_anna",
    shareable_summary:
      "Attachment-based formulation for a 14-year-old (S31) focused on settling and emotional regulation during placement transition. Positive trajectory; supported by consistent routine and key-worker relationship.",
    confidential_notes: "",
  ...
  },
  {
    ...
    child_id: "yp_casey",
    version: 2,
    formulation_date: daysFromNow(-30),
    model_used: "integrated" as const,
    participants_attended: [
      "staff_chervelle (Key Worker)",
      "CAMHS Practitioner",
      "GP",
    ],
    presenting_difficulties: [
      "Persistent low mood with reduced motivation and social withdrawal",
      "Disrupted sleep — difficulty falling asleep and early-morning waking",
    ],
    predisposing: [
      "Family history of low mood",
      "Bereavement of a close relative two years ago",
    ],
    precipitating: [
      "Recent medication review and adjustment of dosage",
      "Reduced contact with a sibling over the winter",
    ],
    perpetuating: [
      "Sleep disruption maintaining daytime fatigue and low mood",
      "Withdrawal reducing access to enjoyable, mood-lifting activities",
    ],
    protective: [
      "Engaged with CAMHS and attends GP medication reviews",
      "Good relationship with key worker staff_chervelle",
    ],
    key_hypotheses: [
      "Low mood and sleep disruption are mutually reinforcing; combined medication review and behavioural activation should interrupt the cycle",
      "Version 2 updates the formulation following the medication change to track its effect on sleep and mood over the next month",
    ],
    agreed_interventions: [
      "GP and CAMHS joint medication review at four weeks to assess the dosage change",
      "Sleep-hygiene plan and morning behavioural-activation routine supported by key worker",
      "Weekly mood and sleep diary reviewed in key-worker sessions",
    ],
    risk_factors: [
      "Persistent low mood",
      "Sleep deprivation affecting daytime functioning",
    ],
    child_contribution:
      "Casey helped update the plan, said the new medication 'makes mornings a bit easier but I'm still up late'; agreed to try a no-screens-before-bed routine and to keep the mood diary.",
    next_review_date: daysFromNow(5),
    internal_lead: "staff_chervelle",
    shareable_summary:
      "Integrated formulation (v2) for a 16-year-old (S31) addressing low mood, sleep disruption and a recent medication change. Joint CAMHS/GP review imminent (within a week) to evaluate response.",
    confidential_notes:
      "Specific medication name and dosage held in the health record; summarised here only as 'recent dosage adjustment'.",
    created_at: daysFromNow(-12),
  },
];

// ── Post-incident child debriefs (seed) ───────────────────────────────────────
// Linked to seeded incidents. Mixed quality: prompt + fully-engaged debriefs vs
// Alex's delayed/declined one after inc_007 (child not ready) — surfaces gaps.
store.postIncidentChildDebriefs = [
  {
    id: "picd_alex_1",
    child_id: "yp_alex",
    incident_ref: "inc_005",
    incident_date: daysFromNow(-21),
    debrief_date: daysFromNow(-20),
    debrief_staff: "staff_edward",
    debrief_method: "conversation" as const,
    child_ready_to_debrief: true,
    readiness_indicators: "Alex was calm and settled the morning after the incident, sought out his key worker himself and said he wanted to 'talk it through'. Offered a quiet space and a drink before starting.",
    child_account_of_what_happened: "Alex said he had felt 'cornered' when staff stood near the doorway and that he 'just wanted to get out of the room'. He recognised he had pushed past staff and that a hold was used to keep him and others safe. He said it 'didn't last long' and that staff let go as soon as he stopped pulling.",
    child_feelings_before_during: "Described feeling 'wound up all day' over a cancelled family contact, then 'panicky and trapped' in the moment. Said his 'heart was racing' and he 'couldn't think straight'.",
    child_feelings_now: "Calmer and a bit embarrassed. Said he 'doesn't like it getting to that point' and was relieved no one was hurt.",
    ...
    what_did_not_help: [
      "Being blocked from leaving the room",
      "Another young person watching from the hallway",
    ],
    child_requests_for_future: [
      "Be told about contact changes face-to-face and earlier in the day",
      "Have a clear exit left open so he doesn't feel trapped",
    ...
    support_needed_now: "Continue daily check-ins with key worker this week; review contact arrangements with social worker so changes are communicated earlier.",
    follow_up_date: daysFromNow(-13),
    recorded_by: "staff_edward",
  },
  {
    id: "picd_alex_2",
    child_id: "yp_alex",
    incident_ref: "inc_007",
    incident_date: daysFromNow(-6),
    debrief_date: daysFromNow(-1),
    debrief_staff: "staff_edward",
    debrief_method: "conversation" as const,
    child_ready_to_debrief: false,
    readiness_indicators: "Alex declined to debrief on the day and for several days after, saying he 'didn't want to talk about it'. Staff checked in daily and left the offer open. When he did sit down he remained guarded and ended the conversation early.",
    child_account_of_what_happened: "Alex gave only a brief account, saying 'it was the same as last time' and that he 'didn't really remember'. He did not want to go into detail and asked to stop.",
    child_feelings_before_during: "",
    child_feelings_now: "Said he was 'fine' and 'over it'. Presented as flat and reluctant to explore further.",
    what_child_wishes_had_been_different: "",
    what_helped_child: [
      "Not being pushed to talk before he was ready",
    ],
    what_did_not_help: [
      "Being asked about it 'too soon' on the day of the incident",
    ],
    child_requests_for_future: [
      "Be left alone for a while afterwards before anyone asks him about it",
    ],
    apologies_offered: "",
    apologies_received: "",
    repairs_agreed: [],
    child_accepts_outcome: false,
    support_needed_now: "Re-offer the debrief later this week once Alex is more settled; consider whether an advocate or his key worker only would help him feel safer to talk. Flag the partial/declined debrief for the team meeting.",
    follow_up_date: "",
    recorded_by: "staff_edward",
  },
  {
    id: "picd_jordan_1",
    child_id: "yp_jordan",
    incident_ref: "inc_003",
    incident_date: daysFromNow(-9),
    debrief_date: daysFromNow(-8),
    debrief_staff: "staff_anna",
    debrief_method: "walk_and_talk" as const,
    child_ready_to_debrief: true,
    readiness_indicators: "Jordan settled quickly after the argument and was happy to talk while walking to the shop with his key worker the next day, which he finds easier than sitting face-to-face.",
    child_account_of_what_happened: "Jordan said he and another young person had argued over the TV remote and that he 'said some things he didn't mean' and slammed a door. He was clear it 'didn't get physical' and that staff stepped in and split them up calmly.",
    child_feelings_before_during: "Said he was 'already in a mood' after a bad day at school and that the other young person 'wound him up'. Felt 'angry and ignored'.",
    child_feelings_now: "Settled and a bit sorry. Said he and the other young person are 'okay now'.",
    what_child_wishes_had_been_different: "Wishes he had walked away instead of arguing back, and that he had told staff he was in a bad mood when he got in from school.",
    what_helped_child: [
      "Staff staying calm and not shouting",
      "Being given space in his room to cool off",
      "Talking it through on the walk the next day",
    ],
    what_did_not_help: [
      "Being in the same room as the other young person while still angry",
    ],
    child_requests_for_future: [
      "A reminder to use his cool-down card when he gets in from a hard day",
      "A rota for the TV at busy times",
    ],
    apologies_offered: "Jordan apologised to the other young person for what he said, with staff support.",
    apologies_received: "The other young person apologised back; both agreed to 'start fresh'.",
    repairs_agreed: [
      "A shared TV-time agreement drawn up with both young people",
      "Jordan to check in with staff when he gets home from school if he's had a hard day",
    ],
    child_accepts_outcome: true,
    support_needed_now: "Continue using cool-down card; light-touch check-in after school this week.",
  ...
  },
  {
    id: "picd_casey_1",
    child_id: "yp_casey",
    incident_ref: "inc_002",
    incident_date: daysFromNow(-15),
    debrief_date: daysFromNow(-14),
    debrief_staff: "staff_chervelle",
    debrief_method: "conversation" as const,
    child_ready_to_debrief: true,
    readiness_indicators: "Casey was calm and willing to talk the day after the medication error was identified. Reassured first that she had not done anything wrong and that the team were sorry.",
    child_account_of_what_happened: "Casey said she 'didn't really know' a mistake had happened until staff told her, but that she'd noticed she felt 'a bit off'. She appreciated that staff explained what had gone wrong with her medication and what they were doing about it.",
    child_feelings_before_during: "Said she had felt 'a bit worried' when staff seemed concerned, but did not feel unwell at the time.",
    child_feelings_now: "Reassured and 'fine'. Said she trusts staff to 'sort it out' and was glad they were honest with her.",
    what_child_wishes_had_been_different: "Wishes the mistake hadn't happened but said she was 'glad they told me straight away'.",
    what_helped_child: [
      "Staff being honest and explaining it in a way she understood",
      "Being told it wasn't her fault",
      "The nurse checking her over and answering her questions",
    ],
    what_did_not_help: [
      "Seeing staff looking stressed before they explained what was going on",
    ],
    child_requests_for_future: [
      "Keep telling her straight away if something goes wrong with her medication",
    ...
    child_accepts_outcome: true,
    support_needed_now: "Continue monitoring as advised by the nurse; confirm with Casey that she feels listened to at her next key-worker session.",
