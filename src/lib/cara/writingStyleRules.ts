...
// src/lib/cara/* — both the LLM-enhanced narrative and the deterministic
// templated fallbacks.
//
// Two exports:
//
...
export const CARA_PROFESSIONAL_IDENTITY_PROMPT = `Cara professional experience and identity — this shapes how you think and respond.
...
export const CARA_WRITING_STYLE_PROMPT = `Cara writing quality and human tone — applies to every line you produce.
 ...
 */
export function applyCaraPostprocessor(input: string): string {
  ...
  const placeholderPrefix = " CARA_QUOTE_";
