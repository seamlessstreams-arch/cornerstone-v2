...
import type { AriaGenerationRequest, AriaSource } from "@/types/aria-studio";
...
function buildSource(data: Omit<AriaSource, "tags" | "category" | "confidentiality_level" | "extracted_text" | "summary" | "updated_at" | "archived_at">): AriaSource {
  return {
    ...data,
    tags: [],
    category: null,
