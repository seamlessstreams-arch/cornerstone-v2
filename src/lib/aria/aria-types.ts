...
import type { AriaPermission, AriaRole } from "./aria-permissions";

export type AriaConfidence = "low" | "medium" | "high";

export type AriaCommandId =
  // General writing
  | "improve_writing"
...
export interface AriaInvocationInput {
...
export interface AriaActorPayload {
  userId: string;
  role: AriaRole;
  organisationId?: string;
  homeId?: string;
...
export interface AriaTranscriptionResult {
