// ══════════════════════════════════════════════════════════════════════════════
// Tests: AriaWeeklyDigest _testing exports
// ══════════════════════════════════════════════════════════════════════════════

import { describe, it, expect } from "vitest";
import { _testing } from "@/components/aria/aria-weekly-digest";

const { PRIORITY_CONFIG, getDemoDigest } = _testing;

describe("AriaWeeklyDigest", () => {
  ...
  describe("getDemoDigest", () => {
    ...
    it("has stats with all required fields", () => {
      ...
      expect(typeof digest.stats.ariaOutputsGenerated).toBe("number");
      expect(typeof digest.stats.ariaOutputsApproved).toBe("number");
    });

    it("approved is less than or equal to generated", () => {
      expect(digest.stats.ariaOutputsApproved).toBeLessThanOrEqual(digest.stats.ariaOutputsGenerated);
    });
