...
export class AriaEvidenceEngine {
   ...
   */
  async search(query: AriaEvidenceQuery): Promise<AriaEvidenceResult[]> {
  ...
  private filterByPermissions(query: AriaEvidenceQuery): EvidenceEmbedding[] {
  ...
  private canUseInReporting(sourceType: EvidenceSourceType, role: AriaRole): boolean {
...
// Singleton
export const ariaEvidenceEngine = new AriaEvidenceEngine();
