...
export const TASKS_REQUIRING_APPROVAL: AriaTaskType[] = [
...
export const CRITICAL_RISK_TASKS: AriaTaskType[] = [
  "safeguarding_analysis",
  "risk_assessment_update",
  "placement_planning",
];
...
export const PROVIDER_MAX_SENSITIVITY: Record<AriaProviderName, AriaDataSensitivity[]> = {
...
export const ENTERPRISE_GOVERNED_PROVIDERS: AriaProviderName[] = [
  "azure_openai",
  "bedrock",
];
...
export const TASK_PROVIDER_PREFERENCE: Partial<Record<AriaTaskType, AriaProviderName[]>> = {
...
export const TASK_DEFAULT_RISK: Record<AriaTaskType, AriaRiskLevel> = {
...
export const TASK_DEFAULT_SENSITIVITY: Partial<Record<AriaTaskType, AriaDataSensitivity>> = {
