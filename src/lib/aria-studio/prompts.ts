...
export const ARIA_STUDIO_SYSTEM_PROMPT = `${ARIA_PROFESSIONAL_IDENTITY_PROMPT}
...
export const FRAMEWORK_PROMPTS: Record<AriaStudioFramework, string> = {
...
export const TONE_PROMPTS: Record<AriaStudioTone, string> = {
...
export const ARTIFACT_TYPE_PROMPTS: Record<AriaStudioArtifactType, { systemFragment: string; outputStructure: string[] }> = {
  keywork_session: {
