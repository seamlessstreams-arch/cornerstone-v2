...
import type { AriaChildProfile, EvidenceRef } from "./types";
...
export async function buildChildProfile(
  ...
  // ── Build profile ──────────────────────────────────────────────────────────
  const profile: AriaChildProfile = {
    childId,
...
function buildDemoProfile(childId: string): AriaChildProfile {
