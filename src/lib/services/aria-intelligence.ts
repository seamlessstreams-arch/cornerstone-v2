...
import type {
  CsAriaRecommendation, AriaRecommendationType,
  AriaRecommendationSeverity, AriaRecommendationStatus,
  ServiceResult,
...
): Promise<ServiceResult<CsAriaRecommendation[]>> {
  const s = sb();
