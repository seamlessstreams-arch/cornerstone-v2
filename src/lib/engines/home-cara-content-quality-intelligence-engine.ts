...
export interface CaraContentQualityInput {
  today: string;
  total_staff: number;
  total_children: number;
  artifacts: CaraArtifactInput[];
}

// ── Output Types ────────────────────────────────────────────────────────────

export type CaraContentRating =
  | "outstanding"
  | "good"
  | "adequate"
  | "inadequate"
...
export interface CaraContentQualityResult {
  content_rating: CaraContentRating;
...
export function computeCaraContentQuality(
  input: CaraContentQualityInput,
): CaraContentQualityResult {
