...
export async function POST(req: Request) {
  ...
  if (shouldPersist) {
    const assessment = db.caraPracticeAssessments.create({
      ...
      cara_advice: output.recommendations,
      cara_flags: output.flags,
      cara_recommendations: output.recommendations,
      cara_questions: output.questions,
      cara_draft_output: null,
      reviewer_id: null,
      reviewed_at: null,
