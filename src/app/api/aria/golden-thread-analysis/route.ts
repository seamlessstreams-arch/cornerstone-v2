// ══════════════════════════════════════════════════════════════════════════════
// API: /api/aria/golden-thread-analysis
//
// GET — Analyse golden thread for a child
// ══════════════════════════════════════════════════════════════════════════════

import { NextRequest, NextResponse } from "next/server";
import { analyseGoldenThread, type GoldenThreadInput } from "@/lib/aria/golden-thread-analyser";
...
export async function GET(req: NextRequest) {
  try {
    ...
    console.error("[aria/golden-thread-analysis] GET error:", err);
