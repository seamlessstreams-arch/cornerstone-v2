// ══════════════════════════════════════════════════════════════════════════════
// POST /api/aria/write-to-child
// GET  /api/aria/write-to-child?recordId=xxx
//
...
export async function POST(request: Request) {
  try {
    ...
    console.error("[aria/write-to-child] POST Error:", err);
...
export async function GET(request: Request) {
  try {
    ...
    console.error("[aria/write-to-child] GET Error:", err);
