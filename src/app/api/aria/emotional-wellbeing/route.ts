// ══════════════════════════════════════════════════════════════════════════════
// API: /api/aria/emotional-wellbeing — Emotional Wellbeing Intelligence
//
...
import { analyseEmotionalWellbeing } from "@/lib/aria/emotional-wellbeing-intelligence";
import { createServerClient, isSupabaseEnabled } from "@/lib/supabase/server";
import type { EmotionalWellbeingInput, SDQScore, TherapeuticInput, SelfHarmIncident, MoodRecord } from "@/lib/aria/emotional-wellbeing-intelligence";
...
export async function GET(req: NextRequest) {
  try {
    ...
    console.error("[aria/emotional-wellbeing] Error:", err);
    return NextResponse.json(
