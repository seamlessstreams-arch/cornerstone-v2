// ══════════════════════════════════════════════════════════════════════════════
// API: /api/aria/recording-quality
//
...
import { scoreRecordingQuality, scoreBatch, type RecordingInput } from "@/lib/aria/recording-quality";
...
export async function POST(req: NextRequest) {
  try {
    ...
    console.error("[aria/recording-quality] POST error:", err);
...
export async function GET(req: NextRequest) {
  try {
    ...
    console.error("[aria/recording-quality] GET error:", err);
