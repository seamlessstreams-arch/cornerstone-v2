// ══════════════════════════════════════════════════════════════════════════════
// API: /api/aria/complaints — Complaints & Representations Intelligence
//
...
import { analyseComplaints } from "@/lib/aria/complaints-intelligence";
import { createServerClient, isSupabaseEnabled } from "@/lib/supabase/server";
import type { ComplaintsInput, Complaint } from "@/lib/aria/complaints-intelligence";
...
export async function GET(req: NextRequest) {
  try {
    ...
    console.error("[aria/complaints] Error:", err);
    return NextResponse.json(
