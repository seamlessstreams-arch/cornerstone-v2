// ══════════════════════════════════════════════════════════════════════════════
// API: /api/aria/pattern-detection
//
...
import { analysePatterns, type TimelineEvent } from "@/lib/aria/pattern-detection";
...
export async function GET(req: NextRequest) {
  try {
    ...
    console.error("[aria/pattern-detection] GET error:", err);
...
export async function POST(req: NextRequest) {
  try {
    ...
    console.error("[aria/pattern-detection] POST error:", err);
    return NextResponse.json({ error: "Failed to analyse patterns" }, { status: 500 });
  }
}
