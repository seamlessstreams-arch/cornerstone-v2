// ══════════════════════════════════════════════════════════════════════════════
// API: /api/aria/medication-intelligence
//
// GET — Analyse medication administration for a home
// ══════════════════════════════════════════════════════════════════════════════

import { NextRequest, NextResponse } from "next/server";
import { analyseMedications, type MedicationRecord, type MedicationProfile } from "@/lib/aria/medication-intelligence";
...
export async function GET(req: NextRequest) {
  try {
    ...
    console.error("[aria/medication-intelligence] GET error:", err);
