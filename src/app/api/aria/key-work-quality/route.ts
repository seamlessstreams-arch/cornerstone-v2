// ══════════════════════════════════════════════════════════════════════════════
// API: /api/aria/key-work-quality
//
// GET — Analyse key work session quality for a home
// ══════════════════════════════════════════════════════════════════════════════

import { NextRequest, NextResponse } from "next/server";
import { analyseKeyWork, type KeyWorkSession, type KeyWorkConfig } from "@/lib/aria/key-work-quality";
...
export async function GET(req: NextRequest) {
  try {
    ...
    console.error("[aria/key-work-quality] GET error:", err);
