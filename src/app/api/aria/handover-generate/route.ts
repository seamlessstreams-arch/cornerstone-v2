// ══════════════════════════════════════════════════════════════════════════════
// API: /api/aria/handover-generate
//
...
import type { AriaRequest } from "@/lib/aria/orchestrator/types";
...
export async function POST(req: NextRequest) {
  try {
    ...
    console.error("[aria/handover-generate] Error:", err);
    return NextResponse.json(
