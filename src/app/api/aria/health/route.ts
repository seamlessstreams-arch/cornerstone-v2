// ══════════════════════════════════════════════════════════════════════════════
// API: /api/aria/health — Health Intelligence (Physical)
//
...
import { analyseHealth } from "@/lib/aria/health-intelligence";
...
import type {
  ...
  HealthAppointment,
  Medication,
} from "@/lib/aria/health-intelligence";
...
export async function GET(req: NextRequest) {
  try {
    ...
    console.error("[aria/health] Error:", err);
    return NextResponse.json(
