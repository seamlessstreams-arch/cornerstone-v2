// ══════════════════════════════════════════════════════════════════════════════
// API: /api/aria/suggest-actions
// Convenience wrapper — calls invokeAriaCommand with commandId "extract_actions".
// ══════════════════════════════════════════════════════════════════════════════

import { NextRequest, NextResponse } from "next/server";
import { invokeAriaCommand } from "@/lib/aria/aria-service";
import type { AriaActor, AriaRole } from "@/lib/aria/aria-permissions";
