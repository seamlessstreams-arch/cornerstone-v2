...
import { reportGenerationRequestSchema } from "@/lib/aria/ai/schemas";
import { generateChildReport } from "@/lib/aria/reports/report-generator";
...
export async function POST(req: NextRequest) {
  try {
    ...
    console.error("[api/aria/reports/generate] Error:", err);
    return NextResponse.json(
      {
        ok: false,
