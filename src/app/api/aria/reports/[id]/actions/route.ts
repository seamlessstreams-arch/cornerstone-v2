// ══════════════════════════════════════════════════════════════════════════════
// API: /api/aria/reports/[id]/actions
//
...
import { generateSuggestedActions } from "@/lib/aria/challenge/challenge-mode";
...
export async function GET(
  ...
  try {
    ...
    console.error("[api/aria/reports/[id]/actions] GET error:", err);
...
export async function POST(
  ...
  try {
    ...
    console.error("[api/aria/reports/[id]/actions] POST error:", err);
    return NextResponse.json(
      {
        ok: false,
        error: err instanceof Error ? err.message : "Internal server error",
