// ══════════════════════════════════════════════════════════════════════════════
// API: /api/aria/reports/[id]/rewrite
//
...
import { rewriteSection } from "@/lib/aria/reports/report-generator";
import { REPORT_AUDIENCES } from "@/types/aria-reports";
import type { ReportAudience } from "@/types/aria-reports";
...
export async function POST(
  ...
  try {
    ...
    console.error("[api/aria/reports/[id]/rewrite] Error:", err);
    return NextResponse.json(
      {
        ok: false,
