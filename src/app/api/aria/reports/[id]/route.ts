...
import {
  getReport,
  updateReportSection,
} from "@/lib/aria/reports/report-generator";
...
export async function GET(
  ...
  try {
    ...
    console.error("[api/aria/reports/[id]] GET error:", err);
    return NextResponse.json(
      {
        ok: false,
...
export async function PUT(
  ...
  try {
    ...
    console.error("[api/aria/reports/[id]] PUT error:", err);
    return NextResponse.json(
      {
        ok: false,
        error: err instanceof Error ? err.message : "Internal server error",
