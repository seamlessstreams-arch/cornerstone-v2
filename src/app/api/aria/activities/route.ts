// ══════════════════════════════════════════════════════════════════════════════
// API: /api/aria/activities — Activities & Enrichment Intelligence
//
...
import { analyseActivities } from "@/lib/aria/activities-intelligence";
import { createServerClient, isSupabaseEnabled } from "@/lib/supabase/server";
import type { ActivityInput, Activity, ActivityCategory } from "@/lib/aria/activities-intelligence";
...
export async function GET(req: NextRequest) {
  try {
    ...
    console.error("[aria/activities] Error:", err);
    return NextResponse.json(
