// ══════════════════════════════════════════════════════════════════════════════
// API: /api/aria/placement-stability — Placement Stability Intelligence
//
...
import { analysePlacementStability } from "@/lib/aria/placement-stability-intelligence";
import { createServerClient, isSupabaseEnabled } from "@/lib/supabase/server";
import type { PlacementStabilityInput, PlacementHistory, DisruptionIndicator } from "@/lib/aria/placement-stability-intelligence";
...
export async function GET(req: NextRequest) {
  try {
    ...
    console.error("[aria/placement-stability] Error:", err);
    return NextResponse.json(
