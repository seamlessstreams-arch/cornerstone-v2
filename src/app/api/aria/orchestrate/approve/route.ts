...
import { hasIntelligencePermission } from "@/lib/aria/intelligence-permissions";
...
export async function POST(req: NextRequest) {
  ...
  if (updateError || !updatedDraft) {
    console.error("[api/aria/orchestrate/approve] Update failed:", updateError?.message);
    return NextResponse.json(
  ...
  try {
    ...
    console.error("[api/aria/orchestrate/approve] Audit write failed:", auditErr);
  }
