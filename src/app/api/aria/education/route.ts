// ═══════════════���══════════════════════════════════════════════════════════════
// API: /api/aria/education — Education Intelligence
//
...
import { analyseEducation } from "@/lib/aria/education-intelligence";
...
import type {
  ...
  PEPRecord,
  PEPQuality,
} from "@/lib/aria/education-intelligence";
...
export async function GET(req: NextRequest) {
  try {
    ...
    console.error("[aria/education] Error:", err);
    return NextResponse.json(
