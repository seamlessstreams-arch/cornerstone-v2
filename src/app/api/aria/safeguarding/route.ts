// ══════════════════════════════════════════════════════════════════════════════
// API: /api/aria/safeguarding — Safeguarding Intelligence
//
...
import { analyseSafeguarding } from "@/lib/aria/safeguarding-intelligence";
...
import type {
  ...
  RiskLevel,
} from "@/lib/aria/safeguarding-intelligence";
...
export async function GET(req: NextRequest) {
  try {
    ...
    console.error("[aria/safeguarding] Error:", err);
    return NextResponse.json(
