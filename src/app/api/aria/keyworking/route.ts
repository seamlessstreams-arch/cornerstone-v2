// ══════════════════════════════════════════════════════════════════════════════
// API: /api/aria/keyworking — Key Working Intelligence
//
...
import { analyseKeyworking } from "@/lib/aria/keyworking-intelligence";
import { createServerClient, isSupabaseEnabled } from "@/lib/supabase/server";
import type { KeyworkingInput, KeyworkSession, SessionTopic } from "@/lib/aria/keyworking-intelligence";
...
export async function GET(req: NextRequest) {
  try {
    ...
    console.error("[aria/keyworking] Error:", err);
    return NextResponse.json(
