// ════════════════════════════════════════════════════════════════════════��═════
// API: /api/aria/supervision-intelligence
//
// GET — Analyse supervision patterns for a home
// ══════════════════════════════════════════════════════════════════════════════

import { NextRequest, NextResponse } from "next/server";
import { analyseSupervisions, type SupervisionRecord } from "@/lib/aria/supervision-intelligence";
...
export async function GET(req: NextRequest) {
  try {
    ...
    console.error("[aria/supervision-intelligence] GET error:", err);
