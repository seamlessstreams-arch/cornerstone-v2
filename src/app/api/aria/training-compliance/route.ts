// ══════════════════════════════════════════════════════════════════════════════
// API: /api/aria/training-compliance
//
// GET — Analyse training compliance for home staff
// ══════════════════════════════════════════════════════════════════════════════

import { NextRequest, NextResponse } from "next/server";
import { analyseTrainingCompliance, type StaffTrainingRecord } from "@/lib/aria/training-compliance";
...
export async function GET(req: NextRequest) {
  try {
    ...
    console.error("[aria/training-compliance] GET error:", err);
