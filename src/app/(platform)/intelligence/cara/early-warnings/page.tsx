...
// ══════════════════════════════════════════════════════════════════════════════
// CARA — Cara EARLY WARNINGS + SAFEGUARDING PATTERNS
// Live scanner output. Cara detects, manager reviews and decides.
// ══════════════════════════════════════════════════════════════════════════════
...
export default function EarlyWarningsPage() {
  ...
  return (
    <PageShell
      ...
      subtitle="Cara scans live records for safeguarding patterns. Manager review required."
