...
// ══════════════════════════════════════════════════════════════════════════════
// CARA — Cara INTERACTIVE SESSIONS
// ══════════════════════════════════════════════════════════════════════════════
    ...
    <div className="flex items-start gap-3 rounded-2xl border border-red-200 bg-red-50 p-4">
      ...
      <div>
        ...
        <p className="text-xs text-red-700 mt-1 leading-relaxed">
          Interactive sessions must be staff-led and supervised. Cara does not provide unsupervised AI counselling.
        ...
        <div className="rounded-xl border border-amber-200 bg-amber-50 p-3 space-y-3">
          <label className="flex items-start gap-3 cursor-pointer">
            ...
            <span className="text-xs font-medium text-amber-800">
              I confirm that consent has been recorded and the young person is aware they are participating in a staff-led session with Cara tools.
            </span>
          </label>
          <textarea
            value={consentNotes}
    ...
    <PageShell
      ...
      actions={
        <div className="flex items-center gap-2">
          <SmartUploadButton variant="inline" label="Upload Session Notes" uploadContext="Cara Intelligence — interactive session notes or resource upload" />
