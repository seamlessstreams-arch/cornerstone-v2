...
// ══════════════════════════════════════════════════════════════════════════════
// CARA — Cara DECISION SUPPORT
// Per-child formulations + ranked recommended actions. Cara drafts.
...
function RecommendationCard({
  ...
  return (
    <Card className={`border ${PRIORITY_TONE[recommendation.priority]}`}>
      ...
      <CardContent className="space-y-3">
        <div>
          <div className="text-xs font-medium">Why Cara suggests this</div>
...
export default function DecisionSupportPage() {
  ...
  return (
    <PageShell
      title="Cara Decision Support"
      subtitle="Drafted formulations and prioritised recommended actions. Cara suggests — managers decide what becomes part of the official record."
      actions={
