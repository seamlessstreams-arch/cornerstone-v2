...
export default function RecommendationsPage() {
  ...
  return (
    <PageShell
      ...
      subtitle="Suggested next actions from Cara"
      showQuickCreate={false}
      actions={<SmartUploadButton variant="inline" label="Upload Supporting Document" uploadContext="Cara Intelligence — recommendations supporting document upload" />}
    >
      <div className="space-y-6 animate-fade-in">
        ...
        {isLoading ? (
          ...
          <div className="flex flex-col items-center gap-3 py-14 text-center">
            ...
            <p className="text-xs text-[var(--cs-text-muted)]">Cara is up to date — all recommendations have been actioned</p>
          </div>
        ) : (
          <div className="space-y-3">
            {filtered.map((rec) => (
