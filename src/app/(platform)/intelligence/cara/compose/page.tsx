      ...
      <div className="mb-6 flex items-start gap-3 rounded-lg border border-[var(--cs-cara-gold-soft)] bg-[var(--cs-cara-gold-bg)] p-4 text-sm text-[var(--cs-navy)]">
        ...
        <div>
          ...
          <p className="text-[var(--cs-navy)]">
            This page demonstrates the universal Cara layer in action. Each field
            below has the Cara microphone button and the Ask Cara command picker.
            Cara runs on the server, every output is labelled as a draft, and
            every approve, edit, reject or rewrite-request is audit-logged. The
            same widget drops into any long-text field across Cara.
          </p>
        </div>
      </div>
      ...
      <Card className="mb-6">
        ...
        <CardContent>
          ...
          <p className="text-xs text-[var(--cs-text-muted)] mt-3">
            Cara respects roles. Mic button, Ask-Cara picker, and HR-permissioned
            commands all hide for roles that don&apos;t hold the relevant Cara
      ...
      <Card>
        ...
        <CardContent className="text-sm text-[var(--cs-text-secondary)] space-y-2">
          <p>
            ...
            automatically for roles that don&apos;t hold the required Cara
            permission.
          </p>
          <p>
