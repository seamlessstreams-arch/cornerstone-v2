...
// ── Parsed result shape (from Cara JSON) ─────────────────────────────────────
...
export default function SituationReviewPage() {
  ...
  async function handleRun() {
    ...
    try {
      ...
      if (!parsed || typeof parsed !== "object") {
        throw new Error("Cara did not return a valid response. Please try again.");
      }
  ...
  return (
    <PageShell
      ...
      actions={<SmartUploadButton variant="inline" label="Upload Situation Evidence" uploadContext="Cara Intelligence — situation review supporting evidence upload" />}
    >
          ...
          <div className="space-y-4">
            <Card className="border-[var(--cs-cara-gold-soft)] bg-[var(--cs-cara-gold-bg)]/30">
              ...
              <CardContent className="space-y-3 text-xs text-[var(--cs-text-secondary)] leading-relaxed">
                <p>Cara produces a structured analysis across 18 headings:</p>
