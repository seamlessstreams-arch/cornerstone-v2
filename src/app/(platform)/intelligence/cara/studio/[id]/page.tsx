...
// ══════════════════════════════════════════════════════════════════════════════
// CARA — Cara STUDIO — ARTIFACT DETAIL
// View, edit, review and commit an Cara-generated artifact.
// Cara drafts. Humans decide. Nothing commits without approval.
// ══════════════════════════════════════════════════════════════════════════════
...
export default function CaraStudioDetailPage({
  ...
  if (isLoading || !data?.data) {
    return (
      <PageShell title="Loading artifact…" subtitle="Cara Studio">
    ...
    >
      ...
      <div className="flex items-start justify-between gap-4 mb-4">
        <Button
          ...
          onClick={() => router.push("/intelligence/cara/studio")}
        >
      ...
      {(status === "draft" || status === "in_review") && (
        <div className="flex items-center gap-3 bg-violet-50 border border-violet-200 rounded-md px-4 py-2.5 mb-4">
          ...
          <p className="text-xs text-violet-700">
            <span className="font-semibold">Cara DRAFT</span> — This is an AI-generated draft.
      ...
      <div className="mt-6 flex items-center gap-2 text-xs text-muted-foreground border-t pt-4">
        ...
        <span>
          Cara drafts. Humans decide. This artifact{" "}
          {isCommitted
