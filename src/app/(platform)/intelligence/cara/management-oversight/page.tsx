...
// ══════════════════════════════════════════════════════════════════════════════
// Cara — MANAGEMENT OVERSIGHT (UI)
// Manager-facing review screen for the Cara Management Oversight Engine.
//
// Flow:
      ...
      <div className="mb-6 flex items-start gap-3 rounded-lg border border-[var(--cs-cara-gold-soft)] bg-[var(--cs-cara-gold-bg)] p-4 text-sm text-[var(--cs-navy)]">
        ...
        <div>
          ...
          <p className="text-[var(--cs-navy)]">
            Output below is generated by the Cara Management Oversight Engine. It
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex items-center justify-end gap-2">
            ...
            >
              ...
              {analysing ? "Analysing..." : "Generate Cara suggested draft"}
            </Button>
          </div>
          {error ? (
          ...
          {review.requiresManagerEscalation ? (
            <div className="mb-6 flex items-start gap-3 rounded-lg border border-amber-300 bg-amber-50 p-4 text-sm text-amber-900">
              ...
              <div>
                ...
                <p>{review.escalationReason ?? "Cara has flagged this record for manager attention."}</p>
              </div>
            </div>
          ) : null}
                ...
                <CardContent>
                  {review.childVoiceVisible ? (
                    ...
                    <div className="flex items-center gap-2 text-sm text-amber-700">
                      ...
                      Child&apos;s voice not detected — Cara has flagged this for follow-up.
                    </div>
                  )}
                </CardContent>
              </Card>
