...
export default function AuditTrailPage() {
  ...
  return (
    <PageShell
      ...
      actions={<SmartUploadButton variant="inline" label="Upload Evidence Document" uploadContext="ARIA Intelligence — audit trail supporting evidence document upload" />}
    >
