...
// ══════════════════════════════════════════════════════════════════════════════
// CORNERSTONE — ARIA Reg 40 Triage Queue (Milestone 15)
//
// Care events that may require an Ofsted notification under Reg 40.
// ARIA drafts the suggested category and reasoning. The manager
...
export default function Reg40TriagePage() {
  ...
  return (
    <PageShell
      title="Reg 40 Triage"
      subtitle="Care events that may require an Ofsted notification under Regulation 40. ARIA drafts the suggested category — humans decide. Notification is never auto-sent."
      actions={
        <Button
          size="sm"
          onClick={() =>
