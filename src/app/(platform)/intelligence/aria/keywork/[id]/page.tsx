...
// ══════════════════════════════════════════════════════════════════════════════
// CORNERSTONE — ARIA KEY WORK SESSION DETAIL
// ══════════════════════════════════════════════════════════════════════════════
    ...
    <PageShell
      ...
      actions={
        <div className="flex items-center gap-2">
          <SmartUploadButton variant="icon" uploadContext={`ARIA Key Work — session notes or supporting material for ${session.title}`} />
          <Link href="/intelligence/aria/keywork">
