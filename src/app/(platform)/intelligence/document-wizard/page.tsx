            ...
            {!last && (
              <div
                className={cn(
                  ...
                  idx < current ? "bg-violet-500" : "bg-slate-200"
                )}
              />
            )}
          </React.Fragment>
  ...
  return (
    ...
    >
      <div className="max-w-2xl mx-auto">
        ...
        {/* ── Stage 2: Classifying ─────────────────────────────────────────── */}
        {stage === "classifying" && (
          <div className="rounded-2xl border border-violet-200 bg-white p-12 flex flex-col items-center justify-center gap-5 shadow-sm">
