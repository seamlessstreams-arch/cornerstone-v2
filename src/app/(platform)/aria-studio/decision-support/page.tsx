...
// ══════════════════════════════════════════════════════════════════════════════
// ARIA STUDIO — DECISION SUPPORT
//
// Structured decision trees: what's known, unknown, the options, risks,
// pros/cons. Helps managers make evidence-informed decisions with ARIA
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-[var(--cs-text-secondary)] mt-0.5">
                Structured decision frameworks: known facts, unknowns, risks, and options with pros and cons. ARIA surfaces the evidence — humans decide.
              </p>
            </div>
          </div>
        </div>
