...
// 19 oversight types. ARIA drafts evidence-based oversight comments — managers
...
const DEMO_DRAFTS: OversightDraft[] = [
  {
    ...
    content: {
      ...
      human_review_note: "ARIA-generated draft. RM to review, personalise, and approve.",
    },
  },
  {
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-[var(--cs-text-secondary)] mt-0.5">
                ARIA drafts evidence-based oversight comments across 19 types. Managers review, personalise, approve, and commit to the official record.
              </p>
            </div>
          </div>
        </div>
