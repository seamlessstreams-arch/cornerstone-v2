...
import { LazyCard } from "@/components/dashboard/lazy-card";
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
        <LazyCard><SupervisionIntelligenceCard /></LazyCard>
        <LazyCard><RegulatoryReportingCard /></LazyCard>
        <LazyCard><RiskIntelligenceCard /></LazyCard>
        <LazyCard><IncidentAnalyticsCard /></LazyCard>
        <LazyCard><RecordingQualityCard /></LazyCard>
        <LazyCard><SafeguardingIntelligenceCard /></LazyCard>
        <LazyCard><MedicationIntelligenceCard /></LazyCard>
        <LazyCard><ContactEngagementCard /></LazyCard>
        <LazyCard><EducationIntelligenceCard /></LazyCard>
        <LazyCard><HealthWellbeingCard /></LazyCard>
        <LazyCard><MissingFromCareCard /></LazyCard>
        <LazyCard><ComplaintsNotificationsCard /></LazyCard>
        <LazyCard><PlacementIntelligenceCard /></LazyCard>
        <LazyCard><BehaviourIntelligenceCard /></LazyCard>
        <LazyCard><RotaIntelligenceCard /></LazyCard>
        <LazyCard><PremisesIntelligenceCard /></LazyCard>
        <LazyCard><TrainingIntelligenceCard /></LazyCard>
        <LazyCard><FinanceIntelligenceCard /></LazyCard>
        <LazyCard><LifeSkillsCard /></LazyCard>
        <LazyCard><NotifiableEventsCard /></LazyCard>
        <LazyCard><SCCIFEvaluationCard /></LazyCard>
        <LazyCard><VisitorsCard /></LazyCard>
        <LazyCard><OutcomesCard /></LazyCard>
        <LazyCard><HandoverCard /></LazyCard>
        <LazyCard><AppraisalsCard /></LazyCard>
        <LazyCard><MeetingsCard /></LazyCard>
        <LazyCard><RestraintCard /></LazyCard>
        <LazyCard><QualityAssuranceCard /></LazyCard>
        <LazyCard><PossessionsCard /></LazyCard>
        <LazyCard><EmergencyCard /></LazyCard>
        <LazyCard><SaferRecruitmentCard /></LazyCard>
        <LazyCard><LeavingCareCard /></LazyCard>
        <LazyCard><StaffDisciplinaryCard /></LazyCard>
        <LazyCard><SanctionsRewardsCard /></LazyCard>
        <LazyCard><ContextualSafeguardingCard /></LazyCard>
        <LazyCard><DeprivationOfLibertyCard /></LazyCard>
        <LazyCard><WhistleblowingCard /></LazyCard>
        <LazyCard><PoliciesRegisterCard /></LazyCard>
        <LazyCard><AdvocacyCard /></LazyCard>
        <LazyCard><MultiAgencyCard /></LazyCard>
        <LazyCard><NightMonitoringCard /></LazyCard>
        <LazyCard><CulturalIdentityCard /></LazyCard>
        <LazyCard><SubstanceMisuseCard /></LazyCard>
        <LazyCard><IndependentVisitorsCard /></LazyCard>
        <LazyCard><BusinessContinuityCard /></LazyCard>
        <LazyCard><StatementOfPurposeCard /></LazyCard>
        <LazyCard><Reg45ReportsCard /></LazyCard>
        <LazyCard><ChildrensGuideCard /></LazyCard>
        <LazyCard><TransitionPlanningCard /></LazyCard>
        <LazyCard><ChildrensParticipationCard /></LazyCard>
        <LazyCard><FoodNutritionCard /></LazyCard>
        <LazyCard><PocketMoneyCard /></LazyCard>
        <LazyCard><EnvironmentalSafetyCard /></LazyCard>
        <LazyCard><RecordsManagementCard /></LazyCard>
        <LazyCard><SleepPatternsCard /></LazyCard>
        <LazyCard><StakeholderEngagementCard /></LazyCard>
        <LazyCard><ImpactRiskAssessmentCard /></LazyCard>
        <LazyCard><StaffWellbeingCard /></LazyCard>
        <LazyCard><KpiTrackingCard /></LazyCard>
        <LazyCard><ProfessionalDevelopmentCard /></LazyCard>
        <LazyCard><TherapeuticInterventionsCard /></LazyCard>
        <LazyCard><WorkforcePlanningCard /></LazyCard>
        <LazyCard><CarePlanningCard /></LazyCard>
        <LazyCard><FamilyEngagementCard /></LazyCard>
        <LazyCard><CommissioningReferralsCard /></LazyCard>
        <LazyCard><ChildrensRightsCard /></LazyCard>
        <LazyCard><PracticeLearningCard /></LazyCard>
        <LazyCard><StaffAbsenceCard /></LazyCard>
        <LazyCard><ActivityPlanningCard /></LazyCard>
        <LazyCard><OnlineSafetyCard /></LazyCard>
        <LazyCard><LACReviewCard /></LazyCard>
        <LazyCard><StaffInductionCard /></LazyCard>
        <LazyCard><DutyOfCandourCard /></LazyCard>
        <LazyCard><AntiBullyingCard /></LazyCard>
        <LazyCard><ConsentManagementCard /></LazyCard>
        <LazyCard><SignificantEventsCard /></LazyCard>
        <LazyCard><LegalStatusCard /></LazyCard>
        <LazyCard><BodyMapCard /></LazyCard>
        <LazyCard><KeyDocumentsCard /></LazyCard>
        <LazyCard><PlacementStabilityCard /></LazyCard>
        <LazyCard><ProviderVisitsCard /></LazyCard>
        <LazyCard><MatchingReferralCard /></LazyCard>
        <LazyCard><IndependencePreparationCard /></LazyCard>
        <LazyCard><SensoryProfileCard /></LazyCard>
        <LazyCard><PeerMentoringCard /></LazyCard>
        <LazyCard><ContactMonitoringCard /></LazyCard>
        <LazyCard><AttachmentRelationshipsCard /></LazyCard>
        <LazyCard><DiversityInclusionCard /></LazyCard>
        <LazyCard><EmergencyPlacementCard /></LazyCard>
        <LazyCard><CourtProceedingsCard /></LazyCard>
        <LazyCard><BehaviourSupportPlansCard /></LazyCard>
        <LazyCard><DischargeTransitionCard /></LazyCard>
        <LazyCard><MedicationErrorsCard /></LazyCard>
        <LazyCard><ChildrensAchievementsCard /></LazyCard>
        <LazyCard><RiskRegisterCard /></LazyCard>
        <LazyCard><DelegatedAuthorityCard /></LazyCard>
        <LazyCard><LanguageCommunicationCard /></LazyCard>
        <LazyCard><IndividualRiskAssessmentCard /></LazyCard>
        <LazyCard><ParentalResponsibilityCard /></LazyCard>
        <LazyCard><ChildrensWishesFeelingsCard /></LazyCard>
        <LazyCard><DailyRoutineCard /></LazyCard>
        <LazyCard><ChildExploitationScreeningCard /></LazyCard>
        <LazyCard><TraumaInformedCareCard /></LazyCard>
        <LazyCard><RespiteShortBreaksCard /></LazyCard>
        <LazyCard><MedicationAdministrationCard /></LazyCard>
        <LazyCard><StaffSupervisionSessionsCard /></LazyCard>
        <LazyCard><FireSafetyCard /></LazyCard>
        <LazyCard><SecureStorageCard /></LazyCard>
        <LazyCard><ComplaintsInvestigationCard /></LazyCard>
        <LazyCard><WorkforceDiversityCard /></LazyCard>
        <LazyCard><VisitorManagementCard /></LazyCard>
        <LazyCard><EmergencyAdmissionsCard /></LazyCard>
        <LazyCard><StaffGrievanceCard /></LazyCard>
        <LazyCard><EqualityHumanRightsCard /></LazyCard>
        <LazyCard><ChildrensFundManagementCard /></LazyCard>
        <LazyCard><StaffAttendanceCard /></LazyCard>
        <LazyCard><AllegationManagementCard /></LazyCard>
        <LazyCard><TransportSafetyCard /></LazyCard>
        <LazyCard><StaffTeamMeetingsCard /></LazyCard>
        <LazyCard><CctvSurveillanceCard /></LazyCard>
        <LazyCard><MealtimesNutritionCard /></LazyCard>
        <LazyCard><BuildingSecurityCard /></LazyCard>
        <LazyCard><WaterSafetyCard /></LazyCard>
        <LazyCard><InfectionControlCard /></LazyCard>
        <LazyCard><MaintenanceRepairsCard /></LazyCard>
        <LazyCard><GiftsHospitalityCard /></LazyCard>
        <LazyCard><BedroomAuditCard /></LazyCard>
        <LazyCard><LaundryClothingCard /></LazyCard>
        <LazyCard><EmergencyDrillCard /></LazyCard>
        <LazyCard><HealthAppointmentsCard /></LazyCard>
        <LazyCard><CommunalAreaAuditCard /></LazyCard>
        <LazyCard><NotificationsRegisterCard /></LazyCard>
        <LazyCard><StaffExitInterviewsCard /></LazyCard>
        <LazyCard><ChildrensMeetingsCard /></LazyCard>
        <LazyCard><HolidayTripsCard /></LazyCard>
        <LazyCard><DataProtectionCard /></LazyCard>
        <LazyCard><PanelDecisionsCard /></LazyCard>
        <LazyCard><VehicleManagementCard /></LazyCard>
        <LazyCard><PestControlCard /></LazyCard>
        <LazyCard><ChildrensFeedbackCard /></LazyCard>
        <LazyCard><UtilityManagementCard /></LazyCard>
        <LazyCard><VolunteerManagementCard /></LazyCard>
        <LazyCard><RoomTemperatureCard /></LazyCard>
        <LazyCard><MedicationAuditCard /></LazyCard>
        <LazyCard><ChildrensAbsenceCard /></LazyCard>
        <LazyCard><HomeImprovementCard /></LazyCard>
        <LazyCard><CleaningScheduleCard /></LazyCard>
        <LazyCard><KeyHoldingCard /></LazyCard>
        <LazyCard><PersonalHygieneCard /></LazyCard>
        <LazyCard><MissingPersonRiskCard /></LazyCard>
        <LazyCard><SafeguardingReferralCard /></LazyCard>
        <LazyCard><MedicationStorageCard /></LazyCard>
        <LazyCard><AdmissionAssessmentCard /></LazyCard>
        <LazyCard><StaffCompetencyAssessmentCard /></LazyCard>
        <LazyCard><EnvironmentalAuditCard /></LazyCard>
        <LazyCard><ProfessionalConsultationCard /></LazyCard>
        <LazyCard><OfstedActionPlanCard /></LazyCard>
        <LazyCard><LifeStoryWorkCard /></LazyCard>
        <LazyCard><PositiveHandlingCard /></LazyCard>
        <LazyCard><ShiftHandoverQualityCard /></LazyCard>
        <LazyCard><ChildrensProgressTrackingCard /></LazyCard>
        <LazyCard><KeyworkerSessionsCard /></LazyCard>
        <LazyCard><RestraintDebriefCard /></LazyCard>
        <LazyCard><StaffReflectivePracticeCard /></LazyCard>
        <LazyCard><StaffHandoverNotesCard /></LazyCard>
        <LazyCard><ChildRiskAssessmentReviewCard /></LazyCard>
        <LazyCard><HomeDecorationPersonalisationCard /></LazyCard>
        <LazyCard><MedicationConsentCard /></LazyCard>
        <LazyCard><StaffLoneWorkingCard /></LazyCard>
        <LazyCard><ChildrensTherapySessionsCard /></LazyCard>
        <LazyCard><NightWakingMonitoringCard /></LazyCard>
        <LazyCard><CommunityLinksIntegrationCard /></LazyCard>
        <LazyCard><StaffMedicationCompetencyCard /></LazyCard>
        <LazyCard><BoundaryManagementCard /></LazyCard>
        <LazyCard><InternetUsageMonitoringCard /></LazyCard>
        <LazyCard><SleepQualityAssessmentCard /></LazyCard>
        <LazyCard><CulturalIdentitySupportCard /></LazyCard>
        <LazyCard><PocketMoneyManagementCard /></LazyCard>
        <LazyCard><ChildWellbeingCheckinCard /></LazyCard>
        <LazyCard><StaffDebriefSupportCard /></LazyCard>
        <LazyCard><EducationAttendanceTrackingCard /></LazyCard>
        <LazyCard><ContactSupervisionCard /></LazyCard>
        <LazyCard><SelfHarmRiskMonitoringCard /></LazyCard>
        <LazyCard><RoomSharingAssessmentCard /></LazyCard>
        <LazyCard><MedicationSideEffectsCard /></LazyCard>
        <LazyCard><PeerRelationshipAssessmentCard /></LazyCard>
        <LazyCard><HomeEnvironmentInspectionCard /></LazyCard>
        <LazyCard><ComplaintResolutionTrackingCard /></LazyCard>
        <LazyCard><StaffSupervisionComplianceCard /></LazyCard>
        <LazyCard><ChildDevelopmentMilestoneCard /></LazyCard>
        <LazyCard><VisitorFeedbackCollectionCard /></LazyCard>
        <LazyCard><StaffShiftPatternMonitoringCard /></LazyCard>
        <LazyCard><ChildDigitalWellbeingCard /></LazyCard>
        <LazyCard><FamilyEngagementTrackingCard /></LazyCard>
        <LazyCard><TransitionPlanningReadinessCard /></LazyCard>
        <LazyCard><KeyWorkerAllocationCard /></LazyCard>
        <LazyCard><ConsentCapacityMonitoringCard /></LazyCard>
        <LazyCard><BehaviourPatternAnalysisCard /></LazyCard>
        <LazyCard><PhysicalActivityTrackingCard /></LazyCard>
        <LazyCard><ReligiousCulturalObservanceCard /></LazyCard>
        <LazyCard><SiblingContactQualityCard /></LazyCard>
        <LazyCard><PrivacyDignityMonitoringCard /></LazyCard>
        <LazyCard><ChildrensAspirationsGoalsCard /></LazyCard>
        <LazyCard><CreativeEnrichmentActivitiesCard /></LazyCard>
        <LazyCard><MedicationEffectivenessReviewCard /></LazyCard>
        <LazyCard><HealthScreeningImmunisationCard /></LazyCard>
        <LazyCard><SocialSkillsDevelopmentCard /></LazyCard>
        <LazyCard><RestorativeJusticePracticeCard /></LazyCard>
        <LazyCard><LeisureRecreationActivitiesCard /></LazyCard>
        <LazyCard><HomeworkAcademicSupportCard /></LazyCard>
        <LazyCard><AdvocacyRepresentationCard /></LazyCard>
        <LazyCard><CelebrationMilestonesCard /></LazyCard>
        <LazyCard><WorkExperienceEmploymentCard /></LazyCard>
        <LazyCard><DeviceScreenTimeMonitoringCard /></LazyCard>
        <LazyCard><FinancialLiteracySavingsCard /></LazyCard>
        <LazyCard><FirstAidMedicalEmergencyCard /></LazyCard>
        <LazyCard><OutdoorSpacesPlayAreasCard /></LazyCard>
        <LazyCard><PositiveBehaviourReinforcementCard /></LazyCard>
        <LazyCard><DentalOpticalHealthCard /></LazyCard>
        <LazyCard><SelfEsteemConfidenceBuildingCard /></LazyCard>
        <LazyCard><ArrivalSettlingExperienceCard /></LazyCard>
        <LazyCard><HealthyEatingCookingSkillsCard /></LazyCard>
        <LazyCard><RelationshipEducationSafetyCard /></LazyCard>
        <LazyCard><PetCareResponsibilityCard /></LazyCard>
        <LazyCard><GardenHorticultureActivitiesCard /></LazyCard>
        <LazyCard><FaithSpiritualObservanceCard /></LazyCard>
        <LazyCard><StaffPatternIntelligenceCard /></LazyCard>
        <LazyCard><StaffPerformanceDipCard /></LazyCard>
        <LazyCard><StaffBurnoutIndicatorCard /></LazyCard>
        <LazyCard><StaffDevelopmentPlanCard /></LazyCard>
        <LazyCard><StaffSupportPlanCard /></LazyCard>
        <LazyCard><StaffPracticeRiskAssessmentCard /></LazyCard>
        <LazyCard><StaffTriggerMapCard /></LazyCard>
        <LazyCard><StaffSupportActionCard /></LazyCard>
        <LazyCard><StaffReviewOutcomeCard /></LazyCard>
        <LazyCard><StaffConfidenceIndicatorCard /></LazyCard>
        <LazyCard><StaffMandatoryTrainingCard /></LazyCard>
        <LazyCard><YoungPersonDailyDiaryCard /></LazyCard>
        <LazyCard><ProfessionalNetworkDirectoryCard /></LazyCard>
        <LazyCard><MenuPlanningDietaryCard /></LazyCard>
        <LazyCard><EhcpSendMonitoringCard /></LazyCard>
        <LazyCard><PlacementMatchingAssessmentCard /></LazyCard>
        <LazyCard><Reg44IndependentVisitorCard /></LazyCard>
        <LazyCard><EmotionalWellbeingOutcomeCard /></LazyCard>
        <LazyCard><ComplianceCertificateCard /></LazyCard>
        <LazyCard><HomeClosurePlanningCard /></LazyCard>
        <LazyCard><ParentalContactArrangementCard /></LazyCard>
        <LazyCard><SafeguardingPartnershipCard /></LazyCard>
        <LazyCard><LacHealthAssessmentCard /></LazyCard>
        <LazyCard><StaffWhistleblowingInvestigationCard /></LazyCard>
        <LazyCard><HomeAtmosphereAssessmentCard /></LazyCard>
        <LazyCard><QualityOfCareReviewCard /></LazyCard>
        <LazyCard><MedicationIncidentReportingCard /></LazyCard>
        <LazyCard><StaffAnnualLeaveCard /></LazyCard>
        <LazyCard><ChildrensPocketMoneyAuditCard /></LazyCard>
        <LazyCard><StaffConflictOfInterestCard /></LazyCard>
        <LazyCard><EnvironmentalImpactAssessmentCard /></LazyCard>
        <LazyCard><StaffRetentionExitAnalysisCard /></LazyCard>
        <LazyCard><ChildSexualExploitationRiskCard /></LazyCard>
        <LazyCard><OfstedInspectionReadinessCard /></LazyCard>
        <LazyCard><YoungPersonEmploymentSupportCard /></LazyCard>
        <LazyCard><SleepDisturbanceInterventionCard /></LazyCard>
        <LazyCard><ChildCriminalExploitationRiskCard /></LazyCard>
        <LazyCard><StaffSicknessManagementCard /></LazyCard>
        <LazyCard><HomeInsuranceComplianceCard /></LazyCard>
        <LazyCard><ChildVoiceParticipationTrackingCard /></LazyCard>
        <LazyCard><StaffCodeOfConductComplianceCard /></LazyCard>
        <LazyCard><HomeEnergyEfficiencyCard /></LazyCard>
        <LazyCard><ChildRadicalisationPreventionCard /></LazyCard>
        <LazyCard><StaffNvqQualificationTrackingCard /></LazyCard>
        <LazyCard><HomeAccessibilityAssessmentCard /></LazyCard>
        <LazyCard><ChildNutritionWeightMonitoringCard /></LazyCard>
        <LazyCard><StaffDbsRenewalTrackingCard /></LazyCard>
        <LazyCard><HomeFireRiskAssessmentCard /></LazyCard>
        <LazyCard><ChildSubstanceMisuseScreeningCard /></LazyCard>
        <LazyCard><StaffReturnToWorkInterviewCard /></LazyCard>
        <LazyCard><HomeLegionellaRiskAssessmentCard /></LazyCard>
        <LazyCard><ChildBereavementSupportCard /></LazyCard>
        <LazyCard><StaffMandatoryRefresherTrainingCard /></LazyCard>
        <LazyCard><HomeAsbestosManagementCard /></LazyCard>
        <LazyCard><ChildGangsAffiliationRiskCard /></LazyCard>
        <LazyCard><StaffAgencyWorkerComplianceCard /></LazyCard>
        <LazyCard><HomeRadonTestingCard /></LazyCard>
        <LazyCard><ChildFgmRiskAssessmentCard /></LazyCard>
        <LazyCard><StaffProfessionalRegistrationCard /></LazyCard>
        <LazyCard><HomeElectricalSafetyCard /></LazyCard>
        <LazyCard><ChildForcedMarriageRiskCard /></LazyCard>
        <LazyCard><StaffSecondmentManagementCard /></LazyCard>
        <LazyCard><HomeGasSafetyCard /></LazyCard>
        <LazyCard><ChildModernSlaveryRiskCard /></LazyCard>
        <LazyCard><StaffPayrollComplianceCard /></LazyCard>
        <LazyCard><HomeLiftEquipmentSafetyCard /></LazyCard>
        <LazyCard><ChildHonourBasedAbuseRiskCard /></LazyCard>
        <LazyCard><StaffExitInterviewManagementCard /></LazyCard>
        <LazyCard><HomeWaterHygieneManagementCard /></LazyCard>
        <LazyCard><ChildRadicalisationRiskCard /></LazyCard>
        <LazyCard><StaffWhistleblowingManagementCard /></LazyCard>
        <LazyCard><HomePestControlManagementCard /></LazyCard>
        <LazyCard><ChildTraffickingRiskCard /></LazyCard>
        <LazyCard><StaffOvertimeManagementCard /></LazyCard>
        <LazyCard><HomeCctvComplianceCard /></LazyCard>
        <LazyCard><ChildOnlineSafetyMonitoringCard /></LazyCard>
        <LazyCard><StaffLoneWorkingRiskCard /></LazyCard>
        <LazyCard><HomeEmergencyLightingCard /></LazyCard>
      </div>
