import { AriaOrchestrationPanel } from "@/components/aria/AriaOrchestrationPanel";

export default async function AriaIntelligencePage() {
  ...
  return (
    <main className="space-y-6 p-6">
      ...
      <AriaOrchestrationPanel
        homeId={homeId}
        userId={userId}
        role={role}
        currentPage="aria-intelligence"
      />
    </main>
  );
}
