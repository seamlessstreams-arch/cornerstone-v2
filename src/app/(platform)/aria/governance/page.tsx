// ══════════════════════════════════════════════════════════════════════════════
// Aria Governance Dashboard — Admin overview of AI governance system
// ══════════════════════════════════════════════════════════════════════════════
...
const GOVERNANCE_MODULES = [
  {
    ...
    href: "/aria/governance/providers",
  ...
  },
  {
    ...
    href: "/aria/governance/approvals",
...
export default function AriaGovernancePage() {
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h1 className="text-2xl font-bold">Aria Intelligence Governance</h1>
