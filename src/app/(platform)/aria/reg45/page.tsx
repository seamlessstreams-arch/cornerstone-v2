...
// ══════════════════════════════════════════════════════════════════════════════
// ARIA — REGULATION 45 EVIDENCE BANK
//
// Displays and filters Reg 45 evidence items. Evidence is gathered from
// across Cornerstone and categorised for inclusion in monthly reports.
// ══════════════════════════════════════════════════════════════════════════════
      ...
      <div className="mb-6 flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm" style={{ color: "var(--cs-text-muted)" }}>
            Evidence gathered across Cornerstone for monthly Reg 45 reporting
          </p>
        </div>
      </div>
