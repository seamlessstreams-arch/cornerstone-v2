...
const MORE = [
  ...
  { label: "Recording rewrite", href: "/aria/recording-assistant" },
...
export default function ManagerAssistantPage() {
  ...
  return (
    <PageShell
      ...
      ariaContext={{ pageTitle: "ARIA Manager Assistant", sourceType: "general" }}
    >
          ...
          <>
              ...
              <Card className="border-l-4 border-l-[var(--cs-aria-gold)]">
                <CardContent className="space-y-3 py-4">
                  <div className="flex flex-wrap items-center justify-between gap-2">
                    <p className="flex items-center gap-1.5 text-sm font-bold text-[var(--cs-navy)]"><Sparkles className="h-4 w-4 text-[var(--cs-aria-gold)]" /> Draft {result.llmUsed ? "(ARIA-polished)" : "(structured from your data)"}</p>
            ...
            <Card>
              <CardContent className="py-4">
                <p className="mb-2 text-xs font-bold uppercase tracking-wide text-[var(--cs-text-muted)]">More ARIA tools</p>
