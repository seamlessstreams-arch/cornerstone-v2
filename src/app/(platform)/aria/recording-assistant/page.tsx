...
export default function AriaRecordingAssistantPage() {
  ...
  return (
    <PageShell
      title="ARIA Recording Assistant"
      subtitle="Turn raw notes into professional, therapeutic, factual records — for any record type. ARIA checks the quality, suggests a rewrite, and you stay the author: original, suggestion and final version are all preserved."
      ariaContext={{ pageTitle: "ARIA Recording Assistant", sourceType: "general" }}
    >
                  ...
                  <CardContent className="space-y-3 py-4">
                    ...
                    {result.ai_draft && (
                      <details className="rounded-xl border border-[var(--cs-border)] bg-[var(--cs-bg)] px-3 py-2">
                        <summary className="cursor-pointer text-xs font-bold text-[var(--cs-text-muted)]">ARIA&rsquo;s suggested rewrite (AI-assisted — review before using)</summary>
