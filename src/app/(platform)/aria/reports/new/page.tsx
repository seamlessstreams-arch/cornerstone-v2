...
// ══════════════════════════════════════════════════════════════════════════════
// ARIA — GENERATE NEW REPORT
//
// Form for requesting a new ARIA-generated report. The user selects a child,
...
export default function AriaReportNewPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (reportId) {
        router.push(`/aria/reports/${reportId}`);
      } else {
  ...
  return (
    <PageShell
      ...
      subtitle="Create a new ARIA intelligence report"
    >
      {/* Back link */}
      <Link
        href="/aria/reports"
          ...
          <CardContent>
            <div className="rounded-lg border border-[var(--cs-aria-gold-soft)] bg-[var(--cs-aria-gold-bg)] p-3 mb-6">
              <p className="text-[10px] text-[var(--cs-aria-gold)] font-medium">
                ARIA will retrieve relevant evidence, generate a structured
              ...
              {generating ? (
                <div className="rounded-xl border border-[var(--cs-aria-gold-soft)] bg-[var(--cs-aria-gold-bg)] p-6 text-center">
                  ...
                  <p className="text-sm font-medium text-[var(--cs-navy)]">
                    ARIA is generating your report...
                  </p>
