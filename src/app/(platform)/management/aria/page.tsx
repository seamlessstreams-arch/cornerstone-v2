    ...
    <div className="flex items-center justify-between gap-4 py-2">
      ...
      <button
        ...
        className={cn(
          ...
          value ? "bg-[var(--cs-aria-gold)]" : "bg-gray-300",
        )}
      >
        <span
          className={cn(
    ...
    <PageShell title="ARIA Governance Settings">
      ...
      <div className="mb-6 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          >
            <Shield className="h-5 w-5" style={{ color: "var(--cs-aria-gold)" }} />
          </div>
          <div>
        ...
        <Button onClick={handleSave} className="gap-2" style={{ backgroundColor: "var(--cs-aria-gold)" }}>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <Card>
          <CardHeader className="pb-3">
            <CardTitle className="flex items-center gap-2 text-base">
              <Bot className="h-4 w-4" style={{ color: "var(--cs-aria-gold)" }} />
              AI Controls
            </CardTitle>
          </CardHeader>
          <CardContent className="space-y-1">
        ...
        <Card>
          <CardHeader className="pb-3">
            <CardTitle className="flex items-center gap-2 text-base">
              <AlertTriangle className="h-4 w-4" style={{ color: "var(--cs-aria-gold)" }} />
              Challenge Mode
            </CardTitle>
          </CardHeader>
          <CardContent className="space-y-1">
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      challengeThreshold === tier
                        ? "border-[var(--cs-aria-gold)] text-white"
                        : "border-[var(--cs-border)] hover:bg-gray-50",
                    )}
                    style={
                      challengeThreshold === tier
                        ? { backgroundColor: "var(--cs-aria-gold)" }
        ...
        <Card>
          <CardHeader className="pb-3">
            <CardTitle className="flex items-center gap-2 text-base">
              <Lock className="h-4 w-4" style={{ color: "var(--cs-aria-gold)" }} />
              Agent Access
            </CardTitle>
          </CardHeader>
          <CardContent>
