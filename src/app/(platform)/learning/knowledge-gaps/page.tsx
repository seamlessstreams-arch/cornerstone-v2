      ...
      <CardContent className="p-4 space-y-3">
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-start justify-between gap-2">
              <p className="text-sm font-semibold text-slate-900">{gap.gap_area}</p>
        ...
        {expanded && (
          <div className="space-y-3 pt-2 border-t border-slate-100">
            {gap.staff_role && (
              <div>
                <p className="text-[11px] font-semibold text-slate-500 uppercase tracking-wide mb-1">Staff Role</p>
                <p className="text-sm text-slate-700">{gap.staff_role}</p>
              </div>
            )}
            {gap.evidence_notes && (
              <div>
                <p className="text-[11px] font-semibold text-slate-500 uppercase tracking-wide mb-1">Evidence Notes</p>
                <div className="rounded-lg bg-slate-50 border border-slate-200 p-3">
                  <p className="text-sm text-slate-700 leading-relaxed whitespace-pre-wrap">{gap.evidence_notes}</p>
                </div>
              </div>
            )}
    ...
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-4">
          <div>
            <label className="text-xs font-semibold text-slate-600 uppercase tracking-wide">Gap Area</label>
            <Input
              className="mt-1"
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              <label className="text-xs font-semibold text-slate-600 uppercase tracking-wide">Identified From</label>
          ...
          <div>
            <label className="text-xs font-semibold text-slate-600 uppercase tracking-wide">Staff Role (optional)</label>
            <Input
              className="mt-1"
          ...
          <div>
            <label className="text-xs font-semibold text-slate-600 uppercase tracking-wide">Evidence Notes</label>
            <Textarea
      ...
      <div id="knowledge-gaps-content" className="space-y-4 animate-fade-in">
        ...
        <div className="grid gap-3 sm:grid-cols-3">
          {[
            ...
            <div key={label} className={cn("rounded-xl border border-slate-100 p-4 text-center", bg)}>
        ...
        {/* List */}
        {isLoading ? (
          <p className="text-center text-sm text-slate-500 py-12">Loading knowledge gaps…</p>
        ) : filtered.length === 0 ? (
