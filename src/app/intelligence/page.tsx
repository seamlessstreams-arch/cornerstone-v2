      ...
      <section className="mx-auto max-w-7xl px-5 py-20">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
            ...
            <Link href="/workforce" className="inline-flex items-center justify-center gap-2 rounded-xl border border-[var(--cs-border)] bg-white px-6 py-3.5 text-sm font-bold text-[var(--cs-navy)] transition-colors hover:bg-[var(--cs-bg)]">Explore workforce <CheckCircle2 className="h-4 w-4 text-[var(--cs-teal)]" /></Link>
          </div>
        </div>
      </section>
