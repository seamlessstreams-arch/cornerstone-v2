      ...
      <CardHeader className={cn("pb-3", isAlert ? "bg-red-50" : "bg-blue-50/50")}>
        <div className="flex items-center justify-between">
          <CardTitle className="text-sm flex items-center gap-2">
            <Megaphone className={cn("h-4 w-4", isAlert ? "text-[--cs-risk]" : "text-blue-600")} />
        ...
        {d.advocacy_rating !== "insufficient_data" && (
          <div className="grid grid-cols-3 sm:grid-cols-6 gap-1.5">
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.active_rate >= 80 ? "bg-green-50" : d.active_rate >= 50 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.active_rate >= 80 ? "text-[--cs-success]" : d.active_rate >= 50 ? "text-[--cs-warning]" : "text-[--cs-risk]")}>{d.active_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.children_with_advocacy_rate >= 80 ? "bg-green-50" : d.children_with_advocacy_rate >= 50 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.children_with_advocacy_rate >= 80 ? "text-[--cs-success]" : d.children_with_advocacy_rate >= 50 ? "text-[--cs-warning]" : "text-[--cs-risk]")}>{d.children_with_advocacy_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.independent_rate >= 50 ? "bg-green-50" : d.independent_rate >= 25 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.independent_rate >= 50 ? "text-[--cs-success]" : d.independent_rate >= 25 ? "text-[--cs-warning]" : "text-[--cs-risk]")}>{d.independent_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.advocacy_type_variety >= 4 ? "bg-green-50" : d.advocacy_type_variety >= 2 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.advocacy_type_variety >= 4 ? "text-[--cs-success]" : d.advocacy_type_variety >= 2 ? "text-[--cs-warning]" : "text-[--cs-risk]")}>{d.advocacy_type_variety}</p>
