...
import { Loader2, AlertCircle, AlertTriangle, Sparkles, Brain, Droplet } from "lucide-react";
...
export function HomeDampMouldManagementIntelligenceCard() {
  ...
  if (!d) return null;
  const ratingStyle = RATING_STYLES[d.damp_rating as DampMouldRating] ?? RATING_STYLES.insufficient_data;
  const isAlert = d.damp_rating === "inadequate";
