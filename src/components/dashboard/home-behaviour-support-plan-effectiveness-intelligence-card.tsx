...
export function HomeBehaviourSupportPlanEffectivenessIntelligenceCard() {
  const { data, isLoading } = useHomeBehaviourSupportPlanEffectivenessIntelligence();
  ...
  const ratingStyle = RATING_STYLES[d.behaviour_rating as BehaviourSupportRating] ?? RATING_STYLES.insufficient_data;
  const isAlert = d.behaviour_rating === "inadequate";
      ...
      <CardHeader className={cn("pb-3", isAlert ? "bg-red-50" : "bg-orange-50/50")}>
        <div className="flex items-center justify-between">
          <CardTitle className="text-sm flex items-center gap-2">
            <Shield className={cn("h-4 w-4", isAlert ? "text-red-600" : "text-orange-600")} />
        ...
        {d.behaviour_rating !== "insufficient_data" && (
          <div className="grid grid-cols-3 sm:grid-cols-6 gap-1.5">
            <div className={cn("text-center rounded-lg p-1.5", d.bsp_coverage_rate >= 90 ? "bg-green-50" : d.bsp_coverage_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.bsp_coverage_rate >= 90 ? "text-green-600" : d.bsp_coverage_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.bsp_coverage_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.intervention_success_rate >= 90 ? "bg-green-50" : d.intervention_success_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.intervention_success_rate >= 90 ? "text-green-600" : d.intervention_success_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.intervention_success_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.deescalation_effectiveness_rate >= 90 ? "bg-green-50" : d.deescalation_effectiveness_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.deescalation_effectiveness_rate >= 90 ? "text-green-600" : d.deescalation_effectiveness_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.deescalation_effectiveness_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.positive_reinforcement_rate >= 90 ? "bg-green-50" : d.positive_reinforcement_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.positive_reinforcement_rate >= 90 ? "text-green-600" : d.positive_reinforcement_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.positive_reinforcement_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.restrictive_practice_reduction_rate >= 90 ? "bg-green-50" : d.restrictive_practice_reduction_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.restrictive_practice_reduction_rate >= 90 ? "text-green-600" : d.restrictive_practice_reduction_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.restrictive_practice_reduction_rate}%</p>
