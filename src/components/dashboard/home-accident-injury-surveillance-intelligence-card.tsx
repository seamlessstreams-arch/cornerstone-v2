      ...
      <CardHeader className={cn("pb-3", isAlert ? "bg-red-50" : "bg-rose-50/50")}>
        <div className="flex items-center justify-between">
          <CardTitle className="text-sm flex items-center gap-2">
            <Siren className={cn("h-4 w-4", isAlert ? "text-[--cs-risk]" : "text-rose-600")} />
        ...
        {d.surveillance_rating !== "insufficient_data" && (
          <div className="grid grid-cols-3 sm:grid-cols-6 gap-1.5">
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.accidents_serious > 0 ? "bg-red-50" : "bg-green-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.accidents_serious > 0 ? "text-[--cs-risk]" : "text-[--cs-success]")}>{d.accidents_serious}</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.injuries_unexplained > 0 ? "bg-red-50" : "bg-green-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.injuries_unexplained > 0 ? "text-[--cs-risk]" : "text-[--cs-success]")}>{d.injuries_unexplained}</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.hospital_visits > 0 ? "bg-amber-50" : "bg-green-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.hospital_visits > 0 ? "text-[--cs-warning]" : "text-[--cs-success]")}>{d.hospital_visits}</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.children_with_repeat_injuries > 0 ? "bg-red-50" : "bg-green-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.children_with_repeat_injuries > 0 ? "text-[--cs-risk]" : "text-[--cs-success]")}>{d.children_with_repeat_injuries}</p>
