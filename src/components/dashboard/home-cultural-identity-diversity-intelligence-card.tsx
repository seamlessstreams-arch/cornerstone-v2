...
export function HomeCulturalIdentityDiversityIntelligenceCard() {
  const { data, isLoading } = useHomeCulturalIdentityDiversityIntelligence();
  ...
  const ratingStyle = RATING_STYLES[d.identity_rating as CulturalIdentityRating] ?? RATING_STYLES.insufficient_data;
      ...
      <CardHeader className={cn("pb-3", isAlert ? "bg-red-50" : "bg-amber-50/50")}>
        <div className="flex items-center justify-between">
          <CardTitle className="text-sm flex items-center gap-2">
            <Globe className={cn("h-4 w-4", isAlert ? "text-red-600" : "text-amber-600")} />
        ...
        {d.identity_rating !== "insufficient_data" && (
          <div className="grid grid-cols-3 sm:grid-cols-6 gap-1.5">
            <div className={cn("text-center rounded-lg p-1.5", d.cultural_plan_coverage_rate >= 80 ? "bg-green-50" : d.cultural_plan_coverage_rate >= 50 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.cultural_plan_coverage_rate >= 80 ? "text-green-600" : d.cultural_plan_coverage_rate >= 50 ? "text-amber-600" : "text-red-600")}>{d.cultural_plan_coverage_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.mentor_assignment_rate >= 80 ? "bg-green-50" : d.mentor_assignment_rate >= 50 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.mentor_assignment_rate >= 80 ? "text-green-600" : d.mentor_assignment_rate >= 50 ? "text-amber-600" : "text-red-600")}>{d.mentor_assignment_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.diversity_participation_rate >= 80 ? "bg-green-50" : d.diversity_participation_rate >= 50 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.diversity_participation_rate >= 80 ? "text-green-600" : d.diversity_participation_rate >= 50 ? "text-amber-600" : "text-red-600")}>{d.diversity_participation_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.life_story_work_rate >= 80 ? "bg-green-50" : d.life_story_work_rate >= 50 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.life_story_work_rate >= 80 ? "text-green-600" : d.life_story_work_rate >= 50 ? "text-amber-600" : "text-red-600")}>{d.life_story_work_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.child_voice_in_plans_rate >= 80 ? "bg-green-50" : d.child_voice_in_plans_rate >= 50 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.child_voice_in_plans_rate >= 80 ? "text-green-600" : d.child_voice_in_plans_rate >= 50 ? "text-amber-600" : "text-red-600")}>{d.child_voice_in_plans_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.personal_passport_currency_rate >= 80 ? "bg-green-50" : d.personal_passport_currency_rate >= 50 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.personal_passport_currency_rate >= 80 ? "text-green-600" : d.personal_passport_currency_rate >= 50 ? "text-amber-600" : "text-red-600")}>{d.personal_passport_currency_rate}%</p>
