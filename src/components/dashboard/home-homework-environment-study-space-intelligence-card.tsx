      ...
      <CardHeader className={cn("pb-3", isAlert ? "bg-red-50" : "bg-yellow-50/50")}>
        <div className="flex items-center justify-between">
          <CardTitle className="text-sm flex items-center gap-2">
            <Lamp className={cn("h-4 w-4", isAlert ? "text-red-600" : "text-yellow-600")} />
        ...
        {d.study_rating !== "insufficient_data" && (
          <div className="grid grid-cols-3 sm:grid-cols-6 gap-1.5">
            <div className={cn("text-center rounded-lg p-1.5", d.study_space_rate >= 90 ? "bg-green-50" : d.study_space_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.study_space_rate >= 90 ? "text-green-600" : d.study_space_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.study_space_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.noise_environment_rate >= 90 ? "bg-green-50" : d.noise_environment_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.noise_environment_rate >= 90 ? "text-green-600" : d.noise_environment_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.noise_environment_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.equipment_rate >= 90 ? "bg-green-50" : d.equipment_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.equipment_rate >= 90 ? "text-green-600" : d.equipment_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.equipment_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.lighting_rate >= 90 ? "bg-green-50" : d.lighting_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.lighting_rate >= 90 ? "text-green-600" : d.lighting_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.lighting_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.utilisation_rate >= 90 ? "bg-green-50" : d.utilisation_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.utilisation_rate >= 90 ? "text-green-600" : d.utilisation_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.utilisation_rate}%</p>
