...
// ══════════════════════════════════════════════════════════════════════════════
// CARA — UTILITY MANAGEMENT INTELLIGENCE CARD
    ...
    <Card className="overflow-hidden border-slate-200">
      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-4 gap-2">
          ...
          <div className={cn(
            "text-center rounded-lg p-2",
            overview.maintenance_overdue === 0 ? "bg-green-50" : "bg-red-50",
          )}>
            <p className={cn(
              "text-lg font-bold tabular-nums",
              overview.maintenance_overdue === 0 ? "text-green-600" : "text-red-600",
            )}>
              {overview.maintenance_overdue}
            </p>
          ...
          <div className={cn(
            ...
            <p className={cn(
              "text-lg font-bold tabular-nums",
              overview.maintenance_urgent === 0 ? "text-green-600" : "text-red-600",
            )}>
