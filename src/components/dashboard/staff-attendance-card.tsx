      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-4 gap-2">
          <div className={cn("text-center rounded-lg p-2", st.coverage_rate >= 90 ? "bg-green-50" : "bg-amber-50")}>
            <p className={cn("text-lg font-bold tabular-nums", st.coverage_rate >= 90 ? "text-green-600" : "text-amber-600")}>
              {st.coverage_rate}%
            </p>
          ...
          <div className={cn("text-center rounded-lg p-2", st.shifts_unfilled === 0 ? "bg-green-50" : "bg-red-50")}>
            <p className={cn("text-lg font-bold tabular-nums", st.shifts_unfilled === 0 ? "text-green-600" : "text-red-600")}>
              {st.shifts_unfilled}
            </p>
          ...
          <div className={cn("text-center rounded-lg p-2", st.overtime_hours_this_month === 0 ? "bg-green-50" : "bg-amber-50")}>
            <p className={cn("text-lg font-bold tabular-nums", st.overtime_hours_this_month === 0 ? "text-green-600" : "text-amber-600")}>
