      ...
      <CardHeader className={cn("pb-3", isAlert ? "bg-red-50" : "bg-red-50/50")}>
        <div className="flex items-center justify-between">
          <CardTitle className="text-sm flex items-center gap-2">
            <HeartPulse className={cn("h-4 w-4", isAlert ? "text-red-600" : "text-red-600")} />
        ...
        {d.therapeutic_rating !== "insufficient_data" && (
          <div className="grid grid-cols-3 sm:grid-cols-6 gap-1.5">
            <div className={cn("text-center rounded-lg p-1.5", d.therapy_attendance_rate >= 90 ? "bg-green-50" : d.therapy_attendance_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.therapy_attendance_rate >= 90 ? "text-green-600" : d.therapy_attendance_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.therapy_attendance_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.progress_assessment_coverage_rate >= 90 ? "bg-green-50" : d.progress_assessment_coverage_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.progress_assessment_coverage_rate >= 90 ? "text-green-600" : d.progress_assessment_coverage_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.progress_assessment_coverage_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.treatment_adherence_rate >= 90 ? "bg-green-50" : d.treatment_adherence_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.treatment_adherence_rate >= 90 ? "text-green-600" : d.treatment_adherence_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.treatment_adherence_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.therapeutic_relationship_quality_rate >= 90 ? "bg-green-50" : d.therapeutic_relationship_quality_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.therapeutic_relationship_quality_rate >= 90 ? "text-green-600" : d.therapeutic_relationship_quality_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.therapeutic_relationship_quality_rate}%</p>
