      ...
      <CardHeader className={cn("pb-3", isAlert ? "bg-red-50" : "bg-cyan-50/50")}>
        <div className="flex items-center justify-between">
          <CardTitle className="text-sm flex items-center gap-2">
            <ChefHat className={cn("h-4 w-4", isAlert ? "text-[--cs-risk]" : "text-cyan-600")} />
        ...
        {d.cooking_rating !== "insufficient_data" && (
          <div className="grid grid-cols-3 sm:grid-cols-6 gap-1.5">
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.category_variety >= 6 ? "bg-green-50" : d.category_variety >= 3 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.category_variety >= 6 ? "text-[--cs-success]" : d.category_variety >= 3 ? "text-[--cs-warning]" : "text-[--cs-risk]")}>{d.category_variety}</p>
