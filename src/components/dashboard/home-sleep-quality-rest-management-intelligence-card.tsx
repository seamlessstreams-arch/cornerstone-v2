...
export function HomeSleepQualityRestManagementIntelligenceCard() {
  const { data, isLoading } = useHomeSleepQualityRestManagementIntelligence();
  ...
  if (!d) return null;
  const ratingStyle = RATING_STYLES[d.sleep_rating as SleepQualityRating] ?? RATING_STYLES.insufficient_data;
      ...
      <CardHeader className={cn("pb-3", isAlert ? "bg-red-50" : "bg-indigo-50/50")}>
        <div className="flex items-center justify-between">
          <CardTitle className="text-sm flex items-center gap-2">
            <BedDouble className={cn("h-4 w-4", isAlert ? "text-red-600" : "text-indigo-600")} />
        ...
        {d.sleep_rating !== "insufficient_data" && (
          <div className="grid grid-cols-3 sm:grid-cols-6 gap-1.5">
            <div className={cn("text-center rounded-lg p-1.5", d.routine_adherence_rate >= 90 ? "bg-green-50" : d.routine_adherence_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.routine_adherence_rate >= 90 ? "text-green-600" : d.routine_adherence_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.routine_adherence_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.environment_quality_rate >= 90 ? "bg-green-50" : d.environment_quality_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.environment_quality_rate >= 90 ? "text-green-600" : d.environment_quality_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.environment_quality_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.disturbance_resolution_rate >= 90 ? "bg-green-50" : d.disturbance_resolution_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.disturbance_resolution_rate >= 90 ? "text-green-600" : d.disturbance_resolution_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.disturbance_resolution_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.bedtime_support_quality_rate >= 90 ? "bg-green-50" : d.bedtime_support_quality_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.bedtime_support_quality_rate >= 90 ? "text-green-600" : d.bedtime_support_quality_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.bedtime_support_quality_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.improvement_plan_coverage_rate >= 90 ? "bg-green-50" : d.improvement_plan_coverage_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.improvement_plan_coverage_rate >= 90 ? "text-green-600" : d.improvement_plan_coverage_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.improvement_plan_coverage_rate}%</p>
