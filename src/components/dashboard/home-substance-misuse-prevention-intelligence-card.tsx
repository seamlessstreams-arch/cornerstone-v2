...
export function HomeSubstanceMisusePreventionIntelligenceCard() {
  ...
  return (
    <Card className={cn("overflow-hidden", isAlert ? "border-red-400 border-2" : "border-orange-600 border-2")} aria-label="ARIA Substance Misuse Prevention Intelligence">
