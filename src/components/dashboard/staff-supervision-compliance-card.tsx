...
// ══════════════════════════════════════════════════════════════════════════════
// CORNERSTONE — STAFF SUPERVISION COMPLIANCE INTELLIGENCE CARD
// Dashboard widget for supervision compliance rates, training status,
// overdue staff, and ARIA intelligence insights.
        ...
        <div className="space-y-1.5">
          ...
          <div className="grid grid-cols-3 gap-2">
            ...
            <div className={cn("text-center rounded-lg p-2", tc.expiring_soon > 0 ? "bg-amber-50" : "bg-green-50")}>
              <p className={cn("text-sm font-bold tabular-nums", tc.expiring_soon > 0 ? "text-amber-600" : "text-green-600")}>
                {tc.expiring_soon}
              </p>
            ...
            <div className={cn("text-center rounded-lg p-2", tc.expired > 0 ? "bg-red-50" : "bg-green-50")}>
              <p className={cn("text-sm font-bold tabular-nums", tc.expired > 0 ? "text-red-600" : "text-green-600")}>
                {tc.expired}
              </p>
