      ...
      <CardHeader className={cn("pb-3", isAlert ? "bg-red-50" : "bg-pink-50/50")}>
        <div className="flex items-center justify-between">
          <CardTitle className="text-sm flex items-center gap-2">
            <Award className={cn("h-4 w-4", isAlert ? "text-[--cs-risk]" : "text-pink-600")} />
        ...
        {d.recognition_rating !== "insufficient_data" && (
          <div className="grid grid-cols-3 sm:grid-cols-5 gap-1.5">
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.recognition_type_variety >= 5 ? "bg-green-50" : d.recognition_type_variety >= 3 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.recognition_type_variety >= 5 ? "text-[--cs-success]" : d.recognition_type_variety >= 3 ? "text-[--cs-warning]" : "text-[--cs-risk]")}>{d.recognition_type_variety}</p>
