...
export function HomeInfectionPreventionControlIntelligenceCard() {
  ...
  return (
    <Card className={cn("overflow-hidden", isAlert ? "border-red-400 border-2" : "border-lime-600 border-2")} aria-label="ARIA Infection Prevention &amp; Control Intelligence">
