...
// ══════════════════════════════════════════════════════════════════════════════
// CARA — RESTRAINT DEBRIEF INTELLIGENCE CARD
// Live data from safeguarding intelligence engine.
// CHR 2015 Reg 12/34/35. SCCIF: Safety.
// ══════════════════════════════════════════════════════════════════════════════
    ...
    <Card className="overflow-hidden">
      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-1.5">
          <p className="text-xs font-semibold text-muted-foreground">Restraint Data</p>
          <div className="grid grid-cols-2 gap-2 text-xs">
            <div className="rounded border p-2">
              <span className="text-muted-foreground">Restraints 30d:</span>{" "}
              <span className="font-semibold">{restraints?.total_restraints_30d ?? 0}</span>
            </div>
            <div className="rounded border p-2">
