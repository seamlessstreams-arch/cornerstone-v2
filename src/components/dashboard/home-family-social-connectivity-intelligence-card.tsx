      ...
      <CardHeader className={cn("pb-3", isAlert ? "bg-red-50" : "bg-red-50/50")}>
        <div className="flex items-center justify-between">
          <CardTitle className="text-sm flex items-center gap-2">
            <Heart className={cn("h-4 w-4", isAlert ? "text-red-600" : "text-red-600")} />
        ...
        {d.connectivity_rating !== "insufficient_data" && (
          <div className="grid grid-cols-3 sm:grid-cols-6 gap-1.5">
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.contact_plan_coverage >= 90 ? "bg-green-50" : d.contact_plan_coverage >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.contact_plan_coverage >= 90 ? "text-green-600" : d.contact_plan_coverage >= 70 ? "text-amber-600" : "text-red-600")}>{d.contact_plan_coverage}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.parent_engagement_rate >= 80 ? "bg-green-50" : d.parent_engagement_rate >= 50 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.parent_engagement_rate >= 80 ? "text-green-600" : d.parent_engagement_rate >= 50 ? "text-amber-600" : "text-red-600")}>{d.parent_engagement_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.social_worker_contact_rate >= 90 ? "bg-green-50" : d.social_worker_contact_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.social_worker_contact_rate >= 90 ? "text-green-600" : d.social_worker_contact_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.social_worker_contact_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.child_voice_capture_rate >= 90 ? "bg-green-50" : d.child_voice_capture_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.child_voice_capture_rate >= 90 ? "text-green-600" : d.child_voice_capture_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.child_voice_capture_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.post_contact_distress_rate <= 10 ? "bg-green-50" : d.post_contact_distress_rate <= 30 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.post_contact_distress_rate <= 10 ? "text-green-600" : d.post_contact_distress_rate <= 30 ? "text-amber-600" : "text-red-600")}>{d.post_contact_distress_rate}%</p>
