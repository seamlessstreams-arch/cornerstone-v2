...
export function HomeDbsRenewalStaffVettingIntelligenceCard() {
  ...
  return (
    <Card className={cn("overflow-hidden", isAlert ? "border-red-400 border-2" : "border-slate-600 border-2")} aria-label="ARIA DBS Renewal &amp; Staff Vetting Intelligence">
