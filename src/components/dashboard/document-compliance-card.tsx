    ...
    <Card className="overflow-hidden">
      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-4 gap-2">
          <div className={cn(
            ...
            <p className={cn(
              ...
              o.avg_sign_off_rate >= 80 ? "text-[--cs-success]" : o.avg_sign_off_rate >= 50 ? "text-[--cs-warning]" : "text-[--cs-risk]",
            )}>
              {o.avg_sign_off_rate}%
            </p>
          ...
          <div className={cn(
            ...
            <p className={cn(
              "text-lg font-bold tabular-nums",
              o.documents_expired === 0 ? "text-[--cs-success]" : "text-[--cs-risk]",
            )}>
              {o.documents_expired}
            </p>
          ...
          <div className={cn(
            ...
            <p className={cn(
              "text-lg font-bold tabular-nums",
              o.documents_expiring_soon === 0 ? "text-[--cs-success]" : "text-[--cs-warning]",
            )}>
        ...
        <div className="grid grid-cols-3 gap-2 text-center text-xs">
          ...
          <div>
            <p className={cn("font-bold tabular-nums", o.mandatory_sign_off_rate >= 80 ? "text-[--cs-success]" : o.mandatory_sign_off_rate >= 50 ? "text-[--cs-warning]" : "text-[--cs-risk]")}>
                ...
                <div key={dp.document_id} className="rounded-lg border p-3 text-xs">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-1.5">
                      <Badge className={cn(
                        "text-[9px]",
                        dp.sign_off_rate >= 80 ? "bg-[--cs-success-bg] text-[--cs-success]"
                  ...
                  <div className="flex items-center gap-3 mt-1 text-muted-foreground">
                    ...
                    {dp.days_until_expiry !== null && (
                      <span className={cn(
                        "text-[10px]",
                        dp.days_until_expiry < 0 ? "text-[--cs-risk]" : dp.days_until_expiry <= 30 ? "text-[--cs-warning]" : "",
                      )}>
