...
export function HomeStaffSupervisionReflectivePracticeIntelligenceCard() {
  const { data, isLoading } = useHomeStaffSupervisionReflectivePracticeIntelligence();
  ...
  const ratingStyle = RATING_STYLES[d.supervision_rating as SupervisionRating] ?? RATING_STYLES.insufficient_data;
  const isAlert = d.supervision_rating === "inadequate";
        ...
        {d.supervision_rating !== "insufficient_data" && (
          <div className="grid grid-cols-3 sm:grid-cols-6 gap-1.5">
            <div className={cn("text-center rounded-lg p-1.5", d.supervision_timeliness_rate >= 90 ? "bg-green-50" : d.supervision_timeliness_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.supervision_timeliness_rate >= 90 ? "text-green-600" : d.supervision_timeliness_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.supervision_timeliness_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.supervision_quality_avg >= 4.0 ? "bg-green-50" : d.supervision_quality_avg >= 3.0 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.supervision_quality_avg >= 4.0 ? "text-green-600" : d.supervision_quality_avg >= 3.0 ? "text-amber-600" : "text-red-600")}>{d.supervision_quality_avg}</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.safeguarding_supervision_coverage_rate >= 90 ? "bg-green-50" : d.safeguarding_supervision_coverage_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.safeguarding_supervision_coverage_rate >= 90 ? "text-green-600" : d.safeguarding_supervision_coverage_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.safeguarding_supervision_coverage_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.reflective_practice_engagement_rate >= 90 ? "bg-green-50" : d.reflective_practice_engagement_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.reflective_practice_engagement_rate >= 90 ? "text-green-600" : d.reflective_practice_engagement_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.reflective_practice_engagement_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.theme_coverage_breadth >= 6 ? "bg-green-50" : d.theme_coverage_breadth >= 4 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.theme_coverage_breadth >= 6 ? "text-green-600" : d.theme_coverage_breadth >= 4 ? "text-amber-600" : "text-red-600")}>{d.theme_coverage_breadth}/8</p>
