...
export function HomeMissingPersonAbsentAuthorityIntelligenceCard() {
  ...
  return (
    <Card className={cn("overflow-hidden", isAlert ? "border-red-400 border-2" : "border-red-600 border-2")} role="region" aria-label="ARIA Missing Person &amp; Absent Without Authority Intelligence">
