...
export function HomeMissingPersonAbsentAuthorityIntelligenceCard() {
  const { data, isLoading } = useHomeMissingPersonAbsentAuthorityIntelligence();
  ...
  const ratingStyle = RATING_STYLES[d.missing_rating as MissingPersonRating] ?? RATING_STYLES.insufficient_data;
  const isAlert = d.missing_rating === "inadequate";

  return (
    <Card className={cn("overflow-hidden", isAlert ? "border-red-400 border-2" : "border-red-600 border-2")} role="region" aria-label="Cara Missing Person &amp; Absent Without Authority Intelligence">
      <CardHeader className={cn("pb-3", isAlert ? "bg-red-50" : "bg-red-50/50")}>
        <div className="flex items-center justify-between">
          <CardTitle className="text-sm flex items-center gap-2">
            <Search className={cn("h-4 w-4", isAlert ? "text-red-600" : "text-red-600")} />
        ...
        {d.missing_rating !== "insufficient_data" && (
          <div className="grid grid-cols-3 sm:grid-cols-6 gap-1.5">
            <div className={cn("text-center rounded-lg p-1.5", d.protocol_adherence_rate >= 90 ? "bg-green-50" : d.protocol_adherence_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.protocol_adherence_rate >= 90 ? "text-green-600" : d.protocol_adherence_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.protocol_adherence_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.return_interview_rate >= 90 ? "bg-green-50" : d.return_interview_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.return_interview_rate >= 90 ? "text-green-600" : d.return_interview_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.return_interview_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.risk_update_rate >= 90 ? "bg-green-50" : d.risk_update_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.risk_update_rate >= 90 ? "text-green-600" : d.risk_update_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.risk_update_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.police_liaison_rate >= 90 ? "bg-green-50" : d.police_liaison_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.police_liaison_rate >= 90 ? "text-green-600" : d.police_liaison_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.police_liaison_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.pattern_analysis_rate >= 90 ? "bg-green-50" : d.pattern_analysis_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.pattern_analysis_rate >= 90 ? "text-green-600" : d.pattern_analysis_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.pattern_analysis_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.prevention_rate >= 90 ? "bg-green-50" : d.prevention_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.prevention_rate >= 90 ? "text-green-600" : d.prevention_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.prevention_rate}%</p>
