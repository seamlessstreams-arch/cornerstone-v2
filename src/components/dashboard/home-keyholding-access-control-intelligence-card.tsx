...
export function HomeKeyholdingAccessControlIntelligenceCard() {
  ...
  return (
    <Card className={cn("overflow-hidden", isAlert ? "border-red-400 border-2" : "border-stone-600 border-2")} role="region" aria-label="ARIA Keyholding & Access Control Intelligence">
