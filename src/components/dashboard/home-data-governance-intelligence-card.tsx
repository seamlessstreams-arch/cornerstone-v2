      ...
      <CardHeader className={cn("pb-3", isAlert ? "bg-red-50" : "bg-slate-50/50")}>
        <div className="flex items-center justify-between">
          <CardTitle className="text-sm flex items-center gap-2">
            <Database className={cn("h-4 w-4", isAlert ? "text-[--cs-risk]" : "text-teal-500")} />
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
            ...
            <div className="text-center rounded-lg bg-slate-50 p-2">
              <div className="flex items-center justify-center gap-1">
                ...
                <p className={cn("text-lg font-bold tabular-nums",
                  d.breaches.open_breaches === 0 ? "text-[--cs-success]" :
                  d.breaches.open_breaches <= 1 ? "text-[--cs-warning]" : "text-[--cs-risk]"
                )}>
            ...
            <div className="text-center rounded-lg bg-slate-50 p-2">
              <div className="flex items-center justify-center gap-1">
                ...
                <p className={cn("text-lg font-bold tabular-nums",
                  d.data_protection.overdue_records === 0 ? "text-[--cs-success]" :
                  d.data_protection.overdue_records <= 2 ? "text-[--cs-warning]" : "text-[--cs-risk]"
                )}>
            ...
            <div className="text-center rounded-lg bg-slate-50 p-2">
              <div className="flex items-center justify-center gap-1">
                ...
                <p className={cn("text-lg font-bold tabular-nums",
                  d.sars.overdue_requests === 0 ? "text-[--cs-success]" :
                  d.sars.overdue_requests <= 1 ? "text-[--cs-warning]" : "text-[--cs-risk]"
                )}>
