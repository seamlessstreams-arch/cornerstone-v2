      ...
      <CardHeader className={cn("pb-3", isAlert ? "bg-red-50" : "bg-amber-50/50")}>
        <div className="flex items-center justify-between">
          <CardTitle className="text-sm flex items-center gap-2">
            <PawPrint className={cn("h-4 w-4", isAlert ? "text-red-600" : "text-amber-600")} />
        ...
        {d.therapy_rating !== "insufficient_data" && (
          <div className="grid grid-cols-3 sm:grid-cols-6 gap-1.5">
            <div className={cn("text-center rounded-lg p-1.5", d.therapy_frequency_rate >= 90 ? "bg-green-50" : d.therapy_frequency_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.therapy_frequency_rate >= 90 ? "text-green-600" : d.therapy_frequency_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.therapy_frequency_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.pet_care_responsibility_rate >= 90 ? "bg-green-50" : d.pet_care_responsibility_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.pet_care_responsibility_rate >= 90 ? "text-green-600" : d.pet_care_responsibility_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.pet_care_responsibility_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.interaction_outcome_rate >= 90 ? "bg-green-50" : d.interaction_outcome_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.interaction_outcome_rate >= 90 ? "text-green-600" : d.interaction_outcome_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.interaction_outcome_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.welfare_compliance_rate >= 90 ? "bg-green-50" : d.welfare_compliance_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.welfare_compliance_rate >= 90 ? "text-green-600" : d.welfare_compliance_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.welfare_compliance_rate}%</p>
