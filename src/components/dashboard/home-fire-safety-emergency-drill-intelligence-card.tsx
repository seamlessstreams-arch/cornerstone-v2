      ...
      <CardHeader className={cn("pb-3", isAlert ? "bg-red-50" : "bg-red-50/50")}>
        <div className="flex items-center justify-between">
          <CardTitle className="text-sm flex items-center gap-2">
            <Flame className={cn("h-4 w-4", isAlert ? "text-red-600" : "text-red-600")} />
        ...
        {d.fire_safety_rating !== "insufficient_data" && (
          <div className="grid grid-cols-3 sm:grid-cols-6 gap-1.5">
            <div className={cn("text-center rounded-lg p-1.5", d.drill_compliance_rate >= 90 ? "bg-green-50" : d.drill_compliance_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.drill_compliance_rate >= 90 ? "text-green-600" : d.drill_compliance_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.drill_compliance_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.evacuation_time_rate >= 90 ? "bg-green-50" : d.evacuation_time_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.evacuation_time_rate >= 90 ? "text-green-600" : d.evacuation_time_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.evacuation_time_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.risk_assessment_currency_rate >= 90 ? "bg-green-50" : d.risk_assessment_currency_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.risk_assessment_currency_rate >= 90 ? "text-green-600" : d.risk_assessment_currency_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.risk_assessment_currency_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.equipment_check_rate >= 90 ? "bg-green-50" : d.equipment_check_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.equipment_check_rate >= 90 ? "text-green-600" : d.equipment_check_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.equipment_check_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.documentation_compliance_rate >= 90 ? "bg-green-50" : d.documentation_compliance_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.documentation_compliance_rate >= 90 ? "text-green-600" : d.documentation_compliance_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.documentation_compliance_rate}%</p>
