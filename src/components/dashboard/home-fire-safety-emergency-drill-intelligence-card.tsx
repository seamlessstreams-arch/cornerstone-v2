...
export function HomeFireSafetyEmergencyDrillIntelligenceCard() {
  ...
  return (
    <Card aria-label="ARIA Fire Safety &amp; Emergency Drill Intelligence" className={cn("overflow-hidden", isAlert ? "border-red-400 border-2" : "border-red-600 border-2")}>
