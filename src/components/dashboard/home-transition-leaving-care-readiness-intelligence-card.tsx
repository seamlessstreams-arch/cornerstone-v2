...
import { useHomeTransitionLeavingCareReadinessIntelligence } from "@/hooks/use-home-transition-leaving-care-readiness-intelligence";
import type { TransitionReadinessRating } from "@/lib/engines/home-transition-leaving-care-readiness-intelligence-engine";

const RATING_STYLES: Record<TransitionReadinessRating, { bg: string; text: string; border: string; label: string }> = {
...
export function HomeTransitionLeavingCareReadinessIntelligenceCard() {
  const { data, isLoading } = useHomeTransitionLeavingCareReadinessIntelligence();
  ...
  const __emptyState = d.readiness_rating === "inadequate" && (d.readiness_score ?? 0) <= 15;
  if (__emptyState) {
    d = {
      ...d,
  ...
  const ratingStyle = RATING_STYLES[d.readiness_rating as TransitionReadinessRating] ?? RATING_STYLES.insufficient_data;
      ...
      <CardHeader className={cn("pb-3", isAlert ? "bg-red-50" : "bg-emerald-50/50")}>
        <div className="flex items-center justify-between">
          <CardTitle className="text-sm flex items-center gap-2">
            <GraduationCap className={cn("h-4 w-4", isAlert ? "text-red-600" : "text-emerald-600")} />
        ...
        {d.readiness_rating !== "insufficient_data" && (
          <div className="grid grid-cols-3 sm:grid-cols-6 gap-1.5">
            <div className={cn("text-center rounded-lg p-1.5", d.transition_plan_coverage_rate >= 90 ? "bg-green-50" : d.transition_plan_coverage_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.transition_plan_coverage_rate >= 90 ? "text-green-600" : d.transition_plan_coverage_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.transition_plan_coverage_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.pathway_plan_currency_rate >= 90 ? "bg-green-50" : d.pathway_plan_currency_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.pathway_plan_currency_rate >= 90 ? "text-green-600" : d.pathway_plan_currency_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.pathway_plan_currency_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.leaving_care_completion_rate >= 90 ? "bg-green-50" : d.leaving_care_completion_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.leaving_care_completion_rate >= 90 ? "text-green-600" : d.leaving_care_completion_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.leaving_care_completion_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.independence_assessment_rate >= 90 ? "bg-green-50" : d.independence_assessment_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.independence_assessment_rate >= 90 ? "text-green-600" : d.independence_assessment_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.independence_assessment_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.aftercare_contact_rate >= 90 ? "bg-green-50" : d.aftercare_contact_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.aftercare_contact_rate >= 90 ? "text-green-600" : d.aftercare_contact_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.aftercare_contact_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.child_voice_in_transition_rate >= 90 ? "bg-green-50" : d.child_voice_in_transition_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.child_voice_in_transition_rate >= 90 ? "text-green-600" : d.child_voice_in_transition_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.child_voice_in_transition_rate}%</p>
