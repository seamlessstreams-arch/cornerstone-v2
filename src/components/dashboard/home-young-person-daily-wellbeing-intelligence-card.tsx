        ...
        {d.wellbeing_rating !== "insufficient_data" && (
          <div className="grid grid-cols-3 sm:grid-cols-6 gap-1.5">
            <div className={cn("text-center rounded-lg p-1.5", d.logs_last_30_days > 0 ? "bg-green-50" : "bg-amber-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.logs_last_30_days > 0 ? "text-[--cs-success]" : "text-[--cs-warning]")}>{d.logs_last_30_days}</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.average_mood_score >= 7 ? "bg-green-50" : d.average_mood_score >= 5 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.average_mood_score >= 7 ? "text-[--cs-success]" : d.average_mood_score >= 5 ? "text-[--cs-warning]" : "text-[--cs-risk]")}>{d.average_mood_score}</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.high_severity_count === 0 ? "bg-green-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.high_severity_count === 0 ? "text-[--cs-success]" : "text-[--cs-risk]")}>{d.high_severity_count}</p>
