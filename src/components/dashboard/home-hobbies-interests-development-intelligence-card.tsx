      ...
      <CardHeader className={cn("pb-3", isAlert ? "bg-red-50" : "bg-pink-50/50")}>
        <div className="flex items-center justify-between">
          <CardTitle className="text-sm flex items-center gap-2">
            <Palette className={cn("h-4 w-4", isAlert ? "text-red-600" : "text-pink-600")} />
        ...
        {d.hobbies_rating !== "insufficient_data" && (
          <div className="grid grid-cols-3 sm:grid-cols-6 gap-1.5">
            <div className={cn("text-center rounded-lg p-1.5", d.hobby_participation_rate >= 90 ? "bg-green-50" : d.hobby_participation_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.hobby_participation_rate >= 90 ? "text-green-600" : d.hobby_participation_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.hobby_participation_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.interest_exploration_rate >= 90 ? "bg-green-50" : d.interest_exploration_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.interest_exploration_rate >= 90 ? "text-green-600" : d.interest_exploration_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.interest_exploration_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.talent_development_rate >= 90 ? "bg-green-50" : d.talent_development_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.talent_development_rate >= 90 ? "text-green-600" : d.talent_development_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.talent_development_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.creative_expression_rate >= 90 ? "bg-green-50" : d.creative_expression_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.creative_expression_rate >= 90 ? "text-green-600" : d.creative_expression_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.creative_expression_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.child_led_rate >= 90 ? "bg-green-50" : d.child_led_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.child_led_rate >= 90 ? "text-green-600" : d.child_led_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.child_led_rate}%</p>
