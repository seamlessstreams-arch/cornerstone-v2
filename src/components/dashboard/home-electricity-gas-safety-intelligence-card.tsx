      ...
      <CardHeader className={cn("pb-3", isAlert ? "bg-red-50" : "bg-yellow-50/50")}>
        <div className="flex items-center justify-between">
          <CardTitle className="text-sm flex items-center gap-2">
            <Plug className={cn("h-4 w-4", isAlert ? "text-red-600" : "text-yellow-600")} />
        ...
        {d.electrical_rating !== "insufficient_data" && (
          <div className="grid grid-cols-3 sm:grid-cols-6 gap-1.5">
            <div className={cn("text-center rounded-lg p-1.5", d.pat_testing_rate >= 90 ? "bg-green-50" : d.pat_testing_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.pat_testing_rate >= 90 ? "text-green-600" : d.pat_testing_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.pat_testing_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.gas_certificate_rate >= 90 ? "bg-green-50" : d.gas_certificate_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.gas_certificate_rate >= 90 ? "text-green-600" : d.gas_certificate_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.gas_certificate_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.electrical_inspection_rate >= 90 ? "bg-green-50" : d.electrical_inspection_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.electrical_inspection_rate >= 90 ? "text-green-600" : d.electrical_inspection_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.electrical_inspection_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.co_detector_rate >= 90 ? "bg-green-50" : d.co_detector_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.co_detector_rate >= 90 ? "text-green-600" : d.co_detector_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.co_detector_rate}%</p>
