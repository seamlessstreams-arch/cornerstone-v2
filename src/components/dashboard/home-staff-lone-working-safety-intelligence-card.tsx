      ...
      <CardHeader className={cn("pb-3", isAlert ? "bg-red-50" : "bg-red-50/50")}>
        <div className="flex items-center justify-between">
          <CardTitle className="text-sm flex items-center gap-2">
            <UserCheck className={cn("h-4 w-4", isAlert ? "text-red-600" : "text-red-600")} />
      ...
      <CardContent className="space-y-4">
        {d.lone_working_rating !== "insufficient_data" && (
          <div className="grid grid-cols-3 sm:grid-cols-6 gap-1.5">
            <div className={cn("text-center rounded-lg p-1.5", d.risk_assessment_rate >= 90 ? "bg-green-50" : d.risk_assessment_rate >= 70 ? "bg-amber-50" : "bg-red-50")}><p className={cn("text-sm font-bold tabular-nums", d.risk_assessment_rate >= 90 ? "text-green-600" : d.risk_assessment_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.risk_assessment_rate}%</p><p className="text-[9px] text-muted-foreground">Risk Asst.</p></div>
            <div className={cn("text-center rounded-lg p-1.5", d.check_in_compliance_rate >= 90 ? "bg-green-50" : d.check_in_compliance_rate >= 70 ? "bg-amber-50" : "bg-red-50")}><p className={cn("text-sm font-bold tabular-nums", d.check_in_compliance_rate >= 90 ? "text-green-600" : d.check_in_compliance_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.check_in_compliance_rate}%</p><p className="text-[9px] text-muted-foreground">Check-in</p></div>
            <div className={cn("text-center rounded-lg p-1.5", d.safety_protocol_rate >= 90 ? "bg-green-50" : d.safety_protocol_rate >= 70 ? "bg-amber-50" : "bg-red-50")}><p className={cn("text-sm font-bold tabular-nums", d.safety_protocol_rate >= 90 ? "text-green-600" : d.safety_protocol_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.safety_protocol_rate}%</p><p className="text-[9px] text-muted-foreground">Protocol</p></div>
            <div className={cn("text-center rounded-lg p-1.5", d.communication_device_rate >= 90 ? "bg-green-50" : d.communication_device_rate >= 70 ? "bg-amber-50" : "bg-red-50")}><p className={cn("text-sm font-bold tabular-nums", d.communication_device_rate >= 90 ? "text-green-600" : d.communication_device_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.communication_device_rate}%</p><p className="text-[9px] text-muted-foreground">Comms</p></div>
            <div className={cn("text-center rounded-lg p-1.5", d.incident_reporting_rate >= 90 ? "bg-green-50" : d.incident_reporting_rate >= 70 ? "bg-amber-50" : "bg-red-50")}><p className={cn("text-sm font-bold tabular-nums", d.incident_reporting_rate >= 90 ? "text-green-600" : d.incident_reporting_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.incident_reporting_rate}%</p><p className="text-[9px] text-muted-foreground">Incidents</p></div>
            <div className={cn("text-center rounded-lg p-1.5", d.staff_confidence_rate >= 90 ? "bg-green-50" : d.staff_confidence_rate >= 70 ? "bg-amber-50" : "bg-red-50")}><p className={cn("text-sm font-bold tabular-nums", d.staff_confidence_rate >= 90 ? "text-green-600" : d.staff_confidence_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.staff_confidence_rate}%</p><p className="text-[9px] text-muted-foreground">Confid.</p></div>
          </div>
        )}
