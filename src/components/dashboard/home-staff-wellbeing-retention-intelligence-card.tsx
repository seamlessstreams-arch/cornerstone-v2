...
export function HomeStaffWellbeingRetentionIntelligenceCard() {
  const { data, isLoading } = useHomeStaffWellbeingRetentionIntelligence();
  ...
  const ratingStyle = RATING_STYLES[d.wellbeing_rating as StaffWellbeingRating] ?? RATING_STYLES.insufficient_data;
      ...
      <CardHeader className={cn("pb-3", isAlert ? "bg-red-50" : "bg-pink-50/50")}>
        <div className="flex items-center justify-between">
          <CardTitle className="text-sm flex items-center gap-2">
            <HeartHandshake className={cn("h-4 w-4", isAlert ? "text-red-600" : "text-pink-600")} />
        ...
        {d.wellbeing_rating !== "insufficient_data" && (
          <div className="grid grid-cols-3 sm:grid-cols-6 gap-1.5">
            <div className={cn("text-center rounded-lg p-1.5", d.sickness_absence_rate <= 10 ? "bg-green-50" : d.sickness_absence_rate <= 30 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.sickness_absence_rate <= 10 ? "text-green-600" : d.sickness_absence_rate <= 30 ? "text-amber-600" : "text-red-600")}>{d.sickness_absence_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.wellbeing_survey_completion_rate >= 90 ? "bg-green-50" : d.wellbeing_survey_completion_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.wellbeing_survey_completion_rate >= 90 ? "text-green-600" : d.wellbeing_survey_completion_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.wellbeing_survey_completion_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.retention_rate >= 90 ? "bg-green-50" : d.retention_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.retention_rate >= 90 ? "text-green-600" : d.retention_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.retention_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.wellbeing_support_uptake_rate >= 90 ? "bg-green-50" : d.wellbeing_support_uptake_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.wellbeing_support_uptake_rate >= 90 ? "text-green-600" : d.wellbeing_support_uptake_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.wellbeing_support_uptake_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.exit_interview_completion_rate >= 90 ? "bg-green-50" : d.exit_interview_completion_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.exit_interview_completion_rate >= 90 ? "text-green-600" : d.exit_interview_completion_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.exit_interview_completion_rate}%</p>
