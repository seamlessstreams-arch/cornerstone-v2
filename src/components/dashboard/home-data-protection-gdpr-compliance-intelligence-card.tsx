...
export function HomeDataProtectionGdprComplianceIntelligenceCard() {
  ...
  return (
    <Card className={cn("overflow-hidden", isAlert ? "border-red-400 border-2" : "border-green-600 border-2")} role="region" aria-label="ARIA Data Protection &amp; GDPR Compliance Intelligence">
