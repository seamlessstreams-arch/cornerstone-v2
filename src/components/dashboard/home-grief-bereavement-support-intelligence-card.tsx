      ...
      <CardHeader className={cn("pb-3", isAlert ? "bg-red-50" : "bg-rose-50/50")}>
        <div className="flex items-center justify-between">
          <CardTitle className="text-sm flex items-center gap-2">
            <Heart className={cn("h-4 w-4", isAlert ? "text-red-600" : "text-rose-600")} />
        ...
        {d.grief_rating !== "insufficient_data" && (
          <div className="grid grid-cols-3 sm:grid-cols-6 gap-1.5">
            <div className={cn("text-center rounded-lg p-1.5", d.loss_identification_rate >= 90 ? "bg-green-50" : d.loss_identification_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.loss_identification_rate >= 90 ? "text-green-600" : d.loss_identification_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.loss_identification_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.counselling_access_rate >= 90 ? "bg-green-50" : d.counselling_access_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.counselling_access_rate >= 90 ? "text-green-600" : d.counselling_access_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.counselling_access_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.memory_work_rate >= 90 ? "bg-green-50" : d.memory_work_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.memory_work_rate >= 90 ? "text-green-600" : d.memory_work_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.memory_work_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.anniversary_management_rate >= 90 ? "bg-green-50" : d.anniversary_management_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.anniversary_management_rate >= 90 ? "text-green-600" : d.anniversary_management_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.anniversary_management_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.child_coping_rate >= 90 ? "bg-green-50" : d.child_coping_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.child_coping_rate >= 90 ? "text-green-600" : d.child_coping_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.child_coping_rate}%</p>
