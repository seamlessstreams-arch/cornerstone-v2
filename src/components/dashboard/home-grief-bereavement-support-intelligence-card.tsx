...
export function HomeGriefBereavementSupportIntelligenceCard() {
  ...
  return (
    <Card className={cn("overflow-hidden", isAlert ? "border-red-400 border-2" : "border-rose-600 border-2")} aria-label="ARIA Grief &amp; Bereavement Support Intelligence">
