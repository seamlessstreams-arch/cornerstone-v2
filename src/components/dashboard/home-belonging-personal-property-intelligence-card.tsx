      ...
      <CardHeader className={cn("pb-3", isAlert ? "bg-red-50" : "bg-pink-50/50")}>
        <div className="flex items-center justify-between">
          <CardTitle className="text-sm flex items-center gap-2">
            <Package className={cn("h-4 w-4", isAlert ? "text-red-600" : "text-pink-600")} />
        ...
        {d.belonging_rating !== "insufficient_data" && (
          <div className="grid grid-cols-3 sm:grid-cols-5 gap-1.5">
            <div className={cn("text-center rounded-lg p-1.5", d.children_with_inventory > 0 ? "bg-green-50" : "bg-amber-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.children_with_inventory > 0 ? "text-green-600" : "text-amber-600")}>{d.children_with_inventory}</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.clothing_choice_rate >= 85 ? "bg-green-50" : d.clothing_choice_rate >= 60 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.clothing_choice_rate >= 85 ? "text-green-600" : d.clothing_choice_rate >= 60 ? "text-amber-600" : "text-red-600")}>{d.clothing_choice_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.hair_cultural_rate >= 85 ? "bg-green-50" : d.hair_cultural_rate >= 60 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.hair_cultural_rate >= 85 ? "text-green-600" : d.hair_cultural_rate >= 60 ? "text-amber-600" : "text-red-600")}>{d.hair_cultural_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.gift_personalisation_rate >= 85 ? "bg-green-50" : d.gift_personalisation_rate >= 60 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.gift_personalisation_rate >= 85 ? "text-green-600" : d.gift_personalisation_rate >= 60 ? "text-amber-600" : "text-red-600")}>{d.gift_personalisation_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.property_loss_rate <= 0.5 ? "bg-green-50" : d.property_loss_rate <= 2 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.property_loss_rate <= 0.5 ? "text-green-600" : d.property_loss_rate <= 2 ? "text-amber-600" : "text-red-600")}>{d.property_loss_rate}</p>
