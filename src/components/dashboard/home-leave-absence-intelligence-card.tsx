...
// ══════════════════════════════════════════════════════════════════════════════
// CARA — HOME LEAVE & ABSENCE INTELLIGENCE CARD
...
export function HomeLeaveAbsenceIntelligenceCard() {
  ...
  const __emptyState = d.leave_rating === "inadequate" && (d.leave_score ?? 0) <= 15;
  if (__emptyState) {
    d = {
      ...d,
  ...
  return (
    <Card className={cn("overflow-hidden", isAlert ? "border-red-400 border-2" : "border-slate-200")}>
      ...
      <CardContent className="space-y-4">
        {d.leave_rating === "insufficient_data" && <IntelligenceCardEmpty />}
