...
export function HomeDigitalSafetyOnlineProtectionIntelligenceCard() {
  const { data, isLoading } = useHomeDigitalSafetyOnlineProtectionIntelligence();
  ...
  if (!d) return null;
  const ratingStyle = RATING_STYLES[d.digital_safety_rating as DigitalSafetyRating] ?? RATING_STYLES.insufficient_data;
  const isAlert = d.digital_safety_rating === "inadequate";
      ...
      <CardHeader className={cn("pb-3", isAlert ? "bg-red-50" : "bg-sky-50/50")}>
        <div className="flex items-center justify-between">
          <CardTitle className="text-sm flex items-center gap-2">
            <Monitor className={cn("h-4 w-4", isAlert ? "text-red-600" : "text-sky-600")} />
        ...
        {d.digital_safety_rating !== "insufficient_data" && (
          <div className="grid grid-cols-3 sm:grid-cols-6 gap-1.5">
            <div className={cn("text-center rounded-lg p-1.5", d.esafety_training_compliance_rate >= 90 ? "bg-green-50" : d.esafety_training_compliance_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.esafety_training_compliance_rate >= 90 ? "text-green-600" : d.esafety_training_compliance_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.esafety_training_compliance_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.usage_monitoring_rate >= 90 ? "bg-green-50" : d.usage_monitoring_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.usage_monitoring_rate >= 90 ? "text-green-600" : d.usage_monitoring_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.usage_monitoring_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.social_media_risk_assessment_rate >= 90 ? "bg-green-50" : d.social_media_risk_assessment_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.social_media_risk_assessment_rate >= 90 ? "text-green-600" : d.social_media_risk_assessment_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.social_media_risk_assessment_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.access_agreement_coverage_rate >= 90 ? "bg-green-50" : d.access_agreement_coverage_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.access_agreement_coverage_rate >= 90 ? "text-green-600" : d.access_agreement_coverage_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.access_agreement_coverage_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.digital_literacy_engagement_rate >= 90 ? "bg-green-50" : d.digital_literacy_engagement_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.digital_literacy_engagement_rate >= 90 ? "text-green-600" : d.digital_literacy_engagement_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.digital_literacy_engagement_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.incident_response_rate >= 90 ? "bg-green-50" : d.incident_response_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.incident_response_rate >= 90 ? "text-green-600" : d.incident_response_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.incident_response_rate}%</p>
