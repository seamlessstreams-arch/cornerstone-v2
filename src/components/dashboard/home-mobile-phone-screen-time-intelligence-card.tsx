      ...
      <CardHeader className={cn("pb-3", isAlert ? "bg-red-50" : "bg-slate-50/50")}>
        <div className="flex items-center justify-between">
          <CardTitle className="text-sm flex items-center gap-2">
            <Smartphone className={cn("h-4 w-4", isAlert ? "text-red-600" : "text-slate-600")} />
        ...
        {d.screen_time_rating !== "insufficient_data" && (
          <div className="grid grid-cols-3 sm:grid-cols-6 gap-1.5">
            <div className={cn("text-center rounded-lg p-1.5", d.screen_time_management_rate >= 90 ? "bg-green-50" : d.screen_time_management_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.screen_time_management_rate >= 90 ? "text-green-600" : d.screen_time_management_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.screen_time_management_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.content_monitoring_rate >= 90 ? "bg-green-50" : d.content_monitoring_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.content_monitoring_rate >= 90 ? "text-green-600" : d.content_monitoring_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.content_monitoring_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.usage_agreement_rate >= 90 ? "bg-green-50" : d.usage_agreement_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.usage_agreement_rate >= 90 ? "text-green-600" : d.usage_agreement_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.usage_agreement_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.digital_wellbeing_rate >= 90 ? "bg-green-50" : d.digital_wellbeing_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.digital_wellbeing_rate >= 90 ? "text-green-600" : d.digital_wellbeing_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.digital_wellbeing_rate}%</p>
