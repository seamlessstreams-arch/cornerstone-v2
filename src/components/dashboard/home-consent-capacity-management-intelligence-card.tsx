...
export function HomeConsentCapacityManagementIntelligenceCard() {
  ...
  return (
    <Card className={cn("overflow-hidden", isAlert ? "border-red-400 border-2" : "border-emerald-600 border-2")} aria-label="ARIA Consent &amp; Capacity Intelligence">
