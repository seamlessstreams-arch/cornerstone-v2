      ...
      <CardHeader className={cn("pb-3", isAlert ? "bg-red-50" : "bg-pink-50/50")}>
        <div className="flex items-center justify-between">
          <CardTitle className="text-sm flex items-center gap-2">
            <Moon className={cn("h-4 w-4", isAlert ? "text-[--cs-risk]" : "text-pink-600")} />
        ...
        {d.sleep_rating !== "insufficient_data" && (
          <div className="grid grid-cols-3 sm:grid-cols-6 gap-1.5">
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.significant_disturbance_count === 0 ? "bg-green-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.significant_disturbance_count === 0 ? "text-[--cs-success]" : "text-[--cs-risk]")}>{d.significant_disturbance_count}</p>
