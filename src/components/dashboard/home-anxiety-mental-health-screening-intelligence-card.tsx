      ...
      <CardHeader className={cn("pb-3", isAlert ? "bg-red-50" : "bg-violet-50/50")}>
        <div className="flex items-center justify-between">
          <CardTitle className="text-sm flex items-center gap-2">
            <Brain className={cn("h-4 w-4", isAlert ? "text-red-600" : "text-violet-600")} />
        ...
        {d.mental_health_rating !== "insufficient_data" && (
          <div className="grid grid-cols-3 sm:grid-cols-6 gap-1.5">
            <div className={cn("text-center rounded-lg p-1.5", d.screening_completion_rate >= 90 ? "bg-green-50" : d.screening_completion_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.screening_completion_rate >= 90 ? "text-green-600" : d.screening_completion_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.screening_completion_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.anxiety_assessment_rate >= 90 ? "bg-green-50" : d.anxiety_assessment_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.anxiety_assessment_rate >= 90 ? "text-green-600" : d.anxiety_assessment_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.anxiety_assessment_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.camhs_referral_rate >= 90 ? "bg-green-50" : d.camhs_referral_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.camhs_referral_rate >= 90 ? "text-green-600" : d.camhs_referral_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.camhs_referral_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.wellbeing_checkin_rate >= 90 ? "bg-green-50" : d.wellbeing_checkin_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.wellbeing_checkin_rate >= 90 ? "text-green-600" : d.wellbeing_checkin_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.wellbeing_checkin_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.early_intervention_rate >= 90 ? "bg-green-50" : d.early_intervention_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.early_intervention_rate >= 90 ? "text-green-600" : d.early_intervention_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.early_intervention_rate}%</p>
