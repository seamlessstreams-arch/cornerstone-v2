...
export function HomeParentalContactFamilyEngagementIntelligenceCard() {
  const { data, isLoading } = useHomeParentalContactFamilyEngagementIntelligence();
  ...
  const __emptyState = d.engagement_rating === "inadequate" && (d.engagement_score ?? 0) <= 15;
  if (__emptyState) {
    d = {
      ...d,
      engagement_rating: "insufficient_data",
      concerns: [],
      recommendations: [],
      insights: [],
      headline:
  ...
  const ratingStyle = RATING_STYLES[d.engagement_rating as FamilyEngagementRating] ?? RATING_STYLES.insufficient_data;
  const isAlert = d.engagement_rating === "inadequate";
        ...
        {d.engagement_rating !== "insufficient_data" && (
          <div className="grid grid-cols-3 sm:grid-cols-6 gap-1.5">
            <div className={cn("text-center rounded-lg p-1.5", d.contact_compliance_rate >= 90 ? "bg-green-50" : d.contact_compliance_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.contact_compliance_rate >= 90 ? "text-green-600" : d.contact_compliance_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.contact_compliance_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.family_visit_quality_rate >= 90 ? "bg-green-50" : d.family_visit_quality_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.family_visit_quality_rate >= 90 ? "text-green-600" : d.family_visit_quality_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.family_visit_quality_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.parental_engagement_rate >= 90 ? "bg-green-50" : d.parental_engagement_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.parental_engagement_rate >= 90 ? "text-green-600" : d.parental_engagement_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.parental_engagement_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.supervised_contact_adherence_rate >= 90 ? "bg-green-50" : d.supervised_contact_adherence_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.supervised_contact_adherence_rate >= 90 ? "text-green-600" : d.supervised_contact_adherence_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.supervised_contact_adherence_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.family_support_coverage_rate >= 90 ? "bg-green-50" : d.family_support_coverage_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.family_support_coverage_rate >= 90 ? "text-green-600" : d.family_support_coverage_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.family_support_coverage_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.child_voice_in_contact_rate >= 90 ? "bg-green-50" : d.child_voice_in_contact_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.child_voice_in_contact_rate >= 90 ? "text-green-600" : d.child_voice_in_contact_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.child_voice_in_contact_rate}%</p>
