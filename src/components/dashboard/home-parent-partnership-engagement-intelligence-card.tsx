      ...
      <CardHeader className={cn("pb-3", isAlert ? "bg-red-50" : "bg-green-50/50")}>
        <div className="flex items-center justify-between">
          <CardTitle className="text-sm flex items-center gap-2">
            <Heart className={cn("h-4 w-4", isAlert ? "text-red-600" : "text-green-600")} />
        ...
        {d.partnership_rating !== "insufficient_data" && (
          <div className="grid grid-cols-3 sm:grid-cols-6 gap-1.5">
            <div className={cn("text-center rounded-lg p-1.5", d.total_contacts > 0 ? "bg-green-50" : "bg-amber-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.total_contacts > 0 ? "text-green-600" : "text-amber-600")}>{d.total_contacts}</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.positive_engagement_rate >= 70 ? "bg-green-50" : d.positive_engagement_rate >= 40 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.positive_engagement_rate >= 70 ? "text-green-600" : d.positive_engagement_rate >= 40 ? "text-amber-600" : "text-red-600")}>{d.positive_engagement_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.children_with_contact_rate >= 90 ? "bg-green-50" : d.children_with_contact_rate >= 60 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.children_with_contact_rate >= 90 ? "text-green-600" : d.children_with_contact_rate >= 60 ? "text-amber-600" : "text-red-600")}>{d.children_with_contact_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.sw_informed_rate >= 80 ? "bg-green-50" : d.sw_informed_rate >= 50 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.sw_informed_rate >= 80 ? "text-green-600" : d.sw_informed_rate >= 50 ? "text-amber-600" : "text-red-600")}>{d.sw_informed_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.contact_type_variety >= 4 ? "bg-green-50" : d.contact_type_variety >= 2 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.contact_type_variety >= 4 ? "text-green-600" : d.contact_type_variety >= 2 ? "text-amber-600" : "text-red-600")}>{d.contact_type_variety}</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.relationship_variety >= 3 ? "bg-green-50" : d.relationship_variety >= 2 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.relationship_variety >= 3 ? "text-green-600" : d.relationship_variety >= 2 ? "text-amber-600" : "text-red-600")}>{d.relationship_variety}</p>
