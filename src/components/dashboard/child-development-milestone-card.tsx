...
// ══════════════════════════════════════════════════════════════════════════════
// CORNERSTONE — CHILD DEVELOPMENT MILESTONE CARD
...
import {
  AlertTriangle, Baby, Brain, ChevronRight, Loader2,
} from "lucide-react";
      ...
      <CardHeader className="pb-3 bg-slate-50/50">
        <div className="flex items-center justify-between">
          <CardTitle className="text-sm flex items-center gap-2">
            <Baby className="h-4 w-4 text-slate-600" />
            <span className="text-slate-900">Development Milestones</span>
          </CardTitle>
      ...
      <CardContent className="space-y-4">
        <div className="grid grid-cols-4 gap-2">
          ...
          <div className="text-center rounded-lg bg-green-50 p-2">
            <p className="text-lg font-bold tabular-nums text-green-600">{d?.compliance?.health_assessment_current ?? 0}</p>
          ...
          <div className="text-center rounded-lg bg-blue-50 p-2">
            ...
            <p className="text-[10px] text-muted-foreground">CAMHS</p>
          </div>
        </div>
        ...
        {insights.length > 0 && (
          <div className="space-y-1.5">
            <p className="text-xs font-semibold flex items-center gap-1 text-purple-700">
              ...
              ARIA Development Milestones Intelligence
            </p>
