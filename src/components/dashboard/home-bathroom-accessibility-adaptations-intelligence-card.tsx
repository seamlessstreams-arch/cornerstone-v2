...
export function HomeBathroomAccessibilityAdaptationsIntelligenceCard() {
  ...
  return (
    <Card className={cn("overflow-hidden", isAlert ? "border-red-400 border-2" : "border-blue-600 border-2")} aria-label="ARIA Bathroom Accessibility &amp; Adaptations Intelligence">
