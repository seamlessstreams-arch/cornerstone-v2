      ...
      <CardHeader className={cn("pb-3", isAlert ? "bg-red-50" : "bg-orange-50/50")}>
        <div className="flex items-center justify-between">
          <CardTitle className="text-sm flex items-center gap-2">
            <MessageCircle className={cn("h-4 w-4", isAlert ? "text-red-600" : "text-orange-600")} />
        ...
        {d.debrief_rating !== "insufficient_data" && (
          <div className="grid grid-cols-3 sm:grid-cols-6 gap-1.5">
            <div className={cn("text-center rounded-lg p-1.5", d.total_debriefs > 0 ? "bg-green-50" : "bg-amber-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.total_debriefs > 0 ? "text-green-600" : "text-amber-600")}>{d.total_debriefs}</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.timeliness_rate >= 80 ? "bg-green-50" : d.timeliness_rate >= 50 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.timeliness_rate >= 80 ? "text-green-600" : d.timeliness_rate >= 50 ? "text-amber-600" : "text-red-600")}>{d.timeliness_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.child_readiness_rate >= 85 ? "bg-green-50" : d.child_readiness_rate >= 60 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.child_readiness_rate >= 85 ? "text-green-600" : d.child_readiness_rate >= 60 ? "text-amber-600" : "text-red-600")}>{d.child_readiness_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.voice_depth_rate >= 75 ? "bg-green-50" : d.voice_depth_rate >= 45 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.voice_depth_rate >= 75 ? "text-green-600" : d.voice_depth_rate >= 45 ? "text-amber-600" : "text-red-600")}>{d.voice_depth_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.restorative_action_rate >= 75 ? "bg-green-50" : d.restorative_action_rate >= 50 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.restorative_action_rate >= 75 ? "text-green-600" : d.restorative_action_rate >= 50 ? "text-amber-600" : "text-red-600")}>{d.restorative_action_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.follow_up_rate >= 80 ? "bg-green-50" : d.follow_up_rate >= 50 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.follow_up_rate >= 80 ? "text-green-600" : d.follow_up_rate >= 50 ? "text-amber-600" : "text-red-600")}>{d.follow_up_rate}%</p>
