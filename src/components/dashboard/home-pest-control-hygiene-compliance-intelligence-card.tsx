...
export function HomePestControlHygieneComplianceIntelligenceCard() {
  ...
  return (
    <Card className={cn("overflow-hidden", isAlert ? "border-red-400 border-2" : "border-amber-600 border-2")} role="region" aria-label="ARIA Pest Control &amp; Hygiene Compliance Intelligence">
