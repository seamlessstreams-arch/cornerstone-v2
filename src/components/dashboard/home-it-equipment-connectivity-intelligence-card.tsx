...
export function HomeItEquipmentConnectivityIntelligenceCard() {
  ...
  const __emptyState = d.it_rating === "inadequate" && (d.it_score ?? 0) <= 15;
  if (__emptyState) {
    d = {
      ...d,
      it_rating: "insufficient_data",
      concerns: [],
      recommendations: [],
      insights: [],
      headline:
