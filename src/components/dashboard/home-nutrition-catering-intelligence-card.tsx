...
import {
  ...
  Sparkles, Brain, UtensilsCrossed,
...
export function HomeNutritionCateringIntelligenceCard() {
  const { data, isLoading } = useHomeNutritionCateringIntelligence();
  ...
  return (
    <Card className={cn("overflow-hidden", isAlert ? "border-red-400 border-2" : "border-slate-200")}>
      ...
      <CardContent className="space-y-4">
        {d.nutrition_rating === "insufficient_data" && <IntelligenceCardEmpty />}
