      ...
      <CardHeader className={cn("pb-3", isAlert ? "bg-red-50" : "bg-lime-50/50")}>
        <div className="flex items-center justify-between">
          <CardTitle className="text-sm flex items-center gap-2">
            <MessageCircle className={cn("h-4 w-4", isAlert ? "text-[--cs-risk]" : "text-lime-600")} />
        ...
        {d.voice_rating !== "insufficient_data" && (
          <div className="grid grid-cols-3 sm:grid-cols-5 gap-1.5">
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.expert_participation_count >= 3 ? "bg-green-50" : d.expert_participation_count >= 1 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.expert_participation_count >= 3 ? "text-[--cs-success]" : d.expert_participation_count >= 1 ? "text-[--cs-warning]" : "text-[--cs-risk]")}>{d.expert_participation_count}</p>
