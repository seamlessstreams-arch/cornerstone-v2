      ...
      <CardHeader className={cn("pb-3", isAlert ? "bg-red-50" : "bg-blue-50/50")}>
        <div className="flex items-center justify-between">
          <CardTitle className="text-sm flex items-center gap-2">
            <Lock className={cn("h-4 w-4", isAlert ? "text-[--cs-risk]" : "text-blue-600")} />
        ...
        {d.dol_rating !== "insufficient_data" && (
          <div className="grid grid-cols-3 sm:grid-cols-6 gap-1.5">
            <div className={cn("text-center rounded-lg p-1.5", d.active_restrictions === 0 ? "bg-green-50" : "bg-amber-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.active_restrictions === 0 ? "text-[--cs-success]" : "text-[--cs-warning]")}>{d.active_restrictions}</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.overdue_review_count === 0 ? "bg-green-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.overdue_review_count === 0 ? "text-[--cs-success]" : "text-[--cs-risk]")}>{d.overdue_review_count}</p>
