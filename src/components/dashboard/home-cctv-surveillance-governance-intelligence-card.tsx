      ...
      <CardHeader className={cn("pb-3", isAlert ? "bg-red-50" : "bg-slate-50/50")}>
        <div className="flex items-center justify-between">
          <CardTitle className="text-sm flex items-center gap-2">
            <Camera className={cn("h-4 w-4", isAlert ? "text-[--cs-risk]" : "text-slate-600")} />
        ...
        {d.cctv_rating !== "insufficient_data" && (
          <div className="grid grid-cols-3 sm:grid-cols-6 gap-1.5">
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.privacy_impact_rate >= 90 ? "bg-green-50" : d.privacy_impact_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.privacy_impact_rate >= 90 ? "text-[--cs-success]" : d.privacy_impact_rate >= 70 ? "text-[--cs-warning]" : "text-[--cs-risk]")}>{d.privacy_impact_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.retention_compliance_rate >= 90 ? "bg-green-50" : d.retention_compliance_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.retention_compliance_rate >= 90 ? "text-[--cs-success]" : d.retention_compliance_rate >= 70 ? "text-[--cs-warning]" : "text-[--cs-risk]")}>{d.retention_compliance_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.data_protection_rate >= 90 ? "bg-green-50" : d.data_protection_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.data_protection_rate >= 90 ? "text-[--cs-success]" : d.data_protection_rate >= 70 ? "text-[--cs-warning]" : "text-[--cs-risk]")}>{d.data_protection_rate}%</p>
