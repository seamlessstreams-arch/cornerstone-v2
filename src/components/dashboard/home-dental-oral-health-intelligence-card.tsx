...
export function HomeDentalOralHealthIntelligenceCard() {
  ...
  return (
    <Card className={cn("overflow-hidden", isAlert ? "border-red-400 border-2" : "border-cyan-600 border-2")} aria-label="ARIA Dental &amp; Oral Health Intelligence">
