...
export function HomeAllegationsInvestigationsManagementIntelligenceCard() {
  ...
  return (
    <Card className={cn("overflow-hidden", isAlert ? "border-red-400 border-2" : "border-red-600 border-2")} aria-label="ARIA Allegations &amp; Investigations Intelligence">
