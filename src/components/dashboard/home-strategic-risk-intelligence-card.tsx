      ...
      <CardHeader className={cn("pb-3", isAlert ? "bg-red-50" : "bg-slate-50/50")}>
        <div className="flex items-center justify-between">
          <CardTitle className="text-sm flex items-center gap-2">
            <AlertOctagon className={cn("h-4 w-4", isAlert ? "text-[--cs-risk]" : "text-orange-600")} />
      ...
      <CardContent className="space-y-4">
        ...
        {d.strategic_risk_rating !== "insufficient_data" && (
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
            ...
            <div className="text-center rounded-lg bg-slate-50 p-2">
              <p className={cn("text-lg font-bold tabular-nums", d.register.critical_count === 0 ? "text-[--cs-success]" : d.register.critical_count <= 1 ? "text-[--cs-warning]" : "text-[--cs-risk]")}>{d.register.critical_count}</p>
              <p className="text-[10px] text-muted-foreground">Critical Risks</p>
            </div>
            <div className="text-center rounded-lg bg-slate-50 p-2">
              <p className={cn("text-lg font-bold tabular-nums", d.strategic.worsening_count === 0 ? "text-[--cs-success]" : d.strategic.worsening_count <= 1 ? "text-[--cs-warning]" : "text-[--cs-risk]")}>{d.strategic.worsening_count}</p>
