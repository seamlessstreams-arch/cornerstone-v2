      ...
      <CardHeader className={cn("pb-3", isAlert ? "bg-red-50" : "bg-teal-50/50")}>
        <div className="flex items-center justify-between">
          <CardTitle className="text-sm flex items-center gap-2">
            <Phone className={cn("h-4 w-4", isAlert ? "text-red-600" : "text-teal-600")} />
        ...
        {d.contact_rating !== "insufficient_data" && (
          <div className="grid grid-cols-3 sm:grid-cols-6 gap-1.5">
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.home_initiated_rate >= 50 ? "bg-green-50" : d.home_initiated_rate >= 30 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.home_initiated_rate >= 50 ? "text-green-600" : d.home_initiated_rate >= 30 ? "text-amber-600" : "text-red-600")}>{d.home_initiated_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.child_awareness_rate >= 80 ? "bg-green-50" : d.child_awareness_rate >= 50 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.child_awareness_rate >= 80 ? "text-green-600" : d.child_awareness_rate >= 50 ? "text-amber-600" : "text-red-600")}>{d.child_awareness_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.decision_documentation_rate >= 60 ? "bg-green-50" : d.decision_documentation_rate >= 30 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.decision_documentation_rate >= 60 ? "text-green-600" : d.decision_documentation_rate >= 30 ? "text-amber-600" : "text-red-600")}>{d.decision_documentation_rate}%</p>
