...
export function HomeMinorRepairsMaintenanceIntelligenceCard() {
  const { data, isLoading } = useHomeMinorRepairsMaintenanceIntelligence();
  ...
  const __emptyState = d.maintenance_rating === "inadequate" && (d.maintenance_score ?? 0) <= 15;
  if (__emptyState) {
    d = {
      ...d,
      maintenance_rating: "insufficient_data",
      concerns: [],
      recommendations: [],
      insights: [],
      headline:
  ...
  const ratingStyle = RATING_STYLES[d.maintenance_rating as MinorRepairsRating] ?? RATING_STYLES.insufficient_data;
  const isAlert = d.maintenance_rating === "inadequate";
      ...
      <CardHeader className={cn("pb-3", isAlert ? "bg-red-50" : "bg-stone-50/50")}>
        <div className="flex items-center justify-between">
          <CardTitle className="text-sm flex items-center gap-2">
            <Wrench className={cn("h-4 w-4", isAlert ? "text-red-600" : "text-stone-600")} />
        ...
        {d.maintenance_rating !== "insufficient_data" && (
          <div className="grid grid-cols-3 sm:grid-cols-6 gap-1.5">
            <div className={cn("text-center rounded-lg p-1.5", d.request_response_rate >= 90 ? "bg-green-50" : d.request_response_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.request_response_rate >= 90 ? "text-green-600" : d.request_response_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.request_response_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.repair_completion_rate >= 90 ? "bg-green-50" : d.repair_completion_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.repair_completion_rate >= 90 ? "text-green-600" : d.repair_completion_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.repair_completion_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.safety_check_rate >= 90 ? "bg-green-50" : d.safety_check_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.safety_check_rate >= 90 ? "text-green-600" : d.safety_check_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.safety_check_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.condition_compliance_rate >= 90 ? "bg-green-50" : d.condition_compliance_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.condition_compliance_rate >= 90 ? "text-green-600" : d.condition_compliance_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.condition_compliance_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.preventative_maintenance_rate >= 90 ? "bg-green-50" : d.preventative_maintenance_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.preventative_maintenance_rate >= 90 ? "text-green-600" : d.preventative_maintenance_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.preventative_maintenance_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.child_environment_rate >= 90 ? "bg-green-50" : d.child_environment_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.child_environment_rate >= 90 ? "text-green-600" : d.child_environment_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.child_environment_rate}%</p>
