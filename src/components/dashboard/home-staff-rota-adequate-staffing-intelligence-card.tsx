      ...
      <CardHeader className={cn("pb-3", isAlert ? "bg-red-50" : "bg-teal-50/50")}>
        <div className="flex items-center justify-between">
          <CardTitle className="text-sm flex items-center gap-2">
            <ClipboardList className={cn("h-4 w-4", isAlert ? "text-[--cs-risk]" : "text-teal-600")} />
        ...
        {d.staffing_rating !== "insufficient_data" && (
          <div className="grid grid-cols-3 sm:grid-cols-6 gap-1.5">
            <div className={cn("text-center rounded-lg p-1.5", d.shift_coverage_rate >= 90 ? "bg-green-50" : d.shift_coverage_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.shift_coverage_rate >= 90 ? "text-[--cs-success]" : d.shift_coverage_rate >= 70 ? "text-[--cs-warning]" : "text-[--cs-risk]")}>{d.shift_coverage_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.ratio_compliance_rate >= 90 ? "bg-green-50" : d.ratio_compliance_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.ratio_compliance_rate >= 90 ? "text-[--cs-success]" : d.ratio_compliance_rate >= 70 ? "text-[--cs-warning]" : "text-[--cs-risk]")}>{d.ratio_compliance_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.overtime_rate <= 20 ? "bg-green-50" : d.overtime_rate <= 50 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.overtime_rate <= 20 ? "text-[--cs-success]" : d.overtime_rate <= 50 ? "text-[--cs-warning]" : "text-[--cs-risk]")}>{d.overtime_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.agency_usage_rate <= 20 ? "bg-green-50" : d.agency_usage_rate <= 50 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.agency_usage_rate <= 20 ? "text-[--cs-success]" : d.agency_usage_rate <= 50 ? "text-[--cs-warning]" : "text-[--cs-risk]")}>{d.agency_usage_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.rota_planning_rate >= 90 ? "bg-green-50" : d.rota_planning_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.rota_planning_rate >= 90 ? "text-[--cs-success]" : d.rota_planning_rate >= 70 ? "text-[--cs-warning]" : "text-[--cs-risk]")}>{d.rota_planning_rate}%</p>
