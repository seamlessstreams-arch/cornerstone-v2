...
export function HomeAdmissionsMatchingAssessmentIntelligenceCard() {
  ...
  return (
    <Card className={cn("overflow-hidden", isAlert ? "border-red-400 border-2" : "border-sky-600 border-2")} aria-label="ARIA Admissions & Matching Intelligence">
