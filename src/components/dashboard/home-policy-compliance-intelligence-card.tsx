      ...
      <CardHeader className={cn("pb-3", isAlert ? "bg-red-50" : "bg-slate-50/50")}>
        <div className="flex items-center justify-between">
          <CardTitle className="text-sm flex items-center gap-2">
            <FileCheck className={cn("h-4 w-4", isAlert ? "text-[--cs-risk]" : "text-sky-500")} />
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
            ...
            <div className="text-center rounded-lg bg-slate-50 p-2">
              <div className="flex items-center justify-center gap-1">
                ...
                <p className={cn("text-lg font-bold tabular-nums",
                  d.compliance_profile.active_count >= 10 ? "text-[--cs-success]" :
                  d.compliance_profile.active_count >= 6 ? "text-[--cs-warning]" : "text-[--cs-risk]"
                )}>
            ...
            <div className="text-center rounded-lg bg-slate-50 p-2">
              <div className="flex items-center justify-center gap-1">
                ...
                <p className={cn("text-lg font-bold tabular-nums",
                  d.compliance_profile.overdue_count === 0 ? "text-[--cs-success]" :
                  d.compliance_profile.overdue_count <= 1 ? "text-[--cs-warning]" : "text-[--cs-risk]"
                )}>
            ...
            <div className="text-center rounded-lg bg-slate-50 p-2">
              <div className="flex items-center justify-center gap-1">
                ...
                <p className={cn("text-lg font-bold tabular-nums",
                  d.coverage_profile.unique_categories >= 8 ? "text-[--cs-success]" :
                  d.coverage_profile.unique_categories >= 5 ? "text-[--cs-warning]" : "text-[--cs-risk]"
                )}>
