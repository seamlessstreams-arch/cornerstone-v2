      ...
      <CardHeader className={cn("pb-3", isAlert ? "bg-red-50" : "bg-rose-50/50")}>
        <div className="flex items-center justify-between">
          <CardTitle className="text-sm flex items-center gap-2">
            <HandMetal className={cn("h-4 w-4", isAlert ? "text-[--cs-risk]" : "text-rose-600")} />
        ...
        {d.restraint_rating !== "insufficient_data" && (
          <div className="grid grid-cols-3 sm:grid-cols-6 gap-1.5">
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.team_teach_compliance_rate >= 95 ? "bg-green-50" : d.team_teach_compliance_rate >= 80 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.team_teach_compliance_rate >= 95 ? "text-[--cs-success]" : d.team_teach_compliance_rate >= 80 ? "text-[--cs-warning]" : "text-[--cs-risk]")}>{d.team_teach_compliance_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.child_debrief_rate >= 85 ? "bg-green-50" : d.child_debrief_rate >= 60 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.child_debrief_rate >= 85 ? "text-[--cs-success]" : d.child_debrief_rate >= 60 ? "text-[--cs-warning]" : "text-[--cs-risk]")}>{d.child_debrief_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.review_completion_rate >= 90 ? "bg-green-50" : d.review_completion_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.review_completion_rate >= 90 ? "text-[--cs-success]" : d.review_completion_rate >= 70 ? "text-[--cs-warning]" : "text-[--cs-risk]")}>{d.review_completion_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.body_map_rate >= 90 ? "bg-green-50" : d.body_map_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.body_map_rate >= 90 ? "text-[--cs-success]" : d.body_map_rate >= 70 ? "text-[--cs-warning]" : "text-[--cs-risk]")}>{d.body_map_rate}%</p>
