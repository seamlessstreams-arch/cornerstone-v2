      ...
      <CardHeader className={cn("pb-3", isAlert ? "bg-red-50" : "bg-sky-50/50")}>
        <div className="flex items-center justify-between">
          <CardTitle className="text-sm flex items-center gap-2">
            <Wifi className={cn("h-4 w-4", isAlert ? "text-red-600" : "text-sky-600")} />
        ...
        {d.digital_rating !== "insufficient_data" && (
          <div className="grid grid-cols-3 sm:grid-cols-5 gap-1.5">
            <div className={cn("text-center rounded-lg p-1.5", d.children_with_digital_plans > 0 ? "bg-green-50" : "bg-amber-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.children_with_digital_plans > 0 ? "text-green-600" : "text-amber-600")}>{d.children_with_digital_plans}</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.digital_skill_coverage_rate >= 80 ? "bg-green-50" : d.digital_skill_coverage_rate >= 50 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.digital_skill_coverage_rate >= 80 ? "text-green-600" : d.digital_skill_coverage_rate >= 50 ? "text-amber-600" : "text-red-600")}>{d.digital_skill_coverage_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.parental_controls_rate >= 90 ? "bg-green-50" : d.parental_controls_rate >= 60 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.parental_controls_rate >= 90 ? "text-green-600" : d.parental_controls_rate >= 60 ? "text-amber-600" : "text-red-600")}>{d.parental_controls_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.rse_digital_coverage_rate >= 80 ? "bg-green-50" : d.rse_digital_coverage_rate >= 50 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.rse_digital_coverage_rate >= 80 ? "text-green-600" : d.rse_digital_coverage_rate >= 50 ? "text-amber-600" : "text-red-600")}>{d.rse_digital_coverage_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.exploitation_risk_assessed_rate >= 90 ? "bg-green-50" : d.exploitation_risk_assessed_rate >= 60 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.exploitation_risk_assessed_rate >= 90 ? "text-green-600" : d.exploitation_risk_assessed_rate >= 60 ? "text-amber-600" : "text-red-600")}>{d.exploitation_risk_assessed_rate}%</p>
