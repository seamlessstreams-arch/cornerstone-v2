...
export function HomeOutdoorNatureEngagementIntelligenceCard() {
  ...
  return (
    <Card className={cn("overflow-hidden", isAlert ? "border-red-400 border-2" : "border-green-600 border-2")} aria-label="ARIA Outdoor & Nature Engagement Intelligence">
