...
export function HomeAsthmaRespiratoryManagementIntelligenceCard() {
  const { data, isLoading } = useHomeAsthmaRespiratoryManagementIntelligence();
  ...
  const __emptyState = d.respiratory_rating === "inadequate" && (d.respiratory_score ?? 0) <= 15;
  if (__emptyState) {
    d = {
      ...d,
      respiratory_rating: "insufficient_data",
      concerns: [],
      recommendations: [],
      insights: [],
      headline:
  ...
  const ratingStyle = RATING_STYLES[d.respiratory_rating as AsthmaRespiratoryRating] ?? RATING_STYLES.insufficient_data;
  const isAlert = d.respiratory_rating === "inadequate";
      ...
      <CardHeader className={cn("pb-3", isAlert ? "bg-red-50" : "bg-teal-50/50")}>
        <div className="flex items-center justify-between">
          <CardTitle className="text-sm flex items-center gap-2">
            <Wind className={cn("h-4 w-4", isAlert ? "text-red-600" : "text-teal-600")} />
        ...
        {d.respiratory_rating !== "insufficient_data" && (
          <div className="grid grid-cols-3 sm:grid-cols-6 gap-1.5">
            <div className={cn("text-center rounded-lg p-1.5", d.action_plan_coverage_rate >= 90 ? "bg-green-50" : d.action_plan_coverage_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.action_plan_coverage_rate >= 90 ? "text-green-600" : d.action_plan_coverage_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.action_plan_coverage_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.inhaler_technique_rate >= 90 ? "bg-green-50" : d.inhaler_technique_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.inhaler_technique_rate >= 90 ? "text-green-600" : d.inhaler_technique_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.inhaler_technique_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.trigger_management_rate >= 90 ? "bg-green-50" : d.trigger_management_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.trigger_management_rate >= 90 ? "text-green-600" : d.trigger_management_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.trigger_management_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.peak_flow_monitoring_rate >= 90 ? "bg-green-50" : d.peak_flow_monitoring_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.peak_flow_monitoring_rate >= 90 ? "text-green-600" : d.peak_flow_monitoring_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.peak_flow_monitoring_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.emergency_preparedness_rate >= 90 ? "bg-green-50" : d.emergency_preparedness_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.emergency_preparedness_rate >= 90 ? "text-green-600" : d.emergency_preparedness_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.emergency_preparedness_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.child_self_management_rate >= 90 ? "bg-green-50" : d.child_self_management_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.child_self_management_rate >= 90 ? "text-green-600" : d.child_self_management_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.child_self_management_rate}%</p>
