      ...
      <CardHeader className={cn("pb-3", isAlert ? "bg-red-50" : "bg-lime-50/50")}>
        <div className="flex items-center justify-between">
          <CardTitle className="text-sm flex items-center gap-2">
            <Moon className={cn("h-4 w-4", isAlert ? "text-red-600" : "text-lime-600")} />
        ...
        {d.handover_rating !== "insufficient_data" && (
          <div className="grid grid-cols-3 sm:grid-cols-5 gap-1.5">
            <div className={cn("text-center rounded-lg p-1.5", d.total_handovers > 0 ? "bg-green-50" : "bg-amber-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.total_handovers > 0 ? "text-green-600" : "text-amber-600")}>{d.total_handovers}</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.risk_briefing_rate >= 90 ? "bg-green-50" : d.risk_briefing_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.risk_briefing_rate >= 90 ? "text-green-600" : d.risk_briefing_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.risk_briefing_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.medication_compliance_rate >= 95 ? "bg-green-50" : d.medication_compliance_rate >= 80 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.medication_compliance_rate >= 95 ? "text-green-600" : d.medication_compliance_rate >= 80 ? "text-amber-600" : "text-red-600")}>{d.medication_compliance_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.morning_completion_rate >= 95 ? "bg-green-50" : d.morning_completion_rate >= 80 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.morning_completion_rate >= 95 ? "text-green-600" : d.morning_completion_rate >= 80 ? "text-amber-600" : "text-red-600")}>{d.morning_completion_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.children_notes_rate >= 90 ? "bg-green-50" : d.children_notes_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.children_notes_rate >= 90 ? "text-green-600" : d.children_notes_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.children_notes_rate}%</p>
