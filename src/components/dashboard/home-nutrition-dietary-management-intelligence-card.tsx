...
export function HomeNutritionDietaryManagementIntelligenceCard() {
  const { data, isLoading } = useHomeNutritionDietaryManagementIntelligence();
  ...
  if (!d) return null;
  const ratingStyle = RATING_STYLES[d.nutrition_rating as NutritionRating] ?? RATING_STYLES.insufficient_data;
  const isAlert = d.nutrition_rating === "inadequate";
      ...
      <CardHeader className={cn("pb-3", isAlert ? "bg-red-50" : "bg-lime-50/50")}>
        <div className="flex items-center justify-between">
          <CardTitle className="text-sm flex items-center gap-2">
            <Apple className={cn("h-4 w-4", isAlert ? "text-red-600" : "text-lime-600")} />
        ...
        {d.nutrition_rating !== "insufficient_data" && (
          <div className="grid grid-cols-3 sm:grid-cols-6 gap-1.5">
            <div className={cn("text-center rounded-lg p-1.5", d.meal_plan_compliance_rate >= 90 ? "bg-green-50" : d.meal_plan_compliance_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.meal_plan_compliance_rate >= 90 ? "text-green-600" : d.meal_plan_compliance_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.meal_plan_compliance_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.dietary_requirement_coverage_rate >= 90 ? "bg-green-50" : d.dietary_requirement_coverage_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.dietary_requirement_coverage_rate >= 90 ? "text-green-600" : d.dietary_requirement_coverage_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.dietary_requirement_coverage_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.nutrition_assessment_rate >= 90 ? "bg-green-50" : d.nutrition_assessment_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.nutrition_assessment_rate >= 90 ? "text-green-600" : d.nutrition_assessment_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.nutrition_assessment_rate}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.food_hygiene_score >= 90 ? "bg-green-50" : d.food_hygiene_score >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.food_hygiene_score >= 90 ? "text-green-600" : d.food_hygiene_score >= 70 ? "text-amber-600" : "text-red-600")}>{d.food_hygiene_score}%</p>
            ...
            <div className={cn("text-center rounded-lg p-1.5", d.special_diet_adherence_rate >= 90 ? "bg-green-50" : d.special_diet_adherence_rate >= 70 ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", d.special_diet_adherence_rate >= 90 ? "text-green-600" : d.special_diet_adherence_rate >= 70 ? "text-amber-600" : "text-red-600")}>{d.special_diet_adherence_rate}%</p>
