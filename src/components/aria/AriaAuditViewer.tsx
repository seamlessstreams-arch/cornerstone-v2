// ══════════════════════════════════════════════════════════════════════════════
// AriaAuditViewer — Audit log viewer for AI operations
// ══════════════════════════════════════════════════════════════════════════════

"use client";

import { useState } from "react";
import type { AriaRiskLevel, AriaTaskType, AriaProviderName } from "@/lib/aria/core/types";
...
export function AriaAuditViewer({
  entries,
  loading = false,
  onLoadMore,
  hasMore = false,
