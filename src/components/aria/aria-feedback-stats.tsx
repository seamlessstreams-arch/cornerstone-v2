...
//
// Usage:
//   <AriaFeedbackStats homeId="demo-home" days={30} />
// ══════════════════════════════════════════════════════════════════════════════
...
interface AriaFeedbackStatsProps {
  homeId?: string;
  days?: number;
  className?: string;
}

export function AriaFeedbackStats({
  homeId,
  days = 30,
  className,
}: AriaFeedbackStatsProps) {
  const [stats, setStats] = useState<FeedbackStats | null>(null);
  const [loading, setLoading] = useState(true);

  useEffect(() => {
    // In production, fetch from /api/aria/feedback/stats
