...
// Consumes /api/aria/shift-safety and displays signals prioritised by severity.
// ══════════════════════════════════════════════════════════════════════════════
...
export function AriaShiftSafety({ homeId = "home_oak" }: { homeId?: string }) {
  ...
  async function fetchSafety() {
    setLoading(true);
    try {
      const res = await fetch(`/api/aria/shift-safety?homeId=${homeId}`);
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-start gap-1.5 mt-1">
                      <Sparkles className="h-2.5 w-2.5 text-[var(--cs-aria-gold)] mt-0.5 shrink-0" />
