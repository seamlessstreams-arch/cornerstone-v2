// ══════════════════════════════════════════════════════════════════════════════
// AriaModelDecisionBadge — Shows which model was used and why
// ══════════════════════════════════════════════════════════════════════════════

"use client";

import type { AriaProviderName, AriaRiskLevel, AriaApprovalStatus } from "@/lib/aria/core/types";
...
const STATUS_LABELS: Record<AriaApprovalStatus, { label: string; colour: string }> = {
...
export function AriaModelDecisionBadge({
  provider,
  model,
  riskLevel,
  approvalStatus,
