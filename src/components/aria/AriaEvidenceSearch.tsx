// ══════════════════════════════════════════════════════════════════════════════
// AriaEvidenceSearch — Semantic evidence search UI with source types
// ══════════════════════════════════════════════════════════════════════════════

"use client";

import { useState } from "react";
import type { AriaRole } from "@/lib/aria/core/types";
...
export function AriaEvidenceSearch({
  userRole,
  organisationId,
  homeId,
  childId,
  ...
  const handleSearch = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("/api/aria/evidence/search", {
        method: "POST",
