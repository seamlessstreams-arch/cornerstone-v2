...
import { AriaHumanReviewBanner } from "./aria-human-review-banner";
import { AriaConfidenceIndicator } from "./aria-confidence-indicator";
import {
  ThumbsUp,
  ThumbsDown,
  Edit3,
...
interface AriaApprovalCardProps {
  outputId: string;
...
export function AriaApprovalCard({
  outputId,
  generatedText,
  commandLabel,
  confidence,
    ...
    <div className={cn(
      ...
      <div className="flex items-center justify-between px-4 py-3 border-b border-[var(--cs-border)] bg-[var(--cs-surface)]">
        <div className="flex items-center gap-2">
          ...
          <AriaConfidenceIndicator confidence={confidence} />
        </div>
        <Badge
          variant="warning"
          className="text-[9px]"
