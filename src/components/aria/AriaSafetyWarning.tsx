// ══════════════════════════════════════════════════════════════════════════════
// AriaSafetyWarning — Displays safety blocks or route restrictions
// ══════════════════════════════════════════════════════════════════════════════

"use client";

import type { AriaDataSensitivity, AriaRiskLevel } from "@/lib/aria/core/types";
...
export function AriaSafetyWarning({
  type,
  reason,
  riskLevel,
  sensitivityLevel,
