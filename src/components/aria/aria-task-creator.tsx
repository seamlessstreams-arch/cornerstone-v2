...
export function AriaTaskCreator({
  generatedText,
  outputId,
  homeId,
  linkedChildId,
  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="flex w-full items-center justify-between p-3 text-left hover:bg-[var(--cs-aria-gold-bg)] transition-colors"
      >
