// ══════════════════════════════════════════════════════════════════════════════
// AriaStudioGenerator — UI for generating child-centred therapeutic resources
// ══════════════════════════════════════════════════════════════════════════════

"use client";

import { useState } from "react";
import type { AriaRole, AriaTaskResult } from "@/lib/aria/core/types";
...
interface Props {
  ...
  childName?: string;
  childAge?: number;
  onGenerated?: (result: AriaTaskResult) => void;
}
...
export function AriaStudioGenerator({
  userRole,
  organisationId,
  homeId,
  childId,
  ...
  const [result, setResult] = useState<AriaTaskResult | null>(null);
  ...
  const handleGenerate = async () => {
    ...
    try {
      const response = await fetch("/api/aria/studio/generate", {
        method: "POST",
