...
// Fetches batch quality data from /api/aria/recording-quality and displays:
...
export function AriaRecordingQuality({ homeId = "home_oak", days = 7 }: { homeId?: string; days?: number }) {
  ...
  async function fetchQuality() {
    setLoading(true);
    try {
      const res = await fetch(`/api/aria/recording-quality?homeId=${homeId}&days=${days}`);
