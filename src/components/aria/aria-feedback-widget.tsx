...
//
// Usage:
//   <AriaFeedbackWidget outputId="out_001" commandId="improve_writing" />
// ══════════════════════════════════════════════════════════════════════════════
...
export function AriaFeedbackWidget({
  outputId,
  commandId,
  compact = true,
  className,
}: AriaFeedbackWidgetProps) {
      ...
      {showNote && rating === null && (
        <div className="flex items-center gap-2">
          <input
            ...
            className="flex-1 rounded-lg border border-[var(--cs-border)] bg-white px-2.5 py-1.5 text-[10px] text-[var(--cs-text-secondary)] placeholder:text-[var(--cs-text-muted)] focus:outline-none focus:ring-1 focus:ring-[var(--cs-aria-gold)]"
            maxLength={500}
          />
        </div>
      )}
