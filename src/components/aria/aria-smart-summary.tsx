...
//
// Usage:
//   <AriaSmartSummary childId="demo-child-1" days={14} />
// ══════════════════════════════════════════════════════════════════════════════
...
interface AriaSmartSummaryProps {
  childId: string;
  days?: number;
  className?: string;
}

export function AriaSmartSummary({
  childId,
  days = 14,
  className,
}: AriaSmartSummaryProps) {
  ...
  if (loading || !summary) {
    return (
      <div className={cn("rounded-2xl border border-[var(--cs-aria-gold-soft)] bg-[var(--cs-aria-gold-bg)] p-5", className)}>
        <div className="flex items-center gap-2">
          <Loader2 className="h-4 w-4 text-[var(--cs-aria-gold)] animate-spin" />
      ...
      <div className="bg-[var(--cs-aria-gold-bg)] px-5 py-3 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            disabled={refreshing}
            className="text-[var(--cs-text-muted)] hover:text-[var(--cs-aria-gold)] transition-colors"
          >
