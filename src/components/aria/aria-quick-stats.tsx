...
interface AriaQuickStatsProps {
  homeId?: string;
  days?: number;
  className?: string;
}

export function AriaQuickStats({
  homeId,
  days = 30,
  className,
}: AriaQuickStatsProps) {
  ...
  return (
    <div
      className={cn(
        "inline-flex items-center gap-3 rounded-full border border-[var(--cs-aria-gold-soft)] bg-[var(--cs-aria-gold-bg)] px-3 py-1.5",
        className,
      )}
    >
