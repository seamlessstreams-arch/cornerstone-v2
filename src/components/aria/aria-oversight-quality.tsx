...
export function AriaOversightQuality({
  oversightText,
  recordType = "general",
  recordReference,
              ...
              return (
                <div key={dim} className="rounded-xl border border-[var(--cs-border-subtle)] bg-slate-50/50 p-3">
                  ...
                  <div className="w-full h-1.5 bg-slate-200 rounded-full overflow-hidden mb-1.5">
                    <div
                      className={cn("h-full rounded-full aria-score-reveal", getBarColour(dimScore))}
          ...
          {suggestions.length > 0 && (
            <div>
              <button
                ...
                className="flex items-center gap-1.5 text-xs font-semibold text-[var(--cs-aria-gold)] hover:text-[var(--cs-aria-gold)]/80 cs-transition-fast"
              >
