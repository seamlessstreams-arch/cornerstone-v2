// ══════════════════════════════════════════════════════════════════════════════
// AriaRedactionNotice — Shows redaction details on AI-generated output
// ══════════════════════════════════════════════════════════════════════════════

"use client";

import { useState } from "react";
import type { AriaRedactionEntry, AriaDataSensitivity } from "@/lib/aria/core/types";

interface Props {
  redactionEntries: AriaRedactionEntry[];
...
export function AriaRedactionNotice({
  redactionEntries,
  sensitivityLevel,
  provider,
  compact = false,
