...
interface AriaShortcutsGuideProps {
  className?: string;
}
...
export function AriaShortcutsGuide({ className }: AriaShortcutsGuideProps) {
  ...
  return (
    <>
      ...
      <div
        className={cn(
          "fixed right-6 top-[10%] z-50 w-80 rounded-2xl border border-[var(--cs-aria-gold-soft)] bg-white shadow-2xl overflow-hidden",
          className,
        )}
      >
        {/* Header */}
        <div className="flex items-center gap-2.5 px-5 py-3 bg-gradient-to-r from-[var(--cs-aria-gold-bg)] to-white border-b border-[var(--cs-aria-gold-soft)]">
