// ══════════════════════════════════════════════════════════════════════════════
// AriaHumanApprovalBanner — Shows when AI output requires human approval
// ══════════════════════════════════════════════════════════════════════════════

"use client";

import { useState } from "react";
import type { AriaApprovalStatus, AriaRiskLevel } from "@/lib/aria/core/types";
...
export function AriaHumanApprovalBanner({
  approvalId,
  taskType,
  riskLevel,
  status,
