// ══════════════════════════════════════════════════════════════════════════════
// AriaApprovalQueue — Queue of AI outputs awaiting human review
// ══════════════════════════════════════════════════════════════════════════════

"use client";

import { useState } from "react";
import type { AriaApprovalRecord, AriaRiskLevel } from "@/lib/aria/core/types";

interface Props {
  items: AriaApprovalRecord[];
  onSelect: (item: AriaApprovalRecord) => void;
  onApprove: (id: string, notes: string) => void;
  onReject: (id: string, reason: string) => void;
  loading?: boolean;
}

const RISK_STYLES: Record<AriaRiskLevel, string> = {
...
export function AriaApprovalQueue({
  items,
  onSelect,
  onApprove,
  onReject,
