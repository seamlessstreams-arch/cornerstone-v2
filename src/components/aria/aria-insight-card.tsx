...
//
// Usage:
//   <AriaInsightCard homeId="demo-home" limit={4} />
// ══════════════════════════════════════════════════════════════════════════════
...
export function AriaInsightCard({
  ...
  useEffect(() => {
    // In a real implementation, fetch from /api/aria/insights
                  ...
                  <div className="flex items-center gap-2 mt-0.5">
                    ...
                    {insight.relatedChildName && (
                      <>
                        ...
                        <span className="text-[9px] font-medium text-[var(--cs-aria-gold)]">
                          {insight.relatedChildName}
                        </span>
                      </>
                    )}
