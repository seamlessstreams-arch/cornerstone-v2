...
import type { CaraQualityCheck } from "@/types/cara-studio";

interface CaraStudioQualityPanelProps {
  qualityCheck: CaraQualityCheck;
  score: number | null;
}

const CHECKS: Array<{
  key: keyof CaraQualityCheck;
  label: string;
  critical?: boolean;
}> = [
...
export function CaraStudioQualityPanel({ qualityCheck, score }: CaraStudioQualityPanelProps) {
