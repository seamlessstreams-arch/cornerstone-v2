// ══════════════════════════════════════════════════════════════════════════════
// CaraWhistleblowingConcerns — Whistleblowing & Professional Concerns Widget
//
...
export function CaraWhistleblowingConcerns() {
      ...
      <div className="px-5 py-4 border-b border-[var(--cs-border)] bg-gradient-to-r from-[var(--cs-cara-gold-bg)] to-white">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <Megaphone className="h-5 w-5 text-[var(--cs-cara-gold)]" />
