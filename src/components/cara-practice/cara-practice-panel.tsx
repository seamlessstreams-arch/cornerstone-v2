...
// CaraPracticePanel — embeddable "Run Cara" panel for any record/assessment.
...
const SEV_STYLE: Record<CaraSeverity, string> = {
...
export interface CaraPracticePanelProps {
  text?: string;
