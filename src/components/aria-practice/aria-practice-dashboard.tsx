...
// AriaPracticeDashboard — manager / RI practice-intelligence overview: gap heatmap,
...
import { useAriaPracticeDashboard } from "@/hooks/use-aria-practice";
import type { AriaSeverity } from "@/lib/aria-practice/types";

const SEV: Record<AriaSeverity, string> = {
...
export function AriaPracticeDashboard({ homeId = "home_oak", childId }: { homeId?: string; childId?: string }) {
  const { data, isLoading, isError, error } = useAriaPracticeDashboard(homeId, childId);
