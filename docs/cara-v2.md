# Cara V2 — Pattern Intelligence Layer
...
File: `src/app/(platform)/intelligence/cara/pattern-intelligence/page.tsx`

Route: `/intelligence/cara/pattern-intelligence`
...
- **Alert list**: expandable rows with severity border, source badge, child badge, Cara recommendation, evidence count, detection timestamp
- **Actions per alert**: Acknowledge, View in Patterns, View Child

### Navigation

Added to Cara nav group as "Pattern Intelligence" with Brain icon.
...
- Voice gaps link to `/intelligence/cara/voice-of-child` for detailed analysis
...
| `src/app/(platform)/intelligence/cara/pattern-intelligence/page.tsx` | Dashboard UI |
